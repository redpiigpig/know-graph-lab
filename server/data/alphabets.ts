...
export interface AlphaLetter {
  ...
  translit?: string;  // 例字的課本式學術轉寫（希伯來文＝BBH2；取代裝置語音）
}
...
const hbo: AlphabetSpec = {
  ...
  intro: "22 個子音，由右至左書寫。5 個字母在詞尾有「字尾形（sofit）」。母音由「母音點（niqqud）」標在子音下／旁。發音與轉寫一律依 Pratico–Van Pelt《Basics of Biblical Hebrew Grammar》第二版（BBH2）的聖經希伯來文系統，不採現代以色列語發音：ו 讀 w、ח 讀 ḥ（與 ḵ 有別）、ע 是濁喉音不可省、ק 讀 q，bgdkpt 六字母分有點（硬音）與無點（軟音 ḇ ḡ ḏ ḵ p̄ ṯ）。",
  rtl: true,
  groups: [
    {
      key: "consonants", label: "22 個子音",
      letters: [
        { char: "א", name: "alef 阿萊夫", sound: "ʾ｜喉塞音，多半不發音", example: "אָב", gloss: "父", translit: "ʾāḇ" },
        { char: "ב", name: "bet 貝特", sound: "b｜有 dagesh；ḇ（v）無 dagesh", example: "בַּיִת", gloss: "家／殿", translit: "bayiṯ" },
        { char: "ג", name: "gimel 吉梅爾", sound: "g｜有 dagesh；ḡ 無 dagesh", example: "גָּדוֹל", gloss: "大的", translit: "gāḏôl" },
        { char: "ד", name: "dalet 達萊特", sound: "d｜有 dagesh；ḏ 無 dagesh", example: "דָּבָר", gloss: "話語／事", translit: "dāḇār" },
        { char: "ה", name: "he 黑", sound: "h", example: "הַר", gloss: "山", translit: "har" },
        { char: "ו", name: "vav 瓦夫", sound: "w｜BBH2 作 w，非現代語的 v；亦作母音 ô／û", example: "וְ", gloss: "和（連接詞）", translit: "wə" },
        { char: "ז", name: "zayin 札因", sound: "z", example: "זֶרַע", gloss: "種子／後裔", translit: "zeraʿ" },
        { char: "ח", name: "chet 黑特", sound: "ḥ｜硬喉擦音，與 ḵ 有別（現代語已合併）", example: "חַיִּים", gloss: "生命", translit: "ḥayyîm" },
        { char: "ט", name: "tet 泰特", sound: "ṭ｜強化 t", example: "טוֹב", gloss: "好", translit: "ṭôḇ" },
        { char: "י", name: "yod 約德", sound: "y", example: "יָד", gloss: "手", translit: "yāḏ" },
        { char: "כ", name: "kaf 卡夫", sound: "k｜有 dagesh；ḵ（kh）無 dagesh", example: "כֹּהֵן", gloss: "祭司", translit: "kōhēn" },
        { char: "ל", name: "lamed 拉梅德", sound: "l", example: "לֵב", gloss: "心", translit: "lēḇ" },
        { char: "מ", name: "mem 梅姆", sound: "m", example: "מַיִם", gloss: "水", translit: "mayim" },
        { char: "נ", name: "nun 努恩", sound: "n", example: "נֶפֶשׁ", gloss: "魂／生命", translit: "nep̄eš" },
        { char: "ס", name: "samek 撒梅克", sound: "s", example: "סֵפֶר", gloss: "書卷", translit: "sēp̄er" },
        { char: "ע", name: "ayin 阿因", sound: "ʿ｜濁喉音，BBH2 要求與 ʾ 分辨，不可省略", example: "עַיִן", gloss: "眼／泉", translit: "ʿayin" },
        { char: "פ", name: "pe 佩", sound: "p｜有 dagesh；p̄（f）無 dagesh", example: "פֶּה", gloss: "口", translit: "pê" },
        { char: "צ", name: "tsade 察德", sound: "ṣ｜強化 s，轉寫作 ṣ 而非 ts", example: "צֶדֶק", gloss: "公義", translit: "ṣeḏeq" },
        { char: "ק", name: "qof 科夫", sound: "q｜小舌 k，與 k 有別", example: "קֹדֶשׁ", gloss: "聖", translit: "qōḏeš" },
        { char: "ר", name: "resh 雷什", sound: "r", example: "רֹאשׁ", gloss: "頭／首", translit: "rōʾš" },
        { char: "שׁ", name: "shin／sin 辛", sound: "š（右點 shin）／ś（左點 sin）", example: "שָׁלוֹם", gloss: "平安", translit: "šālôm" },
        { char: "ת", name: "tav 塔夫", sound: "t｜有 dagesh；ṯ 無 dagesh", example: "תּוֹרָה", gloss: "妥拉／律法", translit: "tôrâ" },
      ],
    },
    {
      ...
      letters: [
        { char: "ך", name: "kaf sofit", sound: "ḵ｜詞尾軟音", example: "לְךָ", gloss: "給你", translit: "ləḵā" },
        { char: "ם", name: "mem sofit", sound: "m｜詞尾", example: "שָׁלוֹם", gloss: "平安", translit: "šālôm" },
        { char: "ן", name: "nun sofit", sound: "n｜詞尾", example: "בֵּן", gloss: "兒子", translit: "bēn" },
        { char: "ף", name: "pe sofit", sound: "p̄｜詞尾軟音", example: "כֶּסֶף", gloss: "銀子", translit: "kesep̄" },
        { char: "ץ", name: "tsade sofit", sound: "ṣ｜詞尾", example: "אֶרֶץ", gloss: "地", translit: "ʾereṣ" },
      ],
    },
    {
      ...
      letters: [
        { char: "בָ", name: "qamats", sound: "ā｜長 a（亦可為短 o，qamats hatuf）", example: "בָּא", gloss: "他來", translit: "bāʾ" },
        { char: "בַ", name: "patach", sound: "a｜短 a", example: "בַּת", gloss: "女兒", translit: "baṯ" },
        { char: "בֵ", name: "tsere", sound: "ē｜長 e", example: "בֵּן", gloss: "兒子", translit: "bēn" },
        { char: "בֶ", name: "segol", sound: "e｜短 e", example: "אֶרֶץ", gloss: "地", translit: "ʾereṣ" },
        { char: "בִ", name: "hiriq", sound: "i／î｜短 i 或長 î", example: "אִישׁ", gloss: "男人", translit: "ʾîš" },
        { char: "בֹ", name: "holam", sound: "ō｜長 o", example: "טוֹב", gloss: "好", translit: "ṭôḇ" },
        { char: "בֻ", name: "qubuts", sound: "u｜短 u", example: "שֻׁלְחָן", gloss: "桌子", translit: "šulḥān" },
        { char: "בְ", name: "shva", sound: "ə｜有聲短音或無聲", example: "בְּרֵאשִׁית", gloss: "起初", translit: "bərēʾšîṯ" },
      ],
    },
  ],
};
