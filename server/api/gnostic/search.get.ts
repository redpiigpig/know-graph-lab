// GET /api/gnostic/search?q=&doc=&version=&limit=
// ILIKE substring search across all 諾斯底主義文獻 sections.
export default defineEventHandler(async (event) => {
  ...
  let sb = supabase
    ...
    .select('doc_slug, version_code, order_index, section_label, text', { count: 'exact' })
    .ilike('text', `%${q}%`)
