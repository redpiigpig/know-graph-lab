// GET /api/apocrypha/search?q=&doc=&version=&limit=
// ILIKE substring search across all 典外文獻 sections.
export default defineEventHandler(async (event) => {
  ...
  let sb = supabase
    ...
    .select('doc_slug, version_code, order_index, section_label, page_number, text',
            { count: 'exact' })
    .ilike('text', `%${q}%`)
