// GET /api/apocrypha/documents
// Returns all apocrypha_documents + section counts per version (so UI can show
// which docs have 中文 / 英文 / 原文 data).
export default defineEventHandler(async (event) => {
  ...
  // Group section counts by doc_slug + version_code
