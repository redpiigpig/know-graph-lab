...
WORKS = [
    ...
    dict(slug="sbe-08-bhagavadgita", eid="55555508-5555-4555-8555-555555555555",
         title="薄伽梵歌（附桑那蘇伽提亞、續歌）",
         title_en="The Bhagavadgîtâ, with the Sanatsugâtîya and the Anugîtâ (Sacred Books of the East, Vol. 8)",
         year=1882, category="世界宗教", subcategory="東方聖書",
         author="德朗（譯）", author_en="Kâshinâth Trimbak Telang (trans.)",
         parent="東方聖書", en_id="mlbd.sacredbooksofeas0000fmax.vol.8", de_id=None, split="coarse"),
    dict(slug="sbe-09-quran-2", eid="55555509-5555-4555-8555-555555555555",
         title="古蘭經（下）", title_en="The Qur'ân, Part II — Chapters XVII–CXIV (Sacred Books of the East, Vol. 9)",
         year=1880, category="世界宗教", subcategory="東方聖書",
         author="帕爾默（譯）", author_en="E. H. Palmer (trans.)",
         parent="東方聖書", en_id="mlbd.sacredbooksofeas0000fmax.vol.9", de_id=None, split="coarse"),
    dict(slug="sbe-15-upanishads-2", eid="55555515-5555-4555-8555-555555555555",
         title="奧義書（下）", title_en="The Upanishads, Part II (Sacred Books of the East, Vol. 15)",
         year=1884, category="世界宗教", subcategory="東方聖書",
         author="穆勒（譯）", author_en="F. Max Müller (trans.)",
         parent="東方聖書", en_id="mlbd.upanishadssacred0000vol-15.unse_x5j4", de_id=None, split="coarse"),
    dict(slug="sbe-21-lotus-sutra", eid="55555521-5555-4555-8555-555555555555",
         title="妙法蓮華經", title_en="The Saddharma-Pundarîka, or The Lotus of the True Law (Sacred Books of the East, Vol. 21)",
         year=1884, category="世界宗教", subcategory="東方聖書",
         author="科恩（譯）", author_en="H. Kern (trans.)",
         parent="東方聖書", en_id="mlbd.saddharmapundarivol-21.0000unse_c0q8", de_id=None, split="coarse"),
    dict(slug="sbe-25-laws-of-manu", eid="55555525-5555-4555-8555-555555555555",
         title="摩奴法論", title_en="The Laws of Manu (Sacred Books of the East, Vol. 25)",
         year=1886, category="世界宗教", subcategory="東方聖書",
         author="比勒（譯）", author_en="Georg Bühler (trans.)",
         parent="東方聖書", en_id="mlbd.lawsofmanu0025unse_h6b1", de_id=None, split="coarse"),
    dict(slug="sbe-39-taoism-1", eid="55555539-5555-4555-8555-555555555555",
         title="道家經籍（一）：道德經‧莊子（上）",
         title_en="The Texts of Tâoism, Part I — Tâo Teh King & Writings of Kwang-3ze (Sacred Books of the East, Vol. 39)",
         year=1891, category="世界宗教", subcategory="東方聖書",
         author="理雅各（譯）", author_en="James Legge (trans.)",
         parent="東方聖書", en_id="mlbd.sacredbooksofeas0039unse", de_id=None, split="coarse"),
