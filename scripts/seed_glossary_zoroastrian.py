...
W("Yasna", "耶斯那", o="Yasna", translit="Yasna", cn="亞斯納",
  reason="yasna 意為「敬拜、獻祭」。本站《東方聖書》第 31 卷卷名已用此譯。")
W("Gāthās", "迦薩", o="Gāθā", translit="Gāθā", cn="伽薩", root="迦薩",
  era="約前 1500–1000",
  reason="🚨 兩個候選並存。取「迦」而不取「伽」的理由：迦是漢語宗教語彙中 gā- 的"
         "標準對音字（迦葉、釋迦、迦南），台灣國語只讀 jiā；伽兼讀 qié（伽藍）與 jiā（伽利略），"
         "有歧義。元文琪譯本作《伽薩》，列為大陸學界譯名。"
         "🚨 不可借用佛教的「偈」「伽陀」——梵語 gāthā 雖與本詞同源，但那是文類名，"
...
W("Visperad", "維斯佩拉德", o="Vīspe ratavō", translit="Visperad", cn="維斯帕拉德",
  reason="vīspe ratavō「向一切主宰者」。全為音譯，因其內容無可意譯的主題。")
W("Vendidad / Videvdad", "祓魔法典", o="Vīdaēva-dāta", translit="Vīdēvdād",
  cn="萬迪達德", era="約前 400 – 公元 300",
  reason="原文 vī-daēva-dāta ＝「驅除迭瓦之法」。依原則 2、3 取意譯：祓（驅除）＋魔（迭瓦）"
         "＋法典（dāta）。本站《東方聖書》第 4 卷卷名已用此譯。音譯「溫迪達德／萬迪達德」列為變體。",
  note="二十一納斯克中唯一完整傳世者，22 章。")
W("Yasht", "耶什特", o="Yašt", translit="Yašt", cn="亞什特",
  reason="yašt「敬拜、讚頌」。獻給各亞扎塔的讚歌 21 首。")
W("Khordeh Avesta", "小阿維斯陀", translit="Xorde Avestā", cn="胡爾達‧阿維斯塔",
  root="阿維斯陀",
  reason="khordeh「小的」；意譯以與《阿維斯陀》構成名根一致的一組。在家信眾日課本。")
W("Sīrōzah", "三十日誦", translit="Sīrōzah", cn="西羅扎",
  reason="sī「三十」＋rōz「日」。祆教曆一月三十日各有守護神，本篇逐日唱名，意譯達意。")
...
W("Āfrīnagān", "祝禱", translit="Āfrīnagān", cn="阿弗里納甘",
  reason="配合供品行禮的祝福禱文，意譯。")
