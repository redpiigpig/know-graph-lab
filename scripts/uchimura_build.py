...
5. **專名與固定術語——一對一，不可改**：無教会（主義）→無教會（主義）、贖罪→贖罪、（基督の）再臨→再臨、復活→復活、十字架→十字架、聖書→聖經（唯誌名《聖書之研究》保留原名）、神→神、イエス‧キリスト→耶穌‧基督、聖霊→聖靈、福音→福音、預言者→先知、使徒→使徒、信者→信徒、教会→教會、宣教師→宣教士（不可照抄日文的「宣教師」，也不用「傳教士」）、恩恵→恩典、艱難→患難、来世→來世、永生→永生、デンマルク→丹麥、ネルソン→納爾遜、後世への最大遺物→給後世的最大遺物。
