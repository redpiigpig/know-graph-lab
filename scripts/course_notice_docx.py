...
# 🚨 **最終版在使用者的 玄奘\博一上\教學\115-1修課須知\，那是他手改的，絕不覆蓋。**
#    2026-09-09 他把四份都改過（連次數與範圍都改了）並交代「不要再覆蓋掉」。
#    本腳本只出「版本」到知識圖工作室；要更新最終版由他自己複製過去。
OUTDIR = Path(r'G:\我的雲端硬碟\資料\知識圖工作室\教學') / '115-1修課須知（版本）'
