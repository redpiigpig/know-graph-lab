...
HYMNS: list[tuple[int, str, int, str, str]] = [
    ...
    (6,  'Πρωτογόνου',                    5,  'PROTOGONUS',     '致普羅托格諾斯（初生者）'),
...
NAMES = {
    ...
    'Aither': '埃忒耳', 'Protogonus': '普羅托格諾斯', 'Phanes': '法涅斯',
    ...
    'Hypnos': '許普諾斯', 'Oneiros': '俄涅伊洛斯', 'Thanatos': '塔納托斯',
