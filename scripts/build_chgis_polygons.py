...
DYNASTIES = [
    ...
    ("Southern Dynasties (Southern Qi)", "南齊", [(490, "南齊")]),
    ("Southern Dynasties (Liang)", "梁", [
        (510, "梁武帝初"),
        (540, "梁武帝末"),
    ]),
    ("Southern Dynasties (Chen)", "陳", [(570, "陳")]),
    ("Sui Empire", "隋", [
        (590, "隋文帝統一"),
        (610, "煬帝極盛"),
    ]),
    ...
    ("Southern Tang", "南唐", [(960, "南唐末")]),
    ("Southern Han", "南漢", [(960, "南漢末")]),
    ("Later Shu", "後蜀", [(960, "後蜀末")]),
    ("Min", "閩", [(940, "閩")]),
    ("Chu (Ten Kingdoms)", "楚", [(940, "楚")]),
    ("Northern Han", "北漢", [(970, "北漢末")]),
    ("Song Empire", "北宋", [
        (980, "宋初"),
        (1020, "真宗"),
        (1050, "仁宗"),
