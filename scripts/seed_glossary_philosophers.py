...
F("Avicenna", "伊本‧西那", lang="ar", var="阿維森納（Avicenna 拉丁化）；阿維桑那",
  school="伊斯蘭亞里斯多德主義", era="中世紀", nat="波斯", by=980, dy=1037,
  reason="按阿拉伯原文 Ibn Sīnā；拉丁化「阿維森納」退為變體（《治療論》《醫典》）")
F("Al-Ghazali", "安薩里", lang="ar", var="加札利；安薩理", school="蘇菲／阿什爾里",
  era="中世紀", nat="波斯", by=1058, dy=1111, reason="《哲學家的矛盾》")
F("Averroes", "伊本‧魯世德", lang="ar", var="阿威羅伊（Averroes 拉丁化）",
  school="伊斯蘭亞里斯多德主義", era="中世紀", nat="安達盧斯", by=1126, dy=1198,
  reason="按阿拉伯原文 Ibn Rushd；拉丁化「阿威羅伊」退為變體")
