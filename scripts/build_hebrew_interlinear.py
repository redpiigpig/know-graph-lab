...
2e. 以下是先前抽驗抓到的固定錯法，一律照右邊標：
    - 冠詞 הַ 不要譯成「這」：הַשָּׁמַיִם＝諸天、הַמַּיִם＝水、הָאָרֶץ＝地、הָעָם＝百姓。
      只有真的作指示用（「這一日」）才寫「這」。
    - אֵת／אֶת 接在動詞後帶直接受詞時＝（受詞記號）；只有當它真的是介系詞
      「與…一同」時才寫「與」。וְאֶת 同理＝並（受詞記號）。
    - בָּרוּךְ 指上帝時一律「當受稱頌的」，指人時一律「蒙福的」，不要每段換一種寫法。
    - אֱלֹהִים＝上帝、אֱלֹהֵינוּ＝我們的上帝、אֱלֹהֵי＝…的上帝（本讀本的繁中聖經是
      和合本修訂版上帝版，這一條優先於下面參考詞庫裡的「神」）。
    - ה׳ 是聖名縮寫，一律標「耶和華」。
