...
5. **城邦官職與祭儀職事依「春秋制」register 定譯**（見 translation-glossary 的「官制與行政區」頁）——希臘城邦對應春秋列國，**嚴禁用總督／行省／省長／監察官／主持官／委員會／團這類明清或現代的詞**：
   ...
   場所：ἄλσος→聖林（非泛稱聖所）、hippodrome→馬埒（漢語固有詞，非和製漢語「競馬場」）。
6. **神名與人名用這些定譯**：宙斯、狄蜜特、珀耳塞福涅、阿波羅、阿緹米絲、雅典娜、赫拉、阿芙羅黛蒂、戴奧尼索斯、赫密士、波塞頓、赫斯提亞、慈心女神（Eumenides）、**慈心者宙斯（Zeus Eumenes）**、**和善者宙斯（Zeus Meilichios）**、先祖靈（Tritopatres）、英雄（heroes）。宙斯的各種稱號務必彼此區分，不可兩個稱號譯成同一個名。不確定的神名音譯即可，不要創造意譯。
7. **英譯裡的圓括號（編者補充說明）保留為中文全形括號**；方括號〔〕表示石面已缺而由編者補入，若英譯有就保留。
8. 中間點用「‧」，全文繁體，不得出現簡體字或日文漢字寫法。
9. **不得增補英譯沒有的內容。** 看不懂的專名照音譯，寧可生硬不可臆造。
...
- 已定案不可改：宙斯、狄蜜特、珀耳塞福涅、阿波羅、阿緹米絲、雅典娜、赫拉、阿芙羅黛蒂、戴奧尼索斯、赫密士、波塞頓、赫斯提亞、慈心女神（Eumenides）、先祖靈（Tritopatres）。
