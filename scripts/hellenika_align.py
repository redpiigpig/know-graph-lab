...
5. **神名與人名用這些定譯**：宙斯、狄蜜特、珀耳塞福涅、阿波羅、阿緹米絲、雅典娜、赫拉、阿芙羅黛蒂、戴奧尼索斯、赫密士、波塞頓、赫斯提亞、慈心女神（Eumenides）、**慈心者宙斯（Zeus Eumenes）**、**和善者宙斯（Zeus Meilichios）**、先祖靈（Tritopatres）、英雄（heroes）。宙斯的各種稱號務必彼此區分，不可兩個稱號譯成同一個名。不確定的神名音譯即可，不要創造意譯。
