...
6. **神名與人名用這些定譯**：宙斯、得墨忒耳、珀耳塞福涅、阿波羅、阿爾忒彌斯、雅典娜、赫拉、阿芙羅狄忒、戴奧尼索斯、赫爾墨斯、波塞頓、赫斯提亞、慈心女神（Eumenides）、**慈心者宙斯（Zeus Eumenes）**、**和善者宙斯（Zeus Meilichios）**、先祖靈（Tritopatres）、英雄（heroes）。宙斯的各種稱號務必彼此區分，不可兩個稱號譯成同一個名。不確定的神名音譯即可，不要創造意譯。
