...
4. **神名與人名用這些定譯**：宙斯、赫拉、波塞頓、得墨忒耳、赫斯提亞、雅典娜、阿波羅、阿爾忒彌斯、阿芙羅狄忒、赫爾墨斯、阿瑞斯、赫菲斯托斯、戴奧尼索斯、克洛諾斯、瑞亞、烏拉諾斯、蓋亞、塔爾塔羅斯、厄洛斯、涅墨西斯、繆斯、命運三女神、復仇女神、泰坦、獨眼巨人、百手巨人、俄刻阿諾斯、忒堤斯、赫利俄斯、塞勒涅、厄俄斯、珀耳塞福涅、哈得斯、普羅米修斯、厄庇米修斯、潘朵拉、赫拉克勒斯、佩加索斯。
...
10. **祭儀讚歌（俄耳甫斯讚歌、荷馬詩頌）以「呼名」為主體**：整首多半是一串接一串
    的稱號堆疊而非敘事。稱號**逐一譯出、順序不動**，不可歸併成一句順口的話，也
    不可為求通順而略去其中幾個——那串稱號本身就是這類文本的宗教內容。
11. 段首圓括號裡的 **The Fumigation from X／with X** 是該首讚歌的焚香指示，
    譯作「（焚香：X）」自成一行，不要併進正文。
