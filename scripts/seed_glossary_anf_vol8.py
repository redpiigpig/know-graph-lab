...
ENTRIES = [
    ...
    ("Clement of Rome (Pseudo-Clementine narrator)","Clemens Romanus","羅馬的革利免",          "person"),
    ...
    ("Pseudo-Clementine Recognitions",        "Recognitiones",      "偽革利免《再認集》",       "work"),
    ("Pseudo-Clementine Homilies",            "Homiliae Clementinae","偽革利免《講道集》",     "work"),
