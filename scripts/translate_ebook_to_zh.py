...
NVIDIA_MODELS = ["nvidia/nemotron-3-super-120b-a12b"]
...
7. **腳註標記原樣保留**（極重要 — reader 靠這些 markers 做跳轉與引用）：
   ...
   - 末尾若有 `————————…` 分隔線後跟 `(1) text` `(2) text` 區段 = 腳註正文區塊：
       ...
       · 編號後的本文翻成繁中
       · 不要合併、不要省略
8. **數字寫法**：西元的年、月、日一律用阿拉伯數字（1969年2月18日、1960年代），不寫「一九六九年」「二月」；
   四位數以上的非整數盡量用阿拉伯數字（1,382人），整數可照中文（四千年、兩萬人）；章名序號與詩句照中文。
