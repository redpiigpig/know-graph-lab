...
""",
    "en": """5. God 譯「神」。**全大寫的 LORD（用來代替神名）譯「上主」**，不要改成「耶和華」；
   **一般的 Lord（主人、君王、對人的尊稱，或 Adonai）譯「主」，不可譯成「上主」——兩者必須分開**。
   欽定本的「Lord GOD」與 NIV 的「Sovereign LORD」（主耶和華）譯「主上主」；全大寫的 GOD 單獨出現時譯「上主」。
   原文直接寫出神名 Jehovah（美國標準譯本）的，譯「耶和華」。
