/**
 * Headless screenshot helper for /genealogy/consecration-tree.
 * Usage:
...
const { data: linkData, error: linkErr } = await admin.auth.admin.generateLink({
  ...
  options: { redirectTo: APP_BASE + '/genealogy/consecration-tree' },
})
...
console.log(`→ Loading /genealogy/consecration-tree`)
await page.goto(APP_BASE + '/genealogy/consecration-tree', { waitUntil: 'domcontentloaded', timeout: 90000 })
