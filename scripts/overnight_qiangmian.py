...
def polish_with_haiku(client, raw_transcript: str, title: str, ppt_text: str) -> str:
    prompt = POLISH_PROMPT.format(title=title, ppt_text=ppt_text[:4000], raw=raw_transcript)
    # Use streaming API because max_tokens=32000 may exceed 10-min SDK limit
