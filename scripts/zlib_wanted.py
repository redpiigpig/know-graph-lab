...
PRIORITY = {
    ...
    # 使用者 2026-09-14 點名擴充：聖經研究四組各十位（舊約／新約／典外文獻／
    # 聖經批判史），22 → 67 筆。原本落在最低層 60，那一層有十幾份書單在輪，
    # 一天分到 1 個名額，等於這 45 筆新的要等上兩個月。
    # 🚨 聖經批判史那一組（斯賓諾莎 1670 到史懷哲 1906）**幾乎全是公有領域**，
    # archive.org 的命中率遠高於 z-lib 而且合法免費 —— 那一組的原文應該走
    # `archive_org_fetch.py`，留在這裡的主要價值是撿中譯本。
    "biblical-studies": 20,
