...
R("Neo-Babylonian City", "邑", etype="行政區", polity="新巴比倫帝國", register="春秋制",
  level="二級", tier="地方", reason="城邑")
# 迦太基（春秋制：商業寡頭城邦；suffete 與希伯來 shophet 同源）
_order = 2300
R("Suffete", "士師", o="šofeṭ", lang="phn", polity="迦太基", register="春秋制",
  level="中央", tier="中央", var="二正卿",
  reason="歲選之最高行政長官（二人），與希伯來 shophet／周官士師同為「司法治理者」")
R("Adirim (Council of Elders)", "元老院", o="ʾadīrīm", lang="phn", etype="機構", polity="迦太基",
  register="春秋制", level="中央", tier="中央", var="長老會；三百人會", reason="商業貴族之議政元老院")
R("Tribunal of 104", "百四憲台", o="mīʾat wə-ʾarbaʿ", lang="phn", etype="機構", polity="迦太基",
  register="春秋制", level="中央", tier="司法", var="百人法庭；監軍憲台", reason="監督將帥之司法審查團（一百零四人）")
R("Carthaginian General", "大將軍", o="rab", lang="phn", polity="迦太基", register="春秋制",
  level="中央", tier="軍事", var="主帥", reason="與士師分立之軍事統帥（如巴卡家族）")
R("Libyan District", "郡", etype="行政區", polity="迦太基", register="春秋制",
  level="一級", tier="地方", reason="北非利比亞人腹地之納貢郡")
R("District Governor (Carthage)", "郡守", polity="迦太基", register="春秋制",
  level="一級", tier="地方", reason="迦太基派駐之郡級長官，重稅利比亞人")
R("Subject City (Carthage)", "屬邑", etype="行政區", polity="迦太基", register="春秋制",
  level="二級", tier="地方", var="腓尼基姊妹城", reason="納貢自治之腓尼基屬邑（如烏提卡）")
R("Carthaginian Town Head", "邑宰", polity="迦太基", register="春秋制",
...
# 孔雀-印度帝國（戰國秦制：《政事論》法家式中央集權）
_order = 2800
R("Mauryan Chief Minister", "丞相", o="mantrin", lang="sa", polity="孔雀-印度帝國", register="戰國秦制",
  level="中央", tier="中央", var="大臣；amatya", reason="首輔（考底利耶著《政事論》，如法家）")
R("Purohita", "國師", o="purohita", lang="sa", polity="孔雀-印度帝國", register="戰國秦制",
  level="中央", tier="中央", var="太師；王家祭司", reason="婆羅門王家祭司兼顧問")
R("Senapati", "大將軍", o="senāpati", lang="sa", polity="孔雀-印度帝國", register="戰國秦制",
  level="中央", tier="軍事", var="太尉", reason="全軍統帥")
R("Samaharta", "大司農", o="samāhartṛ", lang="sa", polity="孔雀-印度帝國", register="戰國秦制",
  level="中央", tier="財政", var="治粟內史", reason="總掌賦稅徵收")
R("Gudhapurusha (Spies)", "繡衣使者", o="gūḍhapuruṣa", lang="sa", polity="孔雀-印度帝國",
  register="戰國秦制", level="監察", tier="中央", var="密探；間者", reason="《政事論》情報密探網，如秦繡衣直指")
R("Mauryan Province", "省", o="pradeśa", lang="sa", etype="行政區", polity="孔雀-印度帝國",
  register="戰國秦制", level="一級", tier="地方", var="州；chakra", reason="王子分鎮之大省（四大省都）")
R("Kumara (Viceroy)", "分鎮王子", o="kumāra", lang="sa", polity="孔雀-印度帝國", register="戰國秦制",
  level="一級", tier="地方", var="王子總督；aryaputra", reason="皇子出鎮大省（塔克西拉/優禪尼）")
R("Mauryan District", "郡", o="āhāra", lang="sa", etype="行政區", polity="孔雀-印度帝國",
  register="戰國秦制", level="二級", tier="地方", var="viṣaya", reason="省下之郡")
R("Rajuka", "郡守", o="rājūka", lang="sa", polity="孔雀-印度帝國", register="戰國秦制",
  level="二級", tier="地方", reason="郡級行政與司法長官")
R("Mauryan Village", "里", o="grāma", lang="sa", etype="行政區", polity="孔雀-印度帝國",
  register="戰國秦制", level="三級", tier="地方", reason="基層村落")
R("Gramika", "里正", o="grāmika", lang="sa", polity="孔雀-印度帝國", register="戰國秦制",
  level="三級", tier="地方", reason="村長")
...
# 笈多-印度帝國（魏晉制：帝國＋samanta 封建藩王之古典盛世）
_order = 4200
R("Gupta Chief Minister", "丞相", o="mantrin", lang="sa", polity="笈多-印度帝國", register="魏晉制",
  level="中央", tier="中央", var="mantri-mukhya", reason="首輔")
R("Sandhivigrahika", "大鴻臚", o="sāndhivigrahika", lang="sa", polity="笈多-印度帝國", register="魏晉制",
  level="中央", tier="中央", var="外務；戰和大臣", reason="掌戰與和之外交大臣")
R("Mahabaladhikrita", "大將軍", o="mahābalādhikṛta", lang="sa", polity="笈多-印度帝國", register="魏晉制",
  level="中央", tier="軍事", reason="全軍統帥")
R("Akshapataladhikrita", "大司農", o="akṣapaṭalādhikṛta", lang="sa", polity="笈多-印度帝國",
  register="魏晉制", level="中央", tier="財政", var="度支", reason="總掌財計簿冊")
R("Samanta", "藩王", o="sāmanta", lang="sa", polity="笈多-印度帝國", register="魏晉制",
  level="羈縻", tier="地方", var="屬國；封臣王", reason="臣服納貢之封建藩王，如魏晉屬國")
R("Bhukti", "州", o="bhukti", lang="sa", etype="行政區", polity="笈多-印度帝國", register="魏晉制",
  level="一級", tier="地方", var="省", reason="一級大行政區")
R("Uparika", "刺史", o="uparika", lang="sa", polity="笈多-印度帝國", register="魏晉制",
  level="一級", tier="地方", var="州牧；省長", reason="州之長官，常由王子任")
R("Vishaya", "郡", o="viṣaya", lang="sa", etype="行政區", polity="笈多-印度帝國", register="魏晉制",
  level="二級", tier="地方", reason="州下之郡")
R("Vishayapati", "太守", o="viṣayapati", lang="sa", polity="笈多-印度帝國", register="魏晉制",
  level="二級", tier="地方", reason="郡之長官")
R("Gupta Village", "里", o="grāma", lang="sa", etype="行政區", polity="笈多-印度帝國", register="魏晉制",
  level="三級", tier="地方", reason="基層村落")
R("Gramika (Gupta)", "里正", o="grāmika", lang="sa", polity="笈多-印度帝國", register="魏晉制",
  level="三級", tier="地方", var="村議會 panchayat", reason="村長，與村議會共治")
...
# 匈奴帝國（遼金元制：左右翼＋十進位騎兵；漢史已備譯名）
_order = 6300
R("Chanyu", "單于", rom="chanyu", polity="匈奴帝國", register="遼金元制",
  level="中央", tier="中央", var="大單于", reason="匈奴最高君主（漢史譯名）")
R("Gudu Marquis", "骨都侯", polity="匈奴帝國", register="遼金元制",
  level="中央", tier="中央", var="異姓輔政", reason="異姓貴族（呼衍/蘭氏）之輔政大臣")
R("Xiongnu Wing", "左方／右方", etype="行政區", polity="匈奴帝國", register="遼金元制",
  level="超一級", tier="軍事", var="左右翼", reason="帝國分東(左)西(右)兩翼")
R("Wise King", "左賢王／右賢王", polity="匈奴帝國", register="遼金元制",
  level="超一級", tier="軍事", var="屠耆王", reason="統左右翼之最高王（左賢王常為儲君）")
R("Myriarch (Xiongnu)", "萬騎長", polity="匈奴帝國", register="遼金元制",
  level="一級", tier="軍事", var="萬戶；二十四長", reason="二十四位「萬騎」之長")
R("Chiliarch (Xiongnu)", "千長", polity="匈奴帝國", register="遼金元制",
  level="二級", tier="軍事", var="千騎長", reason="千人之長")
R("Centurion (Xiongnu)", "百長", polity="匈奴帝國", register="遼金元制",
  level="三級", tier="軍事", var="百騎長", reason="百人之長")
# 突厥汗國（遼金元制：可汗＋葉護＋設；唐史已備譯名）
_order = 6400
R("Khagan", "可汗", rom="qaghan", lang="otk", polity="突厥汗國", register="遼金元制",
  level="中央", tier="中央", var="大汗", reason="突厥最高君主")
R("Yabgu", "葉護", rom="yabgu", lang="otk", polity="突厥汗國", register="遼金元制",
  level="中央", tier="中央", var="副汗", reason="位次可汗之副君（唐史譯名）")
R("Tegin", "特勤", rom="tegin", lang="otk", polity="突厥汗國", register="遼金元制",
  level="中央", tier="中央", var="汗族王子", reason="可汗子弟之封號")
R("Shad", "設", rom="shad", lang="otk", polity="突厥汗國", register="遼金元制",
  level="超一級", tier="軍事", var="察；領兵親王", reason="統轄一廂（東/西）之領兵親王")
R("Irkin", "俟斤", rom="irkin", lang="otk", polity="突厥汗國", register="遼金元制",
  level="一級", tier="地方", var="部落首領", reason="部落酋長")
R("Turkic Chiliarch", "千戶", polity="突厥汗國", register="遼金元制",
  level="二級", tier="軍事", reason="千戶編制")
R("Turkic Centurion", "百戶", polity="突厥汗國", register="遼金元制",
  level="三級", tier="軍事", reason="百戶編制")
...
R("Landgrave", "君侯", o="Landgraf", lang="de", polity="神聖羅馬帝國", register="周封建五等爵",
  level="二級", tier="封爵", var="方伯；領邦伯", reason="直屬皇帝之領邦君侯（「方伯」過於上古，改君侯合中古味）")
...
# 查理曼-卡洛林帝國（周封建五等爵：西周式分封建國＋王官巡狩）
_order = 8600
R("Carolingian Emperor", "皇帝", o="Imperator", lang="la", polity="查理曼-卡洛林帝國",
  register="周封建五等爵", level="中央", tier="中央", var="天子；查理曼", reason="西方復興之皇帝，如周武王分封建國")
R("Carolingian Arch-Chancellor", "大相", o="archicancellarius", lang="la", polity="查理曼-卡洛林帝國",
  register="周封建五等爵", level="中央", tier="中央", var="尚書令；掌璽", reason="掌詔令文書之首相")
R("Count Palatine", "宮廷伯", o="comes palatii", lang="la", polity="查理曼-卡洛林帝國",
  register="周封建五等爵", level="中央", tier="司法", var="廷尉；宮伯", reason="王宮法庭之最高法官")
R("Missi Dominici", "巡按使", o="missi dominici", lang="la", polity="查理曼-卡洛林帝國",
  register="周封建五等爵", level="中央", tier="監察", var="欽差；巡察使", reason="成對出巡（一俗一教）監察諸伯之欽使，如漢刺史/唐巡按")
R("Carolingian Sub-kingdom", "分封王國", etype="行政區", polity="查理曼-卡洛林帝國",
  register="周封建五等爵", level="超一級", tier="封爵", var="王子之國", reason="皇子分封之王國（義大利/阿基坦）")
R("Sub-king (Carolingian)", "分封王子", o="rex", lang="la", polity="查理曼-卡洛林帝國",
  register="周封建五等爵", level="超一級", tier="封爵", reason="出鎮分國之皇子")
R("Comitatus (County)", "郡", o="comitatus", lang="la", etype="行政區", polity="查理曼-卡洛林帝國",
  register="周封建五等爵", level="一級", tier="地方", var="伯國", reason="伯所轄之郡")
R("Comes (Carolingian)", "伯", o="comes", lang="la", polity="查理曼-卡洛林帝國", register="周封建五等爵",
  level="一級", tier="地方", var="郡守；伯爵", root="伯", reason="查理曼時代為朝廷命官（非世襲），職近太守")
R("Marca (March)", "邊區", o="marca", lang="la", etype="行政區", polity="查理曼-卡洛林帝國",
  register="周封建五等爵", level="一級", tier="軍事", var="邊郡", reason="邊防軍區")
R("Margrave (Carolingian)", "邊侯", o="marchio", lang="la", polity="查理曼-卡洛林帝國",
  register="周封建五等爵", level="一級", tier="軍事", var="邊將", reason="邊區統帥（如西班牙邊區）")
R("Centena (Hundred)", "鄉", o="centena", lang="la", etype="行政區", polity="查理曼-卡洛林帝國",
  register="周封建五等爵", level="二級", tier="地方", var="百戶區", reason="郡下之鄉/百戶區")
R("Centenarius", "亭長", o="centenarius", lang="la", polity="查理曼-卡洛林帝國", register="周封建五等爵",
  level="二級", tier="地方", var="鄉長；vicarius", reason="鄉之長")
