...
GRID = [
    ...
    (1, 6, 7, 'study', '宗教經濟學專題研討', '賴建誠　妙然 208',
     'BBJ025‧博士班 2A‧專選‧2 學分'),
    (2, 1, 2, 'study', '初階宗教學日文文獻選讀（旁聽）', '倪杰　妙然 M201',
     'BBA224‧碩士班 1A‧旁聽‧不計學分'),
    ...
    (3, 13, 13, 'tutor', '國中家教', '20:00–21:00', ''),
    (4, 9, 9, 'tutor', '小三家教', '16:15–17:15', ''),
    (5, 13, 13, 'tutor', '國中家教', '20:00–21:00', ''),
...
def legend(doc):
    ...
    _font(p.add_run('教課 4 門 8 學分‧修課 6 門 12 學分（日文旁聽不計）‧家教 3 場／週'),
