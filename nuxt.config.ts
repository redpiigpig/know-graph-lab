...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    // 研究語料（普世運動／洛桑／愛丁堡／DOAJ／佛學辭典）。辭典那批 12 部、
    // 10.3 萬條、28.6 MB JSONL，由 server/utils/glossaries.ts 首次查詢時載進記憶體。
    corpusRoot: process.env.CORPUS_ROOT || "G:/我的雲端硬碟/資料/知識圖工作室/_corpus",
