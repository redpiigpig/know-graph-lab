<template>
  <div class="flex flex-col bg-slate-50 min-h-dvh">
    <AppHeader title="信條對照" :back="{ to: '/scripture-canon/christianity', label: '基督教典籍' }" container-class="max-w-5xl">
      <template #actions>
        <span class="text-xs text-gray-400">{{ ALL_CREEDS.length }} 份</span>
      </template>
    </AppHeader>
...
/** 多份文件會議的「主卡片」標題（特利騰 25 場／梵一 2 份／梵二 16 份等） */
...
const COUNCIL_TOPICS: Record<number, string> = {
  19: '反宗教改革 ／ 正典聖經 ／ 七件聖事 ／ 成義論 ／ 聖體變質說 ／ 彌撒聖祭 ／ 大規模紀律改革 — 跨 18 年共 25 會期，奠定特利騰天主教 (Tridentine Catholicism) 之神學與紀律基礎',
