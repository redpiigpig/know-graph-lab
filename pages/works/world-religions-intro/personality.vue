    ...
    <div class="max-w-3xl mx-auto px-5 py-10">
      ...
      <section v-if="stage === 'intro'">
        ...
        <p class="text-[15px] leading-[1.95] text-gray-600 mb-4">
          二十個情境，沒有對錯，也不問你信什麼。答完會得到四個字，那是你在四個問題上的傾向——
          <span class="text-[#16181d]">神聖在哪裡、你怎麼認識它、你在哪裡修、你怎麼看這個世界。</span>
        </p>
        <p class="text-[15px] leading-[1.95] text-gray-600 mb-8">
          四個問題各有兩個答案，交叉出十六型。人類幾千年來的宗教傳統，大致也就落在這十六格裡。
          等一下我們用這個結果分組，接下來四週的報告，你會研究跟自己最像的那一類。
        </p>
...
const QUESTIONS: { axis: AxisKey; text: string; pos: string; neg: string }[] = [
  { axis: 'a', text: '你第一次走進一座陌生的宗教場所，最先注意到的是什麼？', pos: '高處那尊神像或十字架，讓人不自覺抬頭', neg: '角落裡有個人跪著，安靜地掉眼淚' },
  { axis: 'b', text: '對一個你完全不懂的宗教感到好奇，你會先做什麼？', pos: '找一本書或一支影片，先弄懂它在說什麼', neg: '直接去參加一次他們的聚會，看看是什麼感覺' },
  { axis: 'c', text: '什麼時候你比較容易靜下來？', pos: '一群人一起唸同一段話的時候', neg: '房間裡只剩自己一個人的時候' },
  { axis: 'd', text: '如果信仰要你做一件事，你希望是哪一件？', pos: '去改變一件你看不下去的不公平', neg: '把自己這個人修好' },
  { axis: 'a', text: '「神聖」對你來說比較像什麼？', pos: '從遠方傳來的呼喚，大過我能理解的範圍', neg: '心裡忽然安靜下來的那一瞬間' },
  { axis: 'b', text: '聽一段完全聽不懂的誦經或聖歌，你的反應是？', pos: '想知道那些字到底在講什麼', neg: '不用懂，讓聲音把自己包起來就好' },
  { axis: 'c', text: '節慶那天你會怎麼安排？', pos: '跟大家一起去擠廟口或教堂，人多才有氣氛', neg: '挑人少的時間再去，才看得進去' },
  { axis: 'd', text: '看到社會上的爭議，你覺得宗教團體應該？', pos: '明確表態，站出來說話', neg: '保持距離，專心把自己的事做好' },
  { axis: 'a', text: '朋友問你「人為什麼會受苦」，你比較想這樣回答：', pos: '有一個更大的安排，只是我們現在看不見', neg: '苦本身沒有答案，但人可以在裡面長出東西來' },
  { axis: 'b', text: '關於「神到底存不存在」，你的傾向是？', pos: '這件事要好好定義、好好論證', neg: '這種事講不清楚，經歷過的人自己知道' },
  { axis: 'c', text: '人生遇到大難關，你會？', pos: '找一群信得過的人一起面對', neg: '先自己安靜下來想清楚' },
  { axis: 'd', text: '「放下」這兩個字，你的第一個反應是？', pos: '有些事情不能放下，放下就沒人管了', neg: '放下才自由，抓著只是折磨自己' },
  { axis: 'a', text: '下面哪一句話比較能打動你？', pos: '「祂在高處，垂聽我的聲音。」', neg: '「一花一世界，一葉一如來。」' },
  { axis: 'b', text: '要你準備參加一場很重要的儀式，你會？', pos: '先把流程和它的意思讀懂', neg: '把心情調整好就夠了，到現場自然知道' },
  { axis: 'c', text: '你覺得信仰比較像什麼？', pos: '一群人一起走的一條路', neg: '一個人自己的功課' },
  { axis: 'd', text: '你理想中的宗教生活比較接近哪一種？', pos: '在人群裡服務，忙一點也沒關係', neg: '在安靜的地方修行，少一點打擾' },
  { axis: 'a', text: '要為你最重視的東西找一個地方安放，你選？', pos: '山頂上的一座聖殿', neg: '老家那個熟悉的院子' },
  { axis: 'b', text: '你比較相信哪一種說法？', pos: '想清楚了，才算真的懂', neg: '身體先知道了，腦袋才慢慢追上' },
  { axis: 'c', text: '要你帶一次宗教體驗活動，你會設計成？', pos: '大家一起做同一件事，一起唸、一起走', neg: '各自找一個角落，安靜地體會' },
  { axis: 'd', text: '對這個世界，你的感覺比較接近？', pos: '它值得我們花力氣去改造', neg: '它本來就會過去，不必太執著' },
]
