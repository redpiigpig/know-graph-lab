<template>
  <div class="genealogy-page flex flex-col bg-slate-50" style="height: 100dvh;">
    ...
    <!-- Canvas: flex-1 fills all remaining space automatically -->
...
// ─── Legend state ──────────────────────────────────────────
const colorLegend     = ref<Record<string, string>>({})   // hex → name
const lineStyleLegend = ref<Record<string, string>>({})   // dashStyleId → name
