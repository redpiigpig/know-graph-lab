<template>
  <div class="min-h-screen bg-slate-50">
    ...
    <AppHeader title="年議會歷屆大會名表" :back="{ to: '/research-data/taiwan-methodist', label: '台灣衛理公會研究資料' }" container-class="max-w-6xl" />
...
const records: ConferenceRecord[] = [
  ...
  { type: '中華年議會', session: '第二十屆', location: '台北東吳大學', date: '民國七十二年七月十九日至廿四日', chair: '吳英武', secretary: '蕢建華 林拔高' },
  ...
  { type: '中華年議會', session: '第二十四屆', location: '台北衛理福音園', date: '民國七十六年七月十五日至十六日', chair: '蕢建華', secretary: '郝文章 曾紀平' },
  { type: '中華年議會', session: '第二十五屆', location: '台北衛理福音園', date: '民國七十七年七月十八日至二十日', chair: '蕢建華', secretary: '吳承禧 鍾思波' },
  { type: '中華年議會', session: '第二十六屆臨時年議會', location: '台北衛理福音園', date: '民國七十八年五月六日', chair: '蕢建華', secretary: '郝文章 曾紀平' },
  { type: '中華年議會', session: '第二十六屆', location: '台北衛理福音園', date: '民國七十八年七月十七日至十八日', chair: '蕢建華', secretary: '郝文章 曾紀平' },
  { type: '中華年議會', session: '第二十七屆', location: '台北衛理福音園', date: '民國七十九年七月五日至七日', chair: '蕢建華', secretary: '曾紀鴻 許珂' },
  { type: '中華年議會', session: '第二十八屆', location: '台北衛理福音園', date: '民國八十年七月十五日至十六日', chair: '蕢建華', secretary: '陳家厚 曾長森' },
  { type: '中華年議會', session: '第二十九屆臨時年議會', location: '台北衛理福音園', date: '民國八十一年四月二十日至廿一日', chair: '蕢建華', secretary: '林長贈 蔡敏勝' },
  { type: '中華年議會', session: '第二十九屆', location: '台北衛理福音園', date: '民國八十一年七月十五日至十七日', chair: '蕢建華', secretary: '林長贈 蔡敏勝' },
  ...
  { type: '中華年議會', session: '第三十四屆', location: '台北衛理福音園', date: '民國八十六年七月十七日至十八日', chair: '曾紀鴻', secretary: '蕢建華 謝毓駿' },
  ...
  { type: '中華年議會', session: '第四十二屆年議會第一次會議', location: '台北衛理福音園', date: '民國九十四年五月二十日', chair: '蕢建華', secretary: '唐秋惠 高麗穗' },
  { type: '中華年議會', session: '第四十三屆年議會第一次會議', location: '台北衛理福音園', date: '民國九十五年五月二十五日至二十六日', chair: '蕢建華', secretary: '嚴明華 唐基微' },
  { type: '中華年議會', session: '第四十四屆年議會第一次會議', location: '台北衛理福音園', date: '民國九十六年二月二十七日', chair: '蕢建華', secretary: '黃寬裕 藍思琪' },
  { type: '中華年議會', session: '第四十四屆年議會第二次會議', location: '台北衛理福音園', date: '民國九十六年五月三十一日至六月一日', chair: '蕢建華', secretary: '黃寬裕 藍思琪' },
  { type: '中華年議會', session: '第四十五屆年議會第一次會議', location: '台北衛理福音園', date: '民國九十七年五月廿三日至五月廿四日', chair: '蕢建華', secretary: '林烽銓 李承譽' },
  { type: '中華年議會', session: '第四十六屆年議會第一次會議', location: '台北衛理福音園', date: '民國九十八年五月廿一日至五月廿二日', chair: '蕢建華', secretary: '關鎮威 陳碧娥' },
  { type: '中華年議會', session: '第四十七屆年議會第一次會議', location: '台北衛理福音園', date: '民國九十九年二月廿六日至二月廿七日', chair: '蕢建華', secretary: '徐雪坪 趙慧敏' },
  { type: '中華年議會', session: '第四十七屆年議會第二次會議', location: '台北衛理福音園', date: '民國九十九年五月廿八日至五月廿九日', chair: '蕢建華', secretary: '徐雪坪 何家淑' },
