    ...
    <div class="flex-1 flex items-start justify-center px-6 py-12">
      <div class="w-full max-w-3xl">
        ...
        <div class="mt-10 text-xs text-gray-400 leading-relaxed text-center">
          <p>每個傳統下收該宗教的聖典多版本、教義／信條、法規與經典註釋等對照工具。基督教已上線八個子工具，佛教已上線大藏經全文，祆教已上線四藏書目。</p>
        </div>
      </div>
    </div>
  </div>
...
const religions = [
  ...
  {
    path: '/scripture-canon/zoroastrianism',
    icon: '🔥',
    title: '祆教',
    desc: '祆教經典四藏 —— 阿維斯陀（耶斯那／維斯佩拉德／祓魔法典／耶什特／小阿維斯陀／殘篇）＋巴列維文獻＋後期波斯語外典＋王室銘文附錄；原文轉寫（可切阿維斯陀字母）／英譯／繁中三欄對照',
    enabled: true,
  },
  {
