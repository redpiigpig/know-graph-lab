<template>
  <div class="flex flex-col bg-slate-50 min-h-dvh">
    <AppHeader title="諾斯底主義文獻" :back="{ to: '/scripture-canon/christianity', label: '經典對照' }" container-class="max-w-6xl">
      <template #actions>
        <span class="text-xs text-gray-400">{{ docs.length }} 篇 / {{ CATEGORY_ORDER.length }} 類</span>
      </template>
    </AppHeader>
