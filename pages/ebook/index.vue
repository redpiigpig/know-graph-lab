...
const CATEGORY_TREE: CategoryDef[] = [
  { value: "哲學", icon: "🔭", children: [
    "近代哲學", "哲學原典", "經典與解釋輯刊", "中國思想史", "哲學通史",
    "黎明，西洋哲學史", "形上學", "倫理學", "當代哲學",
    "古希臘哲學", "東方哲學", "政治哲學",
  ]},
  { value: "神學", icon: "⛪", children: [
    "教父著作", "中世紀著作", "改教著作",
    { group: "近現代著作", children: ["近現代著作", "教父研究", "中世紀研究", "改教研究"] },
    "教科書/概論", "主題專論",
    "倫理神學", "靈修神學",
    "神學詮釋/哲學", "本地化處境神學",
  ]},
  { value: "宗教學", icon: "📖", children: [
    "神話學", "宗教史", "宗教對話", "World Religions系列", "宗教社會學",
  ]},
  { value: "世界宗教", icon: "🕌", children: [
    { group: "基督教", children: ["教會法典與信條", "IVP - 古代基督信仰聖經註釋叢書", "基督教典外文獻"] },
    "猶太教", "東亞宗教", "波斯宗教",
    "佛教", "伊斯蘭教", "印度教", "其他宗教", "摩門教",
  ]},
  { value: "心理學", icon: "🧠", children: ["生死學", "認知科學"] },
  { value: "人類生物學", icon: "🧬", children: [
    "人類大歷史", "生物學", "人類起源與進化史", "人類文化-語言學",
  ]},
  { value: "自然科學", icon: "🔬", children: [] },
  { value: "歷史學", icon: "📜", children: [
    "東方界域史", "全球通史", "西方界域史", "中央界域史",
    "史料原典", "近代史", "亞太界域史", "美州界域史",
    "通史", "地區史", "史學理論",
  ]},
  { value: "文學", icon: "✍️", children: ["小說", "文學評論"] },
  { value: "社會政治學", icon: "🏛️", children: [
    "政治學", "資本主義-社會主義", "知識社會學", "社會學",
    "性學", "名家作品", "國際關係",
  ]},
]
