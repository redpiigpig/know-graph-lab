    ...
    <div class="flex-1 max-w-5xl w-full mx-auto px-6 py-10">
      <div class="mb-8">
        ...
        <p class="text-xs text-gray-400 leading-relaxed mt-1">
          <b>編次原則</b>：希臘卷前十四卷按文本在希臘宗教中的權威位階與成書早晚排，不按所敘事件先後——荷馬與赫西俄德是希臘人真正當經在讀的東西，故居首；後十卷按成書年代排，卷內亦由早到晚。
        </p>
      ...
      <div class="mt-4 text-xs text-gray-400 leading-relaxed border-t border-gray-200 pt-4">
        ...
        <p class="mt-1">兩部有少數重疊條目（如赫西俄德《神譜》、德爾菲神諭），在該部列為「前藏」的啟示母體前驅，在本部則是本經；同一部書在兩座圖書館各有其位置，以互見標記串連，不作合併。</p>
      </div>
    </div>
  </div>
</template>
