...
const features = [
  { icon: '🎯', t: '五軍突破', d: '陸海空、海陸、憲五大軍種，依序攻堅一一突破。' },
  { icon: '📈', t: '品質成長', d: '服從 · 體力 · 耐力 · 定力 · 挑戰，隨訓練累積。' },
  { icon: '🎖️', t: '軍階晉升', d: '累積 XP 由二等兵晉升至上士，解鎖榮譽徽章。' },
  { icon: '📓', t: '每日回報', d: '寫下當日日記交由教官批閱、評分與獎懲。' },
]
</script>
