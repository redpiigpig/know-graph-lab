...
const eventsPlanned = [
  ...
  },
  {
    date: '2026/11/14',
    days: '1 天',
    name: '輔仁大學宗教學系 2026 年國際學術研討會「宗教理論的傳承與創新」',
    place: '輔仁大學',
    host: '輔仁大學宗教學系',
    url: '',
    todo: '有發表。摘要經籌備委員會邀請專家審查通過，🚨 全文與投影片須於 2026/10/15 前繳交。一律現場發表，不接受視訊。',
  },
  {
    date: '2027 年 8 月（待公布）',
    days: '2 天',
...
const publications = [
  { title: '聖嚴法師與法鼓系統對「印順學派之成立」的影響與歷史交織', venue: '第二十四屆「印順導師思想之理論與實踐」國際學術會議', date: '2026/8/28–29', state: '已發表', inProgram: false },
  { title: '龐君華會督的衛斯理神學實踐與「新修道主義」願景', venue: '台灣宗教學會 2026 年會「靈性運動、療癒與諮詢」', date: '2026/10/23–24', state: '預計發表（與廖丞譽合著）', inProgram: true },
  { title: '他者的上帝：從基督教認識論的去中心化到「跨界者」的宗教學方法論', venue: '輔仁大學宗教學系 2026 年國際學術研討會「宗教理論的傳承與創新」', date: '2026/11/14', state: '摘要已投，全文 10/15 前繳', inProgram: true },
...
const gates = [
  ...
  { n: '05', t: '發表兩篇審稿論文', p: '4 篇進行中', s: 'run', d: '具審稿制度之研討會或專業學術期刊　·　第五條「在學期間」' },
