<template>
  <div class="flex flex-col bg-slate-50 min-h-dvh">
    <AppHeader title="全球八大人文宗教界域" :back="{ to: '/maps', label: '地圖繪製' }" container-class="max-w-full">
      <template #actions>
        <span class="hidden sm:inline text-xs text-gray-400">The Eight Global Realms</span>
