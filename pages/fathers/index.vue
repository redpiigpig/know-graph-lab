...
const ORIGINAL_IDS = new Set([
  ...
  '709f43f9-724c-4cd5-b6b0-570d26083d24',  // la 12 段 — 希拉里《論三位一體》十二卷
  '75d8aae0-7431-4be9-baee-c57d26599653',  // la 9 段 — 拉克坦提烏《神學原理》卷一、拉克坦提烏《論逼迫者之死》
  '76df31fe-e732-4aa6-88c2-d650a09fb688',  // grc 6 段 — 金口若望《論司祭職》
  ...
  'a7e5956e-8851-4d0f-b3d2-1f823d1bdc81',  // la 14 段 — 耶柔米《名人傳》135 章
  'c98d358d-7066-4691-a896-b7232707b0db',  // grc 60 段 — ANF 第一卷的希臘原典
  'df789501-5620-4833-a0a0-6e8f1a031bb1',  // la 112 段 — 奧古斯丁反伯拉糾論戰十二部
  'd229a6d4-14de-4e28-92de-4855c75cbf68',  // la 76 段 — 耶柔米《書信集》150 封
...
const series = [
  ...
  { key: 'NPNF2', label: 'NPNF2 尼後教父第二系列', subtitle: '東方教父：亞他那修、巴西流、格列高里、希拉流 等 · 14 卷' },
...
const ZH_TITLES: Record<string, string> = {
  ...
  'ANF-6':  '行異能者格列高里、亞歷山卓的狄奧尼修、阿弗里卡努斯、亞納托利烏、阿基老、美多第烏、阿爾諾比烏斯',
