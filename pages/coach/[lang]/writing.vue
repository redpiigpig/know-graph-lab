    ...
    <div class="flex-1 p-5 max-w-2xl mx-auto w-full space-y-4">
      ...
      <div class="bg-white rounded-2xl border border-gray-100 p-5 space-y-3">
        ...
        <div class="flex items-center gap-2">
          <button @click="correct" :disabled="correcting || !text.trim()" class="px-5 py-2 rounded-xl bg-indigo-600 text-white text-sm font-semibold disabled:opacity-40 hover:bg-indigo-700 transition">{{ correcting ? '批改中…' : '逐句批改' }}</button>
