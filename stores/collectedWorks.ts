    ...
    // ────────────────────────────────────────────────────────────────
    {
      ...
      works: [
        ...
        },
        {
          ...
          status: 'copyright',
          note: '德文原典 1929 前出版部分屬公有領域；Hull 英譯仍受版權。',
        },
        {
          title: '實驗研究（字詞聯想）（CW 2）',
        ...
        {
          title: '精神疾病的心理成因（CW 3）',
          titleOriginal: 'The Psychogenesis of Mental Disease',
          year: '1907–58',
          yearSort: 3,
          category: '《全集》各卷（CW / GW）',
          status: 'copyright',
          note: '含 1907《早發性癡呆心理學》（德文原典公有領域）。',
        },
        {
          title: '佛洛伊德與精神分析（CW 4）',
          titleOriginal: 'Freud and Psychoanalysis',
          year: '1906–16',
          yearSort: 4,
          category: '《全集》各卷（CW / GW）',
          status: 'copyright',
          note: '部分早期德文論文 1929 前公有領域；Hull 英譯仍受版權。',
        },
        {
          title: '轉化的象徵（CW 5）',
          ...
          category: '《全集》各卷（CW / GW）',
          status: 'copyright',
          note: '1912 原典的大幅改寫本；受版權至 2031，待合法來源（早期版見上）。',
        },
        {
          title: '心理類型（CW 6）',
        ...
        },
        {
          ...
          category: '《全集》各卷（CW / GW）',
          status: 'copyright',
          note: '煉金術三部之一（含《金花的祕密》評註、佐西默斯異象）。',
        },
        {
          title: '神祕合體（CW 14）',
          ...
          category: '《全集》各卷（CW / GW）',
          status: 'copyright',
          note: '煉金術三部之一；榮格晚年集大成。',
        },
        {
          title: '人、藝術與文學中的精神（CW 15）',
