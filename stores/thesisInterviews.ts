 ...
 *   2) G:\我的雲端硬碟\資料\知識圖工作室\研究資料\大愛道革命\口述訪談\ 各日期資料夾，
...
export const useThesisInterviewsStore = defineStore('thesisInterviews', () => {
  ...
  const published = ref<PublishedInterview[]>([
    ...
    { id: 'zhanxk', name: '詹錫奎先生', role: '前自由時報副刊主編、雅痞日記專欄作家、新台灣周刊社長', date: '2024.05.23', category: '社運界', filename: '05.23 詹錫奎先生口述訪談紀錄' },
    { id: 'zhuzh', name: '朱增宏先生', role: '台灣動物社會研究會執行長、關懷生命協會前秘書長', date: '2024.05.28', category: '社運界', filename: '05.28 朱增宏先生口述訪談紀錄' },
    ...
    { id: 'linrz', name: '林蓉芝居士', role: '中華佛寺協會秘書長、宗教立法研究者', date: '2024.09.03', category: '其他', filename: '09.03 林蓉芝居士口述訪談紀錄' },
    { id: 'kuanqian', name: '釋寬謙法師', role: '覺風佛教藝術文化基金會董事長、永修精舍住持', date: '2024.09.19', category: '法師', filename: '09.19 釋寬謙法師口述訪談紀錄' },
  ])
