...
export const useSacredBooksEastStore = defineStore('sacredBooksEast', () => {
  ...
  const volumes = ref<SbeVolume[]>([
    { vol: 1, titleZh: '奧義書（上）', titleEn: 'The Upanishads, Part I', translatorZh: '穆勒', translatorEn: 'F. Max Müller', year: 1879, tradition: 'veda', status: 'planned' },
    ...
    { vol: 4, titleZh: '阿維斯陀（一）：祓魔法典', titleEn: 'The Zend-Avesta, Part I (Vendîdâd)', translatorZh: '達梅斯特', translatorEn: 'James Darmesteter', year: 1880, tradition: 'zoroastrian', status: 'planned' },
    ...
    { vol: 6, titleZh: '古蘭經（上）', titleEn: "The Qur'ân, Part I", translatorZh: '帕爾默', translatorEn: 'E. H. Palmer', year: 1880, tradition: 'islam', status: 'planned' },
    ...
    { vol: 10, titleZh: '法句經／經集', titleEn: 'The Dhammapada / The Sutta-Nipâta', translatorZh: '穆勒／法斯伯爾', translatorEn: 'F. Max Müller / V. Fausböll', year: 1881, tradition: 'buddhism', status: 'planned' },
    ...
    { vol: 16, titleZh: '儒家經籍（二）：易經', titleEn: 'The Texts of Confucianism, Part II (Yî King)', translatorZh: '理雅各', translatorEn: 'James Legge', year: 1882, tradition: 'china', status: 'planned' },
    ...
    { vol: 22, titleZh: '耆那教經典（一）', titleEn: 'Jaina Sûtras, Part I', translatorZh: '雅各比', translatorEn: 'Hermann Jacobi', year: 1884, tradition: 'jainism', status: 'planned' },
