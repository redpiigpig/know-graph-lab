...
export const useSacredBooksEastStore = defineStore('sacredBooksEast', () => {
  ...
  const volumes = ref<SbeVolume[]>([
    ...
    { vol: 4, titleZh: '阿維斯陀（一）：萬迪達德', titleEn: 'The Zend-Avesta, Part I (Vendîdâd)', translatorZh: '達梅斯特', translatorEn: 'James Darmesteter', year: 1880, tradition: 'zoroastrian', status: 'in-progress', ebookId: '55555504-5555-4555-8555-555555555555', archiveId: 'zendavesta00darmgoog', note: '英文已上架；繁中翻譯進行中。' },
    ...
    { vol: 31, titleZh: '阿維斯陀（三）：亞斯納等', titleEn: 'The Zend-Avesta, Part III (Yasna, Visparad, etc.)', translatorZh: '米爾斯', translatorEn: 'L. H. Mills', year: 1887, tradition: 'zoroastrian', status: 'planned' },
