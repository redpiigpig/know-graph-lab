...
export const POPES: Pope[] = [
  // ════════════════════ 21 世紀 ════════════════════
  {
    ...
    century: 21,
    nationality: '美國／秘魯',
    notesZh: '第 267 任教宗。第一位來自美國的教宗，奧思定會士；2015 起任秘魯 Chiclayo 教區主教，後歸化秘魯籍；2023 升樞機並出任主教部部長。2025-05-08 於方濟各逝後當選；選名 Leo 承襲良十三世社會訓導與工人關懷的傳承，並回應 AI 時代對人類尊嚴的新挑戰。官方中譯為「良十四世」（2025-05 台灣主教團公布）。',
  },
  {
    slug: 'francis',
    nameZh: '方濟各',
