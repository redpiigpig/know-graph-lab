...
> 最後更新：2026-05-28
> 目前狀態：**177 篇 / 39 位教宗**（4c-21c）；popes-catalog 227 位（4c Damasus I 起，pre-Damasus 已刪除）
...
### 4. Pius X / Benedict XV（20c 早期）

vatican.va 提供完整英拉雙語：
- Pius X 1903-14：8 篇 encyclical
- Benedict XV 1914-22：12 篇 encyclical

**動作項**：
- [ ] 用既有 `scripts/_batch_papal_ingest.py`（vatican.va pipeline）跑 pius10 + ben15
- [ ] 或走 papalencyclicals.net 雙源 pipeline（已驗證）
