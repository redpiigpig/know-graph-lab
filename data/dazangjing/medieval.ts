...
export const MEDIEVAL_ERA: DazangEra = {
  ...
  glyph: '經',
  genres: '聖經‧標準本‧註釋聖經',
  summary: '中世紀基督教世界通行的聖經正文與其權威版本、註釋傳統，以及與之並立的他宗教啟示經典。正經部收武加大標準本與經院時代的註釋聖經；外藏收伊斯蘭與猶太兩大啟示傳統的根本經典。',
  portal: { to: '/scripture', label: '聖經閱讀器' },
  zheng: {
    summary: '拉丁西方 800–1500 通行之聖經正文與其權威版本。卡爾大帝時代由阿爾琴主導的校訂奠定中世紀聖經文本，至十三世紀巴黎大學形成標準章節編排，經院神學則以《通用註釋》為閱讀骨架。',
    divisions: [
      {
        key: 'standard-bible',
        label: '正經部‧通行聖經',
        label_en: 'The Standard Bible',
        desc: '中世紀拉丁西方公認的聖經正文與其校訂、編排傳統。',
        works: [
          ...
          { title_zh: '巴黎聖經', title_orig: 'Biblia Parisiensia', author: '巴黎大學書坊群', era: '約 1230', place: '巴黎', language: '拉丁文', intro: '巴黎聖經為十三世紀巴黎大學周邊書坊量產的單冊武加大聖經，採用統一的卷序、序言與如今通行的章節劃分（傳由斯蒂芬·朗頓奠定），並以小開本便於攜帶研讀。它使聖經從多冊巨帙轉為人手一部的工具書，標準化了經文引用方式，深刻影響經院神學的講授與辯論。此版本是中世紀盛期聖經文本標準化的關鍵成果，後世印刷聖經的編排多承其制。' },
    ...
    divisions: [
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '一聖通諭', title_orig: 'Unam Sanctam', author: '教宗卜尼法八世', era: '1302', place: '羅馬', language: '拉丁文', intro: '《一聖通諭》是教宗卜尼法八世在與法王腓力四世衝突白熱化時頒布的教宗詔書，宣告教會唯一、教宗為基督在世唯一元首，並提出「兩劍論」——屬靈與屬世二權皆屬教會，世俗君權須服從屬靈權威，結語斷言一切受造之人服從羅馬教宗乃得救之必要。它是中世紀教宗至上主張最極端的表述，在教會法與教俗權力理論史上極具分量。', link: '/encyclicals' }
        ]
      },
      {
        key: 'monastic-rules',
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '標準註釋聖經', title_orig: 'Glossa Ordinaria', author: '拉昂的安瑟莫及其學派（編纂群）', era: '12 世紀', place: '拉昂／巴黎', language: '拉丁文', intro: '標準註釋聖經是中世紀通行的聖經註釋彙編，於聖經正文的行間與頁緣排印教父與權威的釋義，行間注（interlinear gloss）釋字句、邊注（marginal gloss）引長篇詮解。其骨幹由拉昂的安瑟莫學派於十二世紀奠定，集奧古斯丁、耶柔米、貝達等釋經精華於一頁。它是經院神學課堂的基本教材，塑造了中世紀讀經與講授的方式，影響達數百年。', link: '/fathers' },
