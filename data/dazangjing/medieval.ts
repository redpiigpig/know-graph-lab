    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '第一次拉特朗會議(第九次大公會議)', title_orig: 'Concilium Lateranense I', author: '教宗卡利克斯特二世', era: '1123', place: '羅馬‧拉特朗', language: '拉丁文', intro: '第一次拉特朗會議是西方拉丁教會召開的首次大公會議，由教宗卡利克斯特二世主持，旨在確認結束敘任權之爭的《沃爾姆斯協約》。會議頒布多條教規，禁止買賣聖職、重申神職獨身、規範教產與教會選舉。它標誌教宗改革（額我略改革）成果的鞏固，確立教會在屬靈職務任命上的自主，是中世紀教會法的重要里程碑。', link: '/creeds' },
          ...
          { title_zh: '倫敦會議法令（1102）', title_orig: 'Concilium Londoniense (1102)', author: '坎特伯里總主教安瑟倫主持', era: '1102', place: '倫敦西敏', language: '拉丁文', intro: '安瑟倫主持的倫敦會議法令，首度明文譴責販賣英格蘭人為奴的貿易。中世紀教會反奴隸買賣的先聲條文，改革派主教立法的代表案例。' },
          ...
          { title_zh: '黑衣修士會議譴責法令', title_orig: 'Blackfriars Council (1382)', author: '坎特伯里總主教考特尼主持', era: '1382', place: '倫敦黑衣修士院', language: '拉丁文', intro: '考特尼主持譴責威克里夫二十四條命題的會議，地震適至而得「地震會議」之名。羅拉德運動遭壓制的法律開端，宗教改革前史的英格蘭一頁。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '靜修派會議法令', title_orig: 'Synodi Palamiticae (1341, 1347, 1351)', author: '君士坦丁堡歷次會議', era: '1341–1351', place: '君士坦丁堡', language: '希臘文', intro: '裁定帕拉馬斯靜修神學為正統、確立神之本質與能量之分的歷次會議法令。晚期拜占庭神學的定調立法，正統禮儀年「帕拉馬斯主日」的法源。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '林德伍德教省法規彙編', title_orig: 'Provinciale (seu Constitutiones Angliae)', author: '威廉‧林德伍德', era: '1433', place: '倫敦', language: '拉丁文', intro: '林德伍德輯注坎特伯里教省歷代法規的彙編，逐條附學理注釋。中世紀英格蘭教會法的總集，英國教會法學的奠基文本。' },
          { title_zh: '喬巴姆聽告解大全', title_orig: 'Summa confessorum (Thomas de Chobham)', author: '託馬斯‧喬巴姆', era: '約 1216', place: '索爾茲伯里', language: '拉丁文', intro: '喬巴姆為聽告解司鐸編寫的實務大全，職業倫理逐行業剖析。拉特朗四世年度告解制的配套手冊，中世紀日常道德生活的透視鏡。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '道明會憲章', title_orig: 'Constitutiones Ordinis Praedicatorum', author: '道明(Dominicus)及早期總會', era: '約 1216–1228', place: '土魯斯‧波隆那', language: '拉丁文', intro: '道明會憲章是宣道兄弟會（道明會）的根本法規，在採用奧思定會規之外另立會憲，規定以宣道與救靈為宗旨、重視神學研讀、實行托缽貧窮，並建立以總會、省會、各院議會逐級代議與選舉的治理制度。其代議式架構被譽為中世紀最先進的修會憲政之一。它使學術研究與宣道使命制度化，深刻影響經院神學的興盛（阿奎那、大阿爾伯特皆出此會）。' },
          ...
          { title_zh: '克呂尼慣例集', title_orig: 'Consuetudines Cluniacenses', author: '克呂尼修士伯爾納與烏爾里希（輯錄）', era: '11 世紀', place: '克呂尼', language: '拉丁文', intro: '克呂尼修院日課、禮儀與院務慣例的成文輯錄，詳至燭火與手勢暗語。本篤會規的克呂尼實施細則，中世紀修道日常最細密的白描。' },
          ...
          { title_zh: '普雷蒙特雷會規章', title_orig: 'Statuta Ordinis Praemonstratensis', author: '普雷蒙特雷會（聖諾伯特創始）', era: '約 1140 成文', place: '普雷蒙特雷', language: '拉丁文', intro: '諾伯特所創詠禮司鐸會的規章，奧思定會規之上疊加熙篤式總會議制。修道嚴規與牧靈使命結合的體制設計，白衣詠禮司鐸的生活法度。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '奧思定隱修會聯合詔書', title_orig: 'Licet ecclesiae catholicae', author: '教宗亞歷山大四世', era: '1256', place: '羅馬', language: '拉丁文', intro: '亞歷山大四世將義大利諸隱修團體合併為奧思定隱修會的詔書。託缽修會第四支的誕生文件，日後路德所出修會的法律起點。' },
      ...
      },
      {
        ...
        works: [
          { title_zh: '克拉倫登憲章', title_orig: 'Constitutions of Clarendon', author: '英王亨利二世', era: '1164', place: '克拉倫登', language: '拉丁文', intro: '亨利二世申明王權對教士審判與教會上訴管轄的十六條憲章，貝克特拒署而流亡。坎特伯里血案的法律導火線，英格蘭政教管轄之爭的核心文本。' },
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '論造物六日', title_orig: 'De natura et origine rerum', author: '大阿爾伯特', era: '約 1250', place: '科隆／巴黎', language: '拉丁文', intro: '大阿爾伯特學識淵博，被尊為「全能博士」，廣註亞里斯多德全集並融會自然哲學、礦物、植物與動物之學。其著作將希臘與阿拉伯的科學知識引入拉丁學界，主張理性探究自然與信仰並行不悖。身為多瑪斯‧阿奎那之師，他為亞里斯多德主義在基督教神學中的接納鋪路，是經院全盛期百科全書式的學術巨人。', note: '泛指其亞里斯多德註疏與自然哲學著作群', link: '/fathers' },
          { title_zh: '神學大全', title_orig: 'Summa Theologiae', author: '多瑪斯‧阿奎那', era: '1265–1274', place: '羅馬／巴黎／那不勒斯', language: '拉丁文', intro: '阿奎那畢生神學的總綱，分三大部論上帝、人的德行與道德生活、基督與聖事。採「問題—異議—反之—我說—答辯」的辯證體例，融合亞里斯多德哲學與奧古斯丁傳統，建構出條理嚴密的天主教神學體系。其「五路」論證上帝存在、自然法理論與恩典與本性的關係，影響後世至深，至今仍是天主教神哲學的根本經典，惜作者臨終前擱筆未竟。', link: '/fathers' },
          { title_zh: '哲學大全（駁異教大全）', title_orig: 'Summa contra Gentiles', author: '多瑪斯‧阿奎那', era: '約 1259–1265', place: '巴黎／義大利', language: '拉丁文', intro: '此書旨在面向不接受聖經權威的對象（尤指穆斯林與猶太哲人）以純理性辯護基督信仰，分四卷論上帝、受造、天意與信仰奧祕。前三卷盡力以哲學論證可由理性企及之真理，第四卷則處理三一、道成肉身等須靠啟示方知的信理。其護教進路與當時拉丁學界面對阿拉伯亞里斯多德主義的挑戰密切相關，是中世紀理性神學的代表作。', link: '/fathers' },
        ...
        ,
          ...
          { title_zh: '論真理（辯論問題集）', title_orig: 'Quaestiones disputatae de veritate', author: '多瑪斯‧阿奎那', era: '約 1256–1259', place: '巴黎', language: '拉丁文', intro: '阿奎那首次任教巴黎期間主持公開辯論的記錄，凡二十九題二百餘條，前半論真理、知識、上帝之知、天意、預定（知識論與神的全知），後半論善、意志、自由、良知與信望愛諸德及恩寵。以「異議—反之—我說—答辯」的完整辯論體例深入剖析，展現經院「爭議問題（quaestio disputata）」體例的成熟，為《神學大全》諸題奠基，是研究阿奎那思想形成的關鍵文本。', extent: '二十九問' },
          { title_zh: '論存有與本質', title_orig: 'De Ente et Essentia', author: '多瑪斯‧阿奎那', era: '約 1252–1256', place: '巴黎', language: '拉丁文', intro: '阿奎那青年時期所作的形上學短論，篇幅雖小而為其哲學奠基。書中釐清「存有（esse）」與「本質（essentia）」之分，主張除上帝外一切受造物的本質與其存在皆為實在的區分，唯獨上帝的本質即其存在；並闡述本質在實體、偶性、純靈與上帝中的不同存在方式。是理解托馬斯式形上學「存在優先」核心洞見的入門經典。', extent: '短論一篇' },
          { title_zh: '神學綱要', title_orig: 'Compendium theologiae', author: '多瑪斯‧阿奎那', era: '約 1272–1273', place: '那不勒斯', language: '拉丁文', intro: '阿奎那晚年應其摯友兼祕書雷吉納德之請而作的簡明神學總綱，原擬依「信、望、愛」三德架構統攝全部信理，惜未竟而止於信、望兩部。相較《神學大全》的鉅細靡遺，此書以精煉條理直陳要義，是理解阿奎那思想體系的入門綱領，亦見其臨終前對神學整體的最後綜觀。' },
          { title_zh: '黃金鎖鏈（四福音教父註疏輯）', title_orig: 'Catena aurea', author: '多瑪斯‧阿奎那', era: '約 1262–1268（馬太卷 1262–1264 於奧爾維耶托；馬可／路加／約翰三卷在烏爾班四世 1264 年逝後於羅馬完成）', place: '奧爾維耶托（馬太卷）／羅馬（其餘三卷）', language: '拉丁文', intro: '阿奎那應教宗烏爾班四世之請編纂的四福音逐節註釋，輯錄逾八十位希臘與拉丁教父之語，環環相扣如金鏈，故名。此書首度大量引入東方教父（如金口若望、區利羅）的拉丁譯文，補西方註經傳統之闕，既是經院釋經的典範，亦保存了若干今已散佚之教父殘篇，兼具神學與文獻雙重價值。', extent: '四卷（按四福音）' },
          ...
          { title_zh: '論技藝歸於神學', title_orig: 'De Reductione Artium ad Theologiam', author: '波那文圖拉', era: '十三世紀中葉', place: '巴黎', language: '拉丁文', intro: '波那文圖拉短論，主張一切人類知識與技藝（機械技藝、感官知識、哲學）皆以聖經之光為源、以神學為歸，呈現方濟會「萬學朝向上帝」的知識總綱。' },
          { title_zh: '六日創世講論', title_orig: 'Collationes in Hexaemeron', author: '波那文圖拉', era: '1273', place: '巴黎', language: '拉丁文', intro: '波那文圖拉晚年於巴黎方濟會院所作的系列講論（未竟），借創世六日喻基督中心的智慧層級，批判亞里斯多德主義之偏失，被視為其神學思想的總結與對拉丁亞維羅伊主義的回應。' },
          ...
          { title_zh: '語錄註（里米尼的額我略）', title_orig: 'Lectura super Sententias', author: '里米尼的額我略', era: '約 1343–1346', place: '巴黎', language: '拉丁文', intro: '奧思定會神學家里米尼的額我略在巴黎講授《四部語錄》的註釋，以嚴格的奧古斯丁恩寵論著稱，力斥半伯拉糾主義，強調人得救全賴神恩、無功自誇，因其嚴峻立場而被稱「孩童折磨者（tortor infantium）」。他兼採奧坎唯名論的邏輯工具，於無限、連續與認識論諸題亦有原創貢獻。是中世紀晚期奧古斯丁學派的代表，預示宗教改革對恩典與預定的強調。', extent: '《語錄》前二卷註' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '為靜修者辯護', title_orig: 'Triades pro sanctis hesychastis', author: '格列高里‧帕拉馬斯', era: '約 1338–1341', place: '阿索斯聖山／塞薩洛尼基', language: '希臘文', intro: '帕拉馬斯為阿索斯山靜修士的祈禱經驗辯護，回應加拉布里亞的巴爾拉姆之攻擊，闡發上帝「本質」與「能量（energeiai）」之分：人雖無法企及不可知的神性本質，卻能真實分享其非受造的能量（如他泊山之光）而與神合一。此論於 1351 年君士坦丁堡公會議獲確認為正教信理，奠定東方神化（theosis）神學的根基，是拜占庭晚期最重要的神學成就。', link: '/fathers' },
          { title_zh: '靜修派文獻', title_orig: 'Hesychasm（合集）', author: '阿索斯山靜修傳統諸師', era: '14 世紀', place: '阿索斯聖山', language: '希臘文', intro: '靜修主義是拜占庭晚期的內在祈禱運動，以不斷誦念「耶穌禱文」、調節呼吸與內斂心神，追求心靈寧靜（hesychia）與默觀神光。其修行傳統上溯沙漠教父與西奈的格列高里，經帕拉馬斯神學辯護而臻成熟。這批文獻記錄了修行法門與靈修指導，深刻塑造東方正教的靈修面貌，後世匯為《愛神集（Philokalia）》流傳至斯拉夫世界。', link: '/fathers' },
          { title_zh: '神學講論（神聖之愛之歌）', title_orig: 'Hymns of Divine Love / Catecheses', author: '新神學家西默盎', era: '約 1000', place: '君士坦丁堡', language: '希臘文', intro: '西默盎被尊為繼使徒約翰與拿先斯的格列高里後唯一稱「神學家」者，其講論與聖歌以熱烈的第一人稱見證神光的親身經驗，強調聖靈臨在的具體可感與意識可知。他主張真正的神學出自與上帝的直接相遇而非單純學問，為日後靜修主義鋪路。其著作將早期沙漠靈修的密契傳統帶入拜占庭中期，是東方神祕神學承先啟後的關鍵。', link: '/fathers' }
        ,
          { title_zh: '一百五十章（自然·神學·倫理·靜修篇）', title_orig: 'Capita CL physica, theologica, moralia et practica', author: '格列高里‧帕拉馬斯（Gregorios Palamas）', era: '約 1349–1350', place: '希臘塞薩洛尼基（帖撒羅尼迦）', language: '希臘文', intro: '帕拉馬斯於 1347 年靜修派神學在君士坦丁堡公會議獲勝後所撰的格言體神學精要，凡一百五十章，自人類知識的本性與自然哲學論起，及於上帝的形象、三一、本質（οὐσία）與能量（ἐνέργειαι）之分、聖靈論及靜修之道。以簡明條目濃縮《三聯論》的核心思想，奠定東正教「神之能量可被人領受、本質不可知」的帕拉馬斯神學，後經 1351 年會議定為正統教義，是繼《三聯論》之後其神學體系最凝練的表述。', extent: '一百五十章' },
          { title_zh: '為神聖靜修者辯護（三聯論）', title_orig: 'Ὑπὲρ τῶν ἱερῶς ἡσυχαζόντων (Triads in Defense of the Holy Hesychasts)', author: '格列高里‧帕拉馬斯（Gregorios Palamas）', era: '約 1338–1341', place: '希臘亞陀斯聖山／帖撒羅尼迦', language: '希臘文', intro: '回應卡拉布里亞哲人巴爾拉姆對亞陀斯靜修士（hesychasts）「耶穌禱文」與見「他泊之光」攻擊而作的三組各三篇論文。帕拉馬斯區分上帝不可知的「本質」與可被受造者分享的「能量」（energeiai），主張靜修者在禱中所見之光即神的非受造能量，人可分受上帝的非受造能力而真實神化，奠定東正教神祕神學「帕拉瑪主義」的根基，後經 1341、1351 年大公會議確認。' },
          ...
          { title_zh: '教座答辯（聖父為唯一根源論）', title_orig: 'De processione Spiritus Sancti / Περὶ τῆς ἐκπορεύσεως τοῦ Ἁγίου Πνεύματος', author: '尼魯斯‧卡巴西拉斯', era: '約 1355–1363', place: '帖撒羅尼迦', language: '希臘文', intro: '尼魯斯‧卡巴西拉斯繼帕拉馬斯任帖撒羅尼迦總主教，並參與起草 1351 年會議定案。此書系統反駁拉丁「和子說」與教宗首席權，主張聖父為三一中唯一根源，是拜占庭晚期反拉丁護教與三一神學的代表作，亦為佛羅倫斯合一會議前東方立場的權威表述。' },
          ...
          { title_zh: '教座答辯文書（聖神由聖子永恆顯現論）', title_orig: 'Tomus fidei / De processione Spiritus Sancti（1285 年大公會議文書）', author: '塞浦路斯的格列高里二世（Gregorios II Kyprios，君士坦丁堡牧首）', era: '1285（君士坦丁堡會議）', place: '君士坦丁堡', language: '希臘文', intro: '塞浦路斯的格列高里二世為回應里昂合一（1274）後的和子論爭而作的聖神論文書，獲 1285 年君士坦丁堡會議認可。他提出聖神「由聖子永恆顯現」（aïdios ekphansis）之說，作為介於佛提烏式嚴格立場與拉丁和子論之間的正教方案，深刻影響後來帕拉馬斯的本質—能量神學，是拜占庭晚期聖神論發展的重要環節。' },
          ...
          { title_zh: '駁帕拉馬斯論著（阿金迪諾斯）', title_orig: 'Antirrhetic Treatises against Palamas', author: '格列高里‧阿金迪諾斯', era: '約 1342–1347', place: '君士坦丁堡', language: '希臘文', intro: '阿金迪諾斯原為帕拉馬斯友人，後成為靜修主義神學最堅決的反對者，撰多篇駁論抨擊帕拉馬斯「神性本質與能量實有區別」之說，主張此分將危及神的單一性、近乎多神。其論著保存了反靜修陣營的核心論點，是理解十四世紀靜修之爭兩造交鋒的必讀文獻；雖其立場於 1351 年公會議被定為謬誤，文本史料價值極高。', extent: '駁論多篇' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '基督徒與撒拉森人辯論', title_orig: 'Disputatio Christiani et Saraceni (Disputation Between a Christian and a Saracen)', author: '傳大馬士革的若望（歸屬有爭議）', era: '約 8–9 世紀', place: '敘利亞／巴勒斯坦', language: '希臘文', intro: '以穆斯林問、基督徒答的短篇對話，圍繞善惡的成因、自由意志、基督作為上帝之道、聖母與受造界等問題展開，是拜占庭基督徒早期回應伊斯蘭神學詰問的代表文本。傳統收入大馬士革約翰著作，現代研究對確切作者仍有爭議；無論歸屬如何，它保存了八、九世紀基督教—伊斯蘭論辯的早期形態，應與《論以實瑪利人異端》並讀。' },
        ...
        ,
          { title_zh: '論信仰的理據——駁撒拉森人、希臘人與亞美尼亞人（致安提阿詠經長）', title_orig: 'De rationibus fidei contra Saracenos, Graecos et Armenos ad Cantorem Antiochenum', author: '多瑪斯‧阿奎那（Thomas Aquinas）', era: '約 1264', place: '義大利', language: '拉丁文', intro: '應安提阿詠經長之請而作的短篇護教書，回應東方基督徒在伊斯蘭環境中所遭的詰難：撒拉森人嘲笑三一與基督為神子之說，故前六章理性辯護三一、道成肉身、十字架與救贖；另設專章論聖體（駁亞美尼亞人）與煉獄（駁希臘人）。為阿奎那直接面對伊斯蘭挑戰的代表性護教文獻。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '德意志講道集', title_orig: 'Predigten / Deutsche Werke', author: '艾克哈特大師', era: '約 1300–1327', place: '科隆／埃爾福特／巴黎', language: '中古高地德語／拉丁文', intro: '道明會士艾克哈特以德語向修女與在俗信眾講道，闡發靈魂深處的「靈光（Seelenfünklein）」、神性的「無底深淵」與靈魂中「上帝之誕生」等密契主題，主張人當捨離一切、空乏自我以與神性合一。其大膽思辨與否定神學的語言招致異端指控，部分命題於 1329 年被定罪，然其影響深遠，啟發陶勒、蘇索及萊茵—弗蘭德密契學派，並激盪近代哲學與靈修。', link: '/fathers' },
        ...
        ,
          { title_zh: '論教會聖統制與天階體系註（偽狄奧尼修斯著作評註）', title_orig: 'Expositiones in Ierarchiam coelestem', author: '厄里根那（Johannes Scotus Eriugena）', era: '約 865–870（譯本 c. 860–862，評註本身稍晚）', place: '西法蘭克王國', language: '拉丁文', intro: '厄里根那將偽狄奧尼修斯《天階體系》譯為拉丁文並作評註，把東方否定神學（apophatic）與天使等級論引入拉丁西方，成為中世紀神祕神學的重要源頭。其譯注影響聖維克多學派、波那文圖拉乃至艾克哈特一系的默觀傳統。' },
          ...
          { title_zh: '成全之梯（完全之階梯）', title_orig: 'The Scale of Perfection (Scala Perfectionis)', author: '沃爾特‧希爾頓（Walter Hilton）', era: '約 1380–1396', place: '英格蘭索羅頓（奧思定會修道院）', language: '中古英語', intro: '奧思定詠禮會士希爾頓以英文寫給一位隱修女的靈修指南，分兩卷循序教導默觀生活：由改造罪人受損的「上帝形像」、潔淨罪垢，經黑暗與虛己，至重新成形於耶穌、在恩寵中與祂以愛與光契合。其文穩健平實、心理觀察細膩，避開過度激越的密契語言，調和行動與默觀、信德與經驗。是中世紀英格蘭密契文學與《不知之雲》《神聖之愛的啟示》並列的瑰寶，影響後世英語靈修甚深。', extent: '二卷' },
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '羅馬史（尼基弗魯斯‧格雷戈拉斯）', title_orig: 'Ῥωμαϊκὴ Ἱστορία / Byzantina Historia', author: '尼基弗魯斯‧格雷戈拉斯（Nikephoros Gregoras）', era: '14世紀中（約1359年止）', place: '君士坦丁堡', language: '拜占庭希臘文', intro: '記1204至1359年帕列奧洛戈斯朝史事，篇幅宏大。作者為反靜修主義（反帕拉馬斯）健將，後半部詳載靜修論爭，是研究14世紀拜占庭神學辯論與內戰最重要的當事人記述之一。' },
          { title_zh: '歷史四書（約翰六世‧坎塔庫澤努斯回憶錄）', title_orig: 'Ἱστοριῶν βιβλία δ\' / Historiarum libri IV', author: '約翰六世‧坎塔庫澤努斯（John VI Kantakouzenos）', era: '約1354–1383年（1354 退位出家為僧後撰寫，至 1383 年逝世前）', place: '曼加納修道院，君士坦丁堡', language: '拜占庭希臘文', intro: '退位為僧的皇帝親撰回憶錄，記1320至1356年內戰與其執政始末，採第三人稱自辯。兼為帕拉馬斯靜修神學的有力護教者，是極罕見由君主本人書寫、兼具政治史與神學辯護雙重身分的史傳。' },
    ...
    divisions: [
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '猶太王國志', source: 'rabbinic', title_orig: 'Josippon', author: '佚名（約瑟夫‧本‧古里安之名傳世）', era: '約 10 世紀', place: '義大利南部', language: '希伯來文', intro: '約十世紀在義大利南部編成的希伯來文猶太史著，主要重述約瑟夫斯、馬加比傳統與拉丁史料，自第二聖殿至羅馬戰爭鋪陳民族往事。它並非古代約瑟夫斯原作，而是中世紀猶太人面向自身讀者重建古代史的代表；依實際成書年代由古代移入中世紀外史傳藏，見證希伯來史學在基督教歐洲中的延續與改寫。', note: '原誤置古代；依實際成書年代移入中世紀' },
        ],
      },
      {
        key: 'yiduan-lingxiu',
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '狄奧多夫校訂本聖經', title_orig: 'Biblia Theodulfiana', author: '奧爾良的狄奧多夫', era: '約 800–818', place: '奧爾良／弗勒里', language: '拉丁文', intro: '西哥德出身的奧爾良主教狄奧多夫與阿爾琴同時，主持另一系統的武加大校訂。他以學者手法在頁邊標注異文來源（西班牙本、阿爾昆本等），近乎近代校勘記的先聲；其袖珍細字的「狄奧多夫聖經」現存數部，是加洛林文藝復興聖經文本工程的雙璧之一，惜其批判方法後世未獲承續。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '埃格伯特抄本', title_orig: 'Codex Egberti', author: '賴興瑙修道院書坊（額我略大師等）', era: '約 980–993', place: '賴興瑙島', language: '拉丁文', intro: '特里爾大主教埃格伯特委製的福音經課本，五十餘幅基督生平敘事畫為現存最早成套的福音圖傳之一，「額我略大師」的古典風格與賴興瑙書坊合作其間。它把經課文本與圖像敘事熔於一爐，今藏特里爾市立圖書館。' },
          ...
          { title_zh: '伯里聖經', title_orig: 'Bury Bible', author: '畫師胡戈', era: '約 1135', place: '伯裡聖埃德蒙茲修道院', language: '拉丁文', intro: '英格蘭羅曼式聖經的開山之作，職業畫師胡戈受僱為修道院繪製，濕潤厚重的「拜占庭化」人物開十二世紀英格蘭大聖經傳統之先。胡戈為文獻可考的最早英格蘭職業書畫師之一，此本今藏劍橋基督聖體學院帕克圖書館。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '阿塞馬尼福音抄本', title_orig: 'Codex Assemanius', author: '佚名抄經僧', era: '11 世紀', place: '奧赫里德文書圈', language: '教會斯拉夫文', intro: '格拉哥里字母的節選福音經課本，十八世紀由東方學家阿塞馬尼購自耶路撒冷而得名，今藏梵蒂岡圖書館。除經文外並附斯拉夫最早的曆書聖人紀念，兼具文本史與禮儀史價值，是奧赫里德書寫傳統的代表作。' },
          ...
          { title_zh: '奧斯特羅米爾福音書', title_orig: 'Ostromir Gospels', author: '執事格列高里（繕寫）', era: '1056–1057', place: '諾夫哥羅德', language: '教會斯拉夫文', intro: '現存最古有明確紀年的東斯拉夫書籍，由執事格列高里為諾夫哥羅德總督奧斯特羅米爾繕成，屬節選福音經課本，泥金裝飾華美。其題記明確繫年，成為俄語文獻學的起點座標；文本兼證西里爾與美多德譯文在羅斯的承傳，今藏聖彼得堡俄羅斯國家圖書館。' },
          ...
          { title_zh: '米羅斯拉夫福音書', title_orig: 'Miroslav Gospels', author: '繕寫者額我略等', era: '約 1180', place: '塞爾維亞扎胡姆列', language: '教會斯拉夫文', intro: '塞爾維亞王公米羅斯拉夫委製的福音經課本，融合拜占庭泥金與羅曼式裝飾母題，是塞爾維亞語書寫傳統現存最古的代表作。其三百餘幅飾繪為巴爾幹書藝之冠，二〇〇五年入選世界記憶名錄，今藏貝爾格勒國家博物館。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '古英語六經', title_orig: 'Old English Hexateuch', author: '艾爾弗里克等', era: '約 1000', place: '英格蘭', language: '古英語', intro: '修道院長艾爾弗里克與佚名譯者合力把摩西五經與約書亞記譯為古英語，倫敦藏彩繪本附四百餘幅插畫，為英語舊約翻譯之始。艾爾弗里克於序言坦陳對俗人誤讀律法的疑慮，此序成為中世紀翻譯理論的名篇。' },
          ...
          { title_zh: '威克里夫聖經（前期本）', title_orig: 'Wycliffite Bible, Early Version', author: '威克里夫學圈（赫里福德的尼古拉等）', era: '約 1382–1384', place: '牛津', language: '中古英語', intro: '威克里夫倡議、其牛津門人執譯的第一部完整英語聖經，逐字直譯武加大，拉丁語序斑斑可見。它把「聖經置於凡人之手」的主張化為文本實踐，遭教會禁絕而抄傳不輟，是宗教改革前英語世界最大規模的地下書籍運動。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '布爾貢迪奧希臘教父拉丁譯集', title_orig: 'Translationes Burgundionis Pisani', author: '比薩的布爾貢迪奧', era: '約 1150–1193', place: '比薩／君士坦丁堡', language: '拉丁文（譯自希臘文）', intro: '比薩法學家布爾貢迪奧屢任駐君士坦丁堡使節，通曉希臘文，將大馬士革的若望《正統信仰詳解》、金口若望福音講道集、尼撒的格列高理《論人的造成》等譯為拉丁文，並譯蓋倫醫書。其譯業使拉丁經院得以直接徵引希臘教父體系，隆巴德與阿奎那皆受其惠。' },
          { title_zh: '格羅斯泰斯特希臘譯業', title_orig: 'Translationes Roberti Grosseteste', author: '羅伯特‧格羅斯泰斯特', era: '約 1235–1253', place: '林肯', language: '拉丁文（譯自希臘文）', intro: '林肯主教格羅斯泰斯特晚年延聘希臘助手，重譯託名狄奧尼修斯全集並附詳注，又譯大馬士革的若望、《十二族長遺訓》與亞里斯多德《尼各馬可倫理學》。其譯風逐字精確，兼附語文學評註，把牛津的希臘學推上巔峰，為中世紀英格蘭最重要的希臘—拉丁譯者。' },
    ...
    divisions: [
      {
        ...
        works: [
          { title_zh: '教宗訓令', title_orig: 'Dictatus Papae', author: '額我略七世', era: '1075 年', place: '羅馬', language: '拉丁文', intro: '教宗額我略七世登錄於書信集中的二十七條格言式宣言，逐條主張羅馬教宗的至高權柄：唯教宗可廢立主教、可解除臣民對君主的效忠誓約、教宗永不謬誤等。此文是額我略改革與敘任權之爭的綱領，將教權凌駕王權的主張推至頂點，深刻形塑了中世紀政教關係的走向。', link: '/encyclicals' },
          ...
          { title_zh: '若望二十二世詔書與書信', title_orig: 'Epistolae Iohannis XXII', author: '教宗若望二十二世', era: '1316–1334', place: '亞維儂', language: '拉丁文', intro: '亞維儂教廷全盛期教宗若望二十二世的詔書與書信，涉方濟會神貧之爭、譴責艾克哈特命題、與巴伐利亞的路易帝位之爭，並設立蘇丹尼耶總教區經略波斯。其文書產量空前，展示十四世紀教廷財政與司法機器的巔峰運作。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '安瑟莫書信集', title_orig: 'Epistolae Anselmi', author: '坎特伯里的安瑟莫', era: '約 1070–1109', place: '貝克／坎特伯里', language: '拉丁文', intro: '安瑟莫存世書信四百七十餘封，自貝克修道院師友情誼到坎特伯里大主教任上與英王的敘任權抗爭，靈修懇切與原則堅定並見。其致修士的友愛書簡展現中世紀修道友誼神學的典範，是理解這位經院之父人格的第一門徑。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '費里耶爾的盧普斯書信集', title_orig: 'Epistolae Lupi Ferrariensis', author: '費里耶爾的盧普斯', era: '約 840–862', place: '費里耶爾', language: '拉丁文', intro: '加洛林院長盧普斯的一百三十餘封書信，四處借閱、校勘、追討古典與教父抄本，堪稱第一位「文獻學家」的工作日誌。信中兼涉預定論之爭與王國政局，其求書若渴的形象成為加洛林人文主義最鮮活的見證。' },
          ...
          { title_zh: '阿博‧德‧弗勒里書信集', title_orig: 'Epistolae Abbonis Floriacensis', author: '弗勒里的阿博', era: '約 985–1004', place: '弗勒里', language: '拉丁文', intro: '弗勒里院長阿博的書信集，為修道院豁免權據理力爭、調停英法教會爭端、兼論曆算與正典法彙。阿博終在加斯科尼平亂中殉身，其書信是千年之交修道自由與王權角力的見證，亦見證弗勒里作為學術中心的地位。' },
          ...
          { title_zh: '蘭弗朗克書信集', title_orig: 'Epistolae Lanfranci', author: '帕維亞的蘭弗朗克', era: '1070–1089', place: '坎特伯里', language: '拉丁文', intro: '諾曼征服後首任坎特伯里大主教蘭弗朗克的書信集，重整英格蘭教會、確立坎特伯里對約克的首席權、輔佐威廉一世攝政，函件簡峻務實。它是諾曼教會改革的檔案主幹，兼見這位貝克名師由學者轉為政治家的身影。' },
          ...
          { title_zh: '索爾茲伯里的約翰書信集', title_orig: 'Epistolae Iohannis Saresberiensis', author: '索爾茲伯里的約翰', era: '1153–1180', place: '坎特伯里／沙特爾', language: '拉丁文', intro: '十二世紀最優雅的人文學者約翰的三百二十五封書信，前期代坎特伯里大主教起草教廷文書，後期見證貝克特案全程並在血案現場。書信集古典徵引信手拈來，兼具史料與文學雙重極品之譽。' },
          ...
          { title_zh: '彼得‧德‧布盧瓦書信集', title_orig: 'Epistolae Petri Blesensis', author: '布盧瓦的彼得', era: '約 1170–1204', place: '坎特伯里／倫敦', language: '拉丁文', intro: '宮廷文人彼得‧德‧布盧瓦自編的書信集，描摹亨利二世宮廷的奔波苦況、申論教士操守，文采斐然，中世紀傳抄逾二百部，為書信文學之最。其「宮廷病」書簡開創對權力生活的諷刺文類，影響直至人文主義。' },
          { title_zh: '彼得‧德‧塞勒書信集', title_orig: 'Epistolae Petri Cellensis', author: '塞勒的彼得', era: '約 1145–1183', place: '塞勒／沙特爾', language: '拉丁文', intro: '塞勒院長、後任沙特爾主教的彼得與索爾茲伯里的約翰等一代文士的往來書信，靈修沉思與時局評騭交織，文風凝鍊如箴言。其書信網絡橫跨英法修道與主教圈，是十二世紀「書信共和國」的典型標本。' },
          ...
          { title_zh: '伊什特萬王訓誡書', title_orig: 'Libellus de institutione morum (Admonitiones)', author: '匈牙利王聖伊什特萬（託名起草）', era: '約 1015–1027', place: '匈牙利艾斯特根', language: '拉丁文', intro: '匈牙利開國聖王伊什特萬致儲君埃默里克的十章訓誡，以書信體傳授護持教會、禮遇外人、聽取諫言的治國之道。它是匈牙利文學的第一頁與「君王鑑」文類的東歐代表，見證新皈依王國如何以基督教倫理立國。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '奧赫里德的狄奧菲拉克特書信集', title_orig: 'Epistolae Theophylacti Achridensis', author: '奧赫里德的狄奧菲拉克特', era: '約 1090–1108', place: '奧赫里德', language: '希臘文', intro: '出任保加利亞奧赫里德總主教的拜占庭學者狄奧菲拉克特的書信集，自嘲流放蠻鄉卻為斯拉夫信眾抵擋帝國稅吏，兼與都城故舊論學問政。書信呈現拜占庭菁英與斯拉夫教會的複雜共生，為巴爾幹教會史的珍稀內部視角。' },
          ...
          { title_zh: '格里高爾‧馬吉斯特羅斯書信集', title_orig: 'T\'ght\'er (Letters of Grigor Magistros)', author: '格里高爾‧馬吉斯特羅斯', era: '約 1045–1058', place: '亞美尼亞／美索不達米亞', language: '亞美尼亞文', intro: '亞美尼亞貴族學者馬吉斯特羅斯的八十八封書信，為亞美尼亞文學首部俗人書信集，論希臘哲學、駁湯德拉克派異端、記拜占庭治下的宦遊。其文炫學好僻典，開亞美尼亞「希臘化文風」極致，是十一世紀亞美尼亞知識史的獨家資料。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '貝克特往來書信集', title_orig: 'Correspondence of Thomas Becket', author: '託馬斯‧貝克特及其書記圈', era: '1162–1170', place: '坎特伯里／法蘭西流亡地', language: '拉丁文', intro: '坎特伯里大主教貝克特與亨利二世、教廷及英格蘭主教團的往來書信七百餘件，由其書記圈於殉道後彙編。書信逐日記錄教會自由與王權的攤牌至血濺聖壇，規模與密度為十二世紀之最，是中世紀政教衝突的完整卷宗。' },
          { title_zh: '坎特伯雷基督堂書信集', title_orig: 'Epistolae Cantuarienses', author: '坎特伯里基督堂修士團', era: '1187–1199', place: '坎特伯里', language: '拉丁文', intro: '坎特伯里座堂修士團為抵制大主教另建教士團而與教廷、王室往來的五百餘封書信，修士遭圍困斷糧仍籲告不絕。這批檔案完整呈現一場中世紀教會內部訴訟的攻防全程，為修道團體法權意識的獨特見證。' },
          ...
          { title_zh: '但丁書信集', title_orig: 'Epistolae Dantis', author: '但丁‧阿利吉耶里', era: '約 1304–1320', place: '流亡義大利諸地', language: '拉丁文', intro: '但丁流亡期間的十三封拉丁書信，籲亨利七世南下重整義大利、斥佛羅倫斯同胞、致樞機團哀教廷遷亞維儂，致斯卡拉大公函並自解《神曲》寓意。書信是詩人政治神學的直接陳述，與《帝制論》互為表裡。' },
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '論教會禮儀之起源與增長', title_orig: 'Libellus de exordiis et incrementis rerum ecclesiasticarum', author: '瓦拉弗里德‧斯特拉波', era: '約 841', place: '賴興瑙', language: '拉丁文', intro: '賴興瑙院長瓦拉弗里德考述教堂、祭器、禱文與什一稅諸制度源流的小書，以歷史眼光代替寓意解釋，被譽為史上第一部禮儀史著作。其冷靜的發展觀在中世紀獨樹一幟，近代禮儀學的遠祖。' },
      ...
      },
      {
        ...
        works: [
          { title_zh: '金口若望事奉聖禮', title_orig: 'Θεία Λειτουργία τοῦ ἁγίου Ἰωάννου τοῦ Χρυσοστόμου', author: '託名金口若望（中世紀編訂）', era: '中世紀定型（8–14 世紀）', place: '君士坦丁堡', language: '希臘文', intro: '東正教平日與主日最常用的感恩事奉禮，雖冠以金口若望之名，實為君士坦丁堡禮歷代增飾而成。中世紀經由《典範手冊》（Diataxis）與大牧首傳統逐步定型，包含序禮（preparation）、聖言事奉與聖祭事奉三大段，連禱、進堂與奉獻遊行、感恩經（anaphora）與領聖體經次第井然，是拜占庭禮儀文本的核心。' },
          { title_zh: '巴西流事奉聖禮', title_orig: 'Θεία Λειτουργία τοῦ Μεγάλου Βασιλείου', author: '託名大巴西流（中世紀編訂）', era: '中世紀定型', place: '凱撒利亞—君士坦丁堡', language: '希臘文', intro: '感恩經較長、神學內涵豐富的事奉聖禮，東正教於大齋期諸主日、若干大節前夕及聖巴西流瞻禮日舉行。其感恩經以宏大的救恩史敘事貫穿造化、墮落與救贖，被視為拜占庭禮儀文學的高峰。中世紀與金口若望禮並行於同一套禮典手冊中，僅替換感恩經部分，餘者大體相同。' },
          ...
          { title_zh: '八音頌唱集', title_orig: 'Oktōēchos', author: '拜占庭聖詩傳統（傳大馬士革的若望奠基）', era: '中世紀定型', place: '耶路撒冷／君士坦丁堡', language: '希臘文', intro: '按八個調式循環編排每週日課聖頌的禮書，傳統歸功大馬士革的若望而實經數百年層累。八音體系規範了拜占庭與斯拉夫教會的全部歌唱生活，是東方教會「以音階組織時間」的偉大發明。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '來，聖神', title_orig: 'Veni Sancte Spiritus', author: '傳坎特伯里的斯蒂芬‧朗頓', era: '約 1200', place: '巴黎／坎特伯里', language: '拉丁文', intro: '五旬節金色繼抒詠「來，聖神」，傳出朗頓之手，十行對句字字懇切，被譽為中世紀拉丁詩的完璧。特倫託刪汰繼抒詠時倖存的四首之一，至今聖神降臨節仍詠唱不輟。' },
          ...
          { title_zh: '貝里公爵豪華時辰書', title_orig: 'Très Riches Heures du duc de Berry', author: '林堡兄弟（貝里公爵委製）', era: '約 1412–1416', place: '布爾日', language: '拉丁文', intro: '貝里公爵委託林堡兄弟繪製的時辰書，十二月令圖把貴族與農民的四季生活繪入祈禱書，為國際哥德式繪畫的最高峰。時辰書為中世紀晚期最流行的私人祈禱書，此本即其王者，「中世紀最美的書」。' },
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '拜占庭聖頌續編', title_orig: 'Kontakia kai Kanones', author: '大馬士革的若望、邁烏馬的科斯馬斯等', era: '8–11 世紀', place: '耶路撒冷—君士坦丁堡', language: '希臘文', intro: '繼六世紀羅曼努斯的長篇講道體聖頌（kontakion）之後，中世紀拜占庭聖樂發展出以九段歌頌（ode）構成的「聖頌典」（kanon）形式，大馬士革的若望與其義兄邁烏馬的科斯馬斯為集大成者。其作品依附於晨課九首聖經頌歌，按八種調式（Octoechos）譜成，神學深邃而韻律繁複，構成東正教節期與主日晨課聖樂的主體，至今傳唱。' },
          ...
          { title_zh: '哀歌之書', title_orig: 'Matʻean Ołbergutʻean (Մատեան ողբերգութեան, Book of Lamentations)', author: '納雷克的格里高爾（Grigor Narekatsʻi）', era: '約 1002–1003 年', place: '亞美尼亞凡湖納雷克修道院', language: '古典亞美尼亞文（grabar）', extent: '全 95 篇', note: '亞美尼亞人暱稱「納雷克」，奉為僅次於聖經的靈修經典', intro: '亞美尼亞使徒教會隱修士、神祕主義詩人納雷克的格里高爾晚年所撰的長篇祈禱詩集，由九十五篇「與神由心底傾訴」的哀禱組成。全書以罪人向上帝痛切自陳、懇求憐憫為主軸，意象繁複、語言瑰麗而情感熾烈，世代被亞美尼亞人抄誦、暱稱「納雷克」，信其有醫治之效，尊為僅次於聖經的靈修經典。二〇一五年作者獲天主教會冊封為教會聖師，本書亦為東方基督教密契傳統的巔峰之作。' },
          ...
          { title_zh: '弗里克詩集', title_orig: 'Poems of Frik', author: '弗里克', era: '約 1230–1310', place: '大亞美尼亞', language: '亞美尼亞文', intro: '蒙古統治下的亞美尼亞平信徒詩人弗里克，以直白的俗語向上帝申冤：義人受苦、稅吏橫行，天理何在。中世紀罕見的「抗辯詩」聲音，亞美尼亞文學自教會語轉向民間語的標誌。' }
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '新生', title_orig: 'Vita Nuova', author: '但丁‧阿利吉耶里', era: '約 1294', place: '佛羅倫斯', language: '義大利文', intro: '但丁以詩文交織自述對貝雅特麗齊的愛，自初遇、喪亡至誓言「要為她寫前人未寫之語」。塵世之愛升華為神學之愛的自傳性宣言，《神曲》的青春序章，俗語抒情的奠基之書。' },
          ...
          { title_zh: '坎特伯雷故事集', title_orig: 'The Canterbury Tales', author: '傑弗里‧喬叟', era: '約 1387–1400', place: '倫敦', language: '中古英語', intro: '三十位朝聖者赴坎特伯雷途中輪流講述的故事集，自騎士傳奇至磨坊主葷笑話，赦罪僧與召喚師的醜態並陳，終以堂區神父講道與作者懺悔收卷。朝聖框架盛載全幅人間，英語文學的奠基巨構。' },
          ...
          { title_zh: '奧特弗里德福音詩書', title_orig: 'Evangelienbuch (Otfrid von Weißenburg)', author: '魏森堡的奧特弗裡德', era: '約 863–871', place: '魏森堡修道院', language: '古高地德語', intro: '修士奧特弗裡德以尾韻詩體重述福音生平，自序申明日耳曼語何以堪載聖史，為德語詩開創韻腳傳統。首位留名的德語詩人，福音史詩本地化的加洛林代表作。' },
          ...
          { title_zh: '小園詩', title_orig: 'Hortulus (De cultura hortorum)', author: '瓦拉弗里德‧斯特拉波', era: '約 840', place: '賴興瑙島', language: '拉丁文', intro: '賴興瑙院長瓦拉弗里德詠修道院藥草園的四百行詩，鼠尾草、玫瑰與百合的栽培與靈意娓娓道來，末以園藝獻師長。修道勞動靈修的田園詩化，中世紀植物文學的可愛珍品。' },
          ...
          { title_zh: '悼父輓歌', title_orig: 'Coplas por la muerte de su padre', author: '豪爾赫‧曼里克', era: '約 1476', place: '卡斯提爾', language: '卡斯提爾文', intro: '騎士詩人曼里克悼亡父的四十節輓歌，「我們的生命是河，流入死亡之海」，以三重生命觀安頓死亡。西班牙語最被傳誦的哀歌，中世紀死亡默想詩的完美收束。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '基督受難劇（拜占庭）', title_orig: 'Christos Paschon', author: '託名拿先斯的格列高里（拜占庭編者）', era: '11–12 世紀（傳統歸 4 世紀）', place: '君士坦丁堡', language: '希臘文', intro: '以歐裡庇得斯詩行拼綴而成的受難悲劇，聖母如希臘悲劇女主角慟哭於十字架下。「引詩成劇」（cento）技法的極致，拜占庭對古典悲劇遺產最奇特的基督教挪用。' },
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '德語講道集', title_orig: 'Deutsche Predigten', author: '艾克哈特大師', era: '約 1300–1327', place: '神聖羅馬帝國‧科隆‧史特拉斯堡', language: '中古高地德語', intro: '道明會神學家艾克哈特大師以母語向修女與平信徒所作的講道，是中世紀少見的高水準德語神祕思想文獻。他講「靈魂的火花」（Seelenfünklein）、「神性的虛無」（Gottheit）與「離捨」（Abgeschiedenheit），主張靈魂須空盡自我，方能讓上帝在其中「誕生」。語言鋒利弔詭，部分命題身後遭教廷審查，卻深刻塑造了陶勒、蘇索與萊茵蘭神祕主義一脈。', note: '部分命題於 1329 年《主在田間》詔書中受譴', link: '' },
          ...
          { title_zh: '艾爾弗里克天主教講道集', title_orig: 'Sermones catholici (Catholic Homilies)', author: '艾爾弗里克', era: '約 990–995', place: '塞恩／恩舍姆', language: '古英語', intro: '修道院長艾爾弗里克以古英語寫成的兩輯各四十篇講道，供司鐸向不諳拉丁文的會眾宣講，文體節奏鏗鏘近乎韻文。他自陳為免「無知者曲解」而譯講並重，是歐洲俗語講道文學最早的高峰，古英語散文的典範。' },
          { title_zh: '布里克林講道集', title_orig: 'Blickling Homilies', author: '佚名（英格蘭堂區編者）', era: '10 世紀（971 年題記）', place: '英格蘭', language: '古英語', intro: '存於布里克林府邸抄本的十八篇古英語講道，成於艾爾弗里克之前，雜採偽經傳說與末世警語，反映千禧年前夕民間講壇的實態。其保存的聖米迦勒山異象等母題為研究盎格魯-撒克遜大眾信仰的珍貴材料。' },
          ...
          { title_zh: '明燈問答', title_orig: 'Elucidarium', author: '奧頓的霍諾留', era: '約 1098–1101', place: '坎特伯里／雷根斯堡', language: '拉丁文', intro: '霍諾留以師徒問答總括基督教義的教理手冊，自三一、救贖至末世逐條作答，語簡而斷然。本書為中世紀最流行的平信徒教理書，譯成法、德、古諾斯諸語，堂區司鐸賴以答問講授，塑造數百年大眾信仰的常識框架。' },
          ...
          { title_zh: '奎德林堡的約旦講道集', title_orig: 'Opus postillarum et sermonum Iordani', author: '奎德林堡的約旦', era: '約 1365–1380', place: '埃爾福特', language: '拉丁文', intro: '奧思定隱修會士約旦的講道與後注大全，按禮儀年集成數百篇，兼收其會祖傳統的靈修教導，流傳中歐抄本極多。他是十四世紀「講道彙編」文化的代表，其書為晚期中世紀司鐸的標準參考，亦預示奧思定會的改革土壤。' },
          { title_zh: '米爾克節期講道集', title_orig: 'Festial (John Mirk)', author: '約翰‧米爾克', era: '約 1380–1390', place: '什羅普郡利勒斯霍爾修道院', language: '中古英語', intro: '奧思定會律修士米爾克為粗通文墨的堂區司鐸編寫的英語節期講道集，逐節配聖徒故事與奇蹟例話，語極平白。本書為中世紀晚期英格蘭最流行的講道書，印刷時代再版逾二十次，正統堂區講壇對羅拉德挑戰的回應。' },
          ...
          { title_zh: '奧赫里德的克萊門特講道集', title_orig: 'Поучения на Климент Охридски', author: '奧赫里德的克萊門特', era: '約 886–916', place: '奧赫里德', language: '教會斯拉夫文', intro: '西里爾與美多德高弟克萊門特被逐出摩拉維亞後於奧赫里德建校興學，為新受洗的保加利亞信眾撰寫節慶講道與聖徒頌讚數十篇，語淺情深。他是斯拉夫語講道文學的實際奠基者，七聖師傳統的核心人物。' },
          ...
          { title_zh: '帕拉馬斯講道集', title_orig: 'Homiliae Gregorii Palamae', author: '帖撒羅尼迦的格列高里‧帕拉馬斯', era: '1347–1359', place: '帖撒羅尼迦', language: '希臘文', intro: '靜修論戰主將帕拉馬斯出任帖撒羅尼迦都主教後的六十三篇講道，把「非受造之光」的高峰神學化為對城市會眾的牧養言說，兼斥社會不義。這批講章證明奧秘神學與講壇實踐可為一體，是晚期拜占庭講道的巔峰。' },
          ...
          { title_zh: '北方講道集', title_orig: 'Northern Homily Cycle', author: '佚名（英格蘭北部奧思定會圈）', era: '約 1315–1350', place: '英格蘭北部', language: '中古英語', intro: '以中古英語韻文按主日福音編排的講道詩集，每篇譯經、釋義、附例話，供司鐸誦講亦供平信徒自讀。全集傳抄本眾多並兩度擴編，是英格蘭俗語講道與通俗詩歌合流的大型紀念碑。' },
          { title_zh: '奧姆魯姆', title_orig: 'Ormulum', author: '奧姆', era: '約 1150–1180', place: '英格蘭東中部', language: '中古英語', intro: '奧思定會律修士奧姆以自創嚴格音節體與獨特拼寫法寫成的英語福音講解詩，自序願「英吉利人以英語明白福音」。其拼寫系統精確標記音長，意外成為英語語音史的無價化石，講道文學與語言學雙重奇珍。' },
      ...
      },
      {
        ...
        works: [
          { title_zh: '駁異教大全', title_orig: 'Summa contra Gentiles', author: '多瑪斯‧阿奎那', era: '約 1259–1265', place: '義大利‧奧爾維耶托', language: '拉丁文', intro: '相傳應道明會宣教需要而作的護教巨著，旨在向不接受聖經權威的「外教人」——尤指穆斯林與猶太智者——僅憑理性論證基督信仰。全書四卷，前三卷依自然理性論上帝存在、本性與受造界的歸向，末卷方論唯憑啟示可知的奧理如三位一體、降生與聖事。結構嚴密，是中世紀理性護教與宣教神學的最高範本。', note: '一說為宣教手冊，學界對其用途有爭議', link: '/fathers' },
          ...
          { title_zh: '向穆斯林證三位一體傳教指南', title_orig: 'Pugio Fidei / De rationibus fidei', author: '雷蒙‧馬蒂尼、多瑪斯‧阿奎那', era: '十三世紀中後期', place: '伊比利亞‧北非', language: '拉丁文（雜希伯來、阿拉伯文）', intro: '收伊比利亞道明會為向穆斯林與猶太人傳道而編的論辯手冊。馬蒂尼的「信仰之匕首」廣徵塔木德、古蘭與阿拉伯哲人原文，逐條駁斥並引以證基督；阿奎那的「論信仰之理」則應安提阿傳教士之請，教人如何向否認三位一體與降生的穆斯林作理性辯護而不訴諸聖經權威。二者反映托缽會「以彼之典攻彼之說」的宣教策略。', note: '為同類傳教手冊之合錄', link: '/fathers' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '狄奧菲拉克特四福音注', title_orig: 'Hermeneia eis ta tessara euangelia', author: '奧赫里德的狄奧菲拉克特', era: '約 1090–1108', place: '奧赫里德', language: '希臘文', intro: '狄奧菲拉克特承金口若望釋經傳統寫成的四福音簡注，文義清通，拜占庭與斯拉夫世界奉為標準福音注，阿奎那《黃金鎖鏈》與伊拉斯謨新約注皆大量取資。本注是教父釋經中世紀傳承的最大中繼站。' },
    ...
    divisions: [
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '通用透視學', title_orig: 'Perspectiva communis', author: '約翰‧佩坎', era: '約 1277–1279', place: '牛津／坎特伯里', language: '拉丁文', intro: '方濟會士、坎特伯里大主教佩坎綜合阿爾哈曾光學傳統寫成的透視學教本，論視覺、反射與折射，簡明適教。本書作為大學光學標準教材沿用至十七世紀，刊本迭出，是中世紀科學課程建制化的代表。' },
          ...
          { title_zh: '論磁石書信', title_orig: 'Epistola de magnete', author: '馬里古的彼得（佩雷格林努斯）', era: '1269', place: '義大利南部圍城軍中', language: '拉丁文', intro: '工程師彼得在圍城軍旅中寫成的磁學書信，首度定義磁極、記述極性相斥相吸與斷磁再生兩極，並設計浮針與樞軸羅盤。這是歐洲第一部實驗磁學專著，吉爾伯特《論磁》承其餘緒，羅盤航海的理論起點。' },
          ...
          { title_zh: '曆法校正論', title_orig: 'Compotus correctorius', author: '羅伯特‧格羅斯泰斯特', era: '約 1220–1230', place: '牛津', language: '拉丁文', intro: '格羅斯泰斯特精算儒略曆的累積誤差，指出春分與月相漸離教會曆法，提出校正方案以正復活節之期。其後培根、庫薩諸家相繼論此，至一五八二年額我略改曆方告實現，本書是三百年改曆運動的先聲。' },
          ...
          { title_zh: '赫里福德世界地圖', title_orig: 'Hereford Mappa Mundi', author: '霍爾丁厄姆的理查', era: '約 1300', place: '林肯／赫里福德', language: '拉丁文', intro: '現存最大的中世紀世界地圖，繪於整張牛皮，以耶路撒冷居中，伊甸園、巴別塔與奇風異族環列，地理與救恩史疊合為一。它與其說是導航圖不如說是「時間中的世界」總覽，中世紀宇宙觀最壯麗的視覺總結。' },
          ...
          { title_zh: '加泰隆尼亞地圖集', title_orig: 'Atles català', author: '克雷斯克斯‧亞伯拉罕', era: '1375', place: '馬約卡', language: '加泰隆尼亞文', intro: '馬約卡猶太製圖師克雷斯克斯為亞拉岡王室繪製、獻予法王的世界地圖集，八幅羊皮上羅盤線縱橫，馬里帝國曼薩‧穆薩與馬可波羅商隊皆入畫。它代表波特蘭實測製圖與世界圖像的合流，中世紀製圖學的最高傑作。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '新詩學', title_orig: 'Poetria nova', author: '傑弗里‧德‧文索夫', era: '約 1208–1213', place: '英格蘭', language: '拉丁文', intro: '以兩千行韻文自身示範修辭技法的寫作教本，論佈局、放大縮小與文采諸法，題獻英諾森三世。全歐傳抄逾二百部，喬叟亦戲仿其句，是中世紀修辭學最成功的教科書，「新詩學」遂成文類之名。' },
          ...
          { title_zh: '大邏輯', title_orig: 'Logica magna', author: '威尼斯的保羅', era: '約 1396–1399', place: '帕多瓦', language: '拉丁文', intro: '奧思定會士威尼斯的保羅集十四世紀英國邏輯之大成的巨帙，論詞項、命題、推論與詭辯無所不包，篇幅為中世紀邏輯書之最。它把牛津的邏輯精微移植義大利，支配帕多瓦學風，是晚期經院邏輯的百科式總匯。' },
          { title_zh: '解決詭辯的規則', title_orig: 'Regulae solvendi sophismata', author: '威廉‧海特斯伯里', era: '1335', place: '牛津默頓學院', language: '拉丁文', intro: '默頓學者海特斯伯里以詭辯題材訓練分析技巧的教本，論說謊者悖論、極大極小與瞬時速度，將邏輯推向數學物理的邊界。本書為義大利大學邏輯課指定用書百餘年，展示中世紀「詭辯練習」的智性鋒芒。' },
          ...
          { title_zh: '俗語論', title_orig: 'De vulgari eloquentia', author: '但丁‧阿利吉耶里', era: '約 1303–1305', place: '流亡義大利', language: '拉丁文', intro: '但丁以拉丁文為俗語辯護的語言學論著，考察語言變遷、分類義大利十四種方言，尋求足堪高詩的「光輝俗語」。書雖未竟，其歷史語言學眼光超前數百年，是俗語文學自覺的理論宣言，語言學史的先知之作。' }
