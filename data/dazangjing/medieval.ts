    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '駁異教大全', title_orig: 'Summa contra Gentiles', author: '多瑪斯‧阿奎那', era: '約 1259–1265', place: '巴黎／義大利', language: '拉丁文', intro: '此書旨在面向不接受聖經權威的對象（尤指穆斯林與猶太哲人）以純理性辯護基督信仰，分四卷論上帝、受造、天意與信仰奧祕。前三卷盡力以哲學論證可由理性企及之真理，第四卷則處理三一、道成肉身等須靠啟示方知的信理。其護教進路與當時拉丁學界面對阿拉伯亞里斯多德主義的挑戰密切相關，是中世紀理性神學的代表作。', link: '/fathers' },
