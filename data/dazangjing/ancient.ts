        ...
        divisions: [
          ...
          },
          {
            ...
            works: [
              ...
              { title_zh: '阿羅基尼解經', title_orig: 'The Hypostasis of the Archons (On the Reality of the Rulers)', author: '託名（塞特派）', era: '約 3 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              ...
              { title_zh: '至高三重力', title_orig: 'The Three Forms of First Thought (Trimorphic Protennoia)', author: '託名（塞特派）', era: '約 3 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '歐格諾斯托斯論福者', title_orig: 'Eugnostos the Blessed', author: '託名歐格諾斯托斯', era: '約 1 至 2 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '耶穌基督的智慧', title_orig: 'The Sophia of Jesus Christ', author: '託名（諾斯底）', era: '約 2 至 3 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '耶烏二書', title_orig: 'The Books of Jeu (Bruce Codex)', author: '託名（諾斯底）', era: '約 3 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '三部訓言', title_orig: 'The Tripartite Tractate', author: '託名（瓦倫廷派）', era: '約 3 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '復活論（致雷吉努斯書）', title_orig: 'The Treatise on the Resurrection (Letter to Rheginos)', author: '託名（瓦倫廷派）', era: '約 2 至 3 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '瓦倫廷釋義', title_orig: 'A Valentinian Exposition', author: '託名（瓦倫廷派）', era: '約 2 至 3 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '靈魂註解', title_orig: 'The Exegesis on the Soul', author: '託名（諾斯底）', era: '約 2 至 3 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '大力者論', title_orig: 'The Concept of Our Great Power', author: '託名（諾斯底）', era: '約 4 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '彼得致腓力書信', title_orig: 'The Letter of Peter to Philip', author: '託名彼得（諾斯底）', era: '約 2 至 3 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '猶大福音', title_orig: 'The Gospel of Judas', author: '託名（該隱派／塞特派）', era: '約 2 世紀', place: '埃及或敘利亞', language: '科普特文', link: '/gnostic' },
              { title_zh: '瑪利亞福音', title_orig: 'The Gospel of Mary', author: '託名抹大拉的瑪利亞（諾斯底）', era: '約 2 世紀', place: '埃及', language: '科普特文', link: '/gnostic' },
              { title_zh: '巴魯克書', title_orig: 'The Book of Baruch (by Justin the Gnostic)', author: '諾斯底派猶斯定', era: '約 2 世紀', place: '敘利亞或埃及', language: '希臘文', link: '/gnostic' },
            ],
          },
        ],
      },
