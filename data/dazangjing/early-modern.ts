    ...
    divisions: [
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '瓦洛奇里手稿', title_orig: 'Huarochirí Manuscript', author: '佚名安地斯敘述者（阿維拉委錄）', era: '傳統古老／文本化約 1598–1608', place: '南美洲（秘魯瓦洛奇里）', language: '克丘亞語', intro: '以克丘亞語記錄瓦洛奇裡地區神話、聖地與祭儀的手稿,由剷除偶像者神父阿維拉委人採錄——是前基督教安地斯宗教最完整的第一手紀錄,諷刺地出於迫害者之手。它既是安地斯宗教的活檔案,也是基督教在此傳播時「認識以對治/會通」本土信仰的關鍵文本。﹝接觸期克丘亞文本化。﹞' },
    ...
    divisions: [
      ...
      },
      {
        ...
        ,
          ...
          { title_zh: '一六〇四年教會法規', title_orig: 'Canons of 1604', author: '坎特伯里教省會議（班克羅夫特主導）', era: '1604', place: '倫敦', language: '英文／拉丁文', intro: '詹姆士一世初年通過的一百四十一條教會法規，禮儀服制與教會法庭全面成文化。英格蘭教會沿用近三百五十年的法典，清教徒不從國教的法律分界線。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '格里曆改革詔書', title_orig: 'Inter gravissimas', author: '教宗額我略十三世', era: '1582', place: '羅馬', language: '拉丁文', intro: '額我略十三世頒布曆法改革的詔書，刪十日並改置閏之法，格里曆由此誕生。教會法令改寫全人類時間座標的孤例，復活節計算引發的科學工程。' },
    ...
    divisions: [
...

      {
        ...
        works: [
          ...
          { title_zh: '神學要義', title_orig: 'Loci communes rerum theologicarum', author: '菲利普‧墨蘭頓', era: '一五二一', place: '德意志‧維滕貝格', language: '拉丁文', intro: '墨蘭頓以羅馬書為綱所撰的首部新教系統神學，依「罪、律法、恩典」等主題分章論述，文字清晰條理嚴謹。此書是路德宗教義的首次有序整理，路德盛讚其價值。墨蘭頓以人文主義學養將改教信念體系化，奠定新教教義學的方法論基礎，數度增訂再版，影響德意志神學教育達一世紀之久。' },
        ...
        ,
          ...
          { title_zh: '見證人錄', title_orig: 'Catalogus testium veritatis', author: '馬太亞斯‧弗拉齊烏斯‧伊里里庫斯（Matthias Flacius Illyricus）', era: '1556', place: 'Basileae（巴塞爾）', language: '拉丁文', intro: '路德宗改革家弗拉齊烏斯所著護教巨著，彙編教父與教會史文獻以證新教教義之古老淵源。作品成於宗教改革激烈時期，標題「真理見證人」明示其論證策略：透過古代教會大家的言論駁斥天主教反改革的指控，強調新教教義乃回歸早期教會傳統。此書在16–17世紀新教正統中地位重要，對後世護教學影響深遠。' },
      ...
      "divisions": [
        {
          ...
          "works": [
            ...
            },
            {
              ...
              "language": "英文",
              "parent": "救主神蹟論六篇",
              "intro": "以俄利根寓意解經為據，主張福音書神蹟按字面理解則荒謬，須全作靈意解；銷量以萬計，最聳動的宗教論戰文本。"
            },
            {
              "title_zh": "神蹟能力自由探究",
          ...
          "works": [
            {
              ...
              "language": "拉丁文",
              "intro": "西班牙神學家塞爾維特（米格爾‧塞爾維特，約 1511–1553）於 1531 年在哈根諾出版的反三位一體論著作，為宗教改革時代最激進的神學挑戰之一。全書七卷以聖經文本為據，主張尼西亞三位一體教義係希臘哲學污染之產物，耶穌非永恆的第二位格而是神性之子。此書同時觸怒天主教與改教陣營，終致塞爾維特 1553 年於日內瓦被審判火刑。本書為近代唯一神論與反尼西亞神學的奠基原典，具有不可忽略的神學史地位。"
            }
          ]
        }
      ]
    ...
    divisions: [
      {
        ...
        ,
          ...
          { title_zh: '約翰‧諾克斯傳：蘇格蘭宗教改革史論', title_orig: 'Life of John Knox, containing Illustrations of the History of the Reformation in Scotland', author: 'M\'Crie, Thomas', era: '1811', place: 'Edinburgh', language: '英文', intro: '托馬斯‧麥克里（Thomas M\'Crie）所著，1813年愛丁堡初版，是十九世紀最具影響力的約翰‧諾克斯傳記。諾克斯（約1514–1572）為蘇格蘭宗教改革之父，主導建立長老制度並推動加爾文主義在蘇格蘭生根。全書以翔實的一手史料與檔案為基礎，記述諾克斯的神學立場、與天主教勢力的衝突、《蘇格蘭信條》起草，以及改革宗教會的建立，兼具傳記與宗教改革史的雙重價值，是研究近代蘇格蘭教會史不可或缺的一手性敘事原典。' },
          { title_zh: '蘇格蘭教會與國家事務史（宗教改革初至1568年）', title_orig: 'History of the Affairs of Church and State in Scotland, from the Beginning of the Reformation to the Year 1568', author: 'Keith, Robert', era: '1734', place: 'Edinburgh', language: '英文', intro: '蘇格蘭主教暨史學家基斯（Robert Keith，1681–1757）所著教會史，記述蘇格蘭宗教改革肇始至1568年間教會與國家之交涉。本書依原始檔案與年代史料編纂，涵蓋瑪麗女王時代的宗教政爭、加爾文主義長老教會興起、英格蘭聖公會勢力競逐，以及天主教舊教勢力衰退諸史事，為研究不列顛宗教改革史不可或缺之十八世紀第一手史學著作。' },
      ...
      },
      {
        ...
        ,
          ...
          { title_zh: '羅馬殉道錄（1613年安特衛普版）', title_orig: 'Martyrologium romanum ad nouam kalendarij rationem restitutum (Antwerp 1613 ed.)', author: 'Catholic Church; Baronio, Cesare', era: '1583', place: 'Antverpiae', language: '拉丁文', intro: '天主教教會官方殉道錄，依額我略曆改革重整曆法次序，著名教會史家凱撒‧巴羅尼烏斯（Cesare Baronio）於1586、1589年考訂補注（刪除歷史可疑條目、補充原始文獻注腳），1583年首版、1584年第三版定為羅馬禮必用。本書按月日逐日列出殉道聖人姓名、受難地與簡傳，為後世聖人曆與教會史研究奠定規範。1613年安特衛普版由普蘭廷出版社（Plantin-Moretus）印行，乃重要早期刊本。此書係天主教反宗教改革時期強化聖徒崇敬、確立正統殉道傳統之核心史傳文獻。【注：intro原稿誤稱聖查理‧博羅梅奧主持修訂，文獻不支持此說，已刪除。】' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '沙勿略書簡', title_orig: 'Epistolae S. Francisci Xaverii', author: '方濟‧沙勿略（Francis Xavier）', era: '1549–1552', place: '日本‧果阿', language: '拉丁文‧葡萄牙文', intro: '沙勿略自果阿與日本寄回歐洲的書簡，是天主教進入日本最早的親歷紀錄。信中熱切描述薩摩、山口、京都之行，分析日本人尚理重榮的民族性，反省如何透過辯論與本地語彙傳講福音，也坦陳語言隔閡與佛僧敵意的挫折。這批書簡既是宣教實況報告，也是近代跨文化傳教方法的雛形，激勵大批耶穌會士東來，奠定「吉利支丹」時代的開端。' },
          ...
          { title_zh: '中華大帝國史', title_orig: 'Historia del Gran Reino de la China', author: '門多薩(Juan González de Mendoza)', era: '1585', place: '羅馬', language: '西班牙文', intro: '奧思定會士門多薩（Juan González de Mendoza）受教宗委託編纂，於一五八五年在羅馬刊行，是歐洲第一部全面詳述中國的專著。全書匯整早期赴華傳教士、使節與商旅的見聞，記述中國的疆域、物產、典章制度、宗教風俗與印刷火炮等技藝。出版後數十年間譯成多種歐洲語文、再版數十次，成為大航海時代歐洲認識中國的權威讀本，深刻形塑近代早期歐人的「中華帝國」想像。' },
      ...
      },
      {
        ...
        ,
          ...
          { title_zh: '日內瓦教會史：自宗教改革肇始至今日', title_orig: 'Histoire de l\'Église de Genève depuis le commencement de la réformation jusqu\'à nos jours', author: 'Gaberel, Jean-Pierre', era: '1855', place: 'Genève', language: '法文', intro: '法語教會史著作，記述日內瓦教會自十六世紀宗教改革肇始至十九世紀中葉的歷史沿革。日內瓦為加爾文神學重鎮，本書系統梳理改革宗在此地的建制過程、神學論爭、教會治理及歷代牧者事蹟。作者加柏雷爾（Jean-Pierre Gaberel）以編年體鋪陳，涵蓋十六至十九世紀約三百年間加爾文主義於日內瓦的發展脈絡，為研究改革宗教會史及瑞士新教史的重要原始文獻。' },
    ...
    divisions: [
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '日內瓦聖經', title_orig: 'The Geneva Bible', author: '日內瓦英籍流亡學者群 (惠廷漢 William Whittingham 等)', era: '一五六〇年', place: '日內瓦', language: '英文', intro: '瑪利女王迫害期間流亡日內瓦的英籍新教學者所譯，是首部分節編號並附大量旁註的英文聖經。註釋帶鮮明的加爾文派立場，輕便價廉，深受清教徒與一般家庭喜愛，隨「五月花號」傳入新大陸，在欽定本之前長期是英語世界最普及的聖經。', link: '/scripture' },
          ...
          { title_zh: '維茲索里聖經', title_orig: 'Vizsolyi Biblia (Károli)', author: '卡羅利‧加什帕爾', era: '1590', place: '維茲索里', language: '匈牙利文', intro: '改革宗牧師卡羅利率團隊譯成的首部匈語全本聖經，於維茲索里村邊印邊譯而成。匈牙利文學語言的奠基之作，四百年來新教匈人的「卡羅利聖經」。' },
          ...
          { title_zh: '斯科里納魯塞尼亞聖經', title_orig: 'Біблія руска (Skaryna)', author: '弗蘭齊斯克‧斯科里納', era: '1517–1519', place: '布拉格／維爾紐斯', language: '魯塞尼亞文（教會斯拉夫混合）', intro: '白羅斯醫學博士斯科里納在布拉格刊印的聖經諸卷，序跋以民語申明「令庶民識智慧」。東斯拉夫印刷與人文主義的黎明之作，白羅斯文化的第一座豐碑。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '固里東正教官話新約', title_orig: '固里譯本（東正教新約）', author: '固里（卡爾波夫）', era: '1864', place: '北京', language: '中文（官話）', intro: '俄國東正教北京傳道團修士大司祭固里譯成的官話新約，術語自成一系（如「福音」作「福音經」）。漢語東正教傳統的譯經孤本，新教天主教之外的第三譯脈。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '奧斯坎亞美尼亞聖經首刊本', title_orig: 'Oskan Bible', author: '奧斯坎‧葉里溫齊', era: '1666', place: '阿姆斯特丹', language: '亞美尼亞文', intro: '主教奧斯坎流轉歐洲於阿姆斯特丹印成的首部亞美尼亞文印刷聖經，附插圖精美。離散民族以印刷續命經典的壯舉，亞美尼亞書籍史的巔峰。' },
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '克蘭麥書信集', title_orig: 'Letters of Thomas Cranmer', author: '託馬斯‧克蘭麥', era: '1533–1556', place: '坎特伯里', language: '英文／拉丁文', intro: '坎特伯里大主教克蘭麥的書信，邀布塞爾、維米利等歐陸學者赴英共建改革，並謀劃普世新教信條會議。至其繫獄反覆與終局的信件，呈現公禱書之父在王權與良心夾縫中的全部掙扎。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '露薏絲‧德‧馬里亞克書信', title_orig: 'Lettres de Louise de Marillac', author: '露薏絲‧德‧馬里亞克', era: '1626–1660', place: '巴黎', language: '法文', intro: '仁愛女修會共同創始人露薏絲致各地姊妹的書信，指導首個走出隱院、入戶服務窮人的女修會如何在街巷間持守祈禱。與文生的通信互為表裡，這批信是女性主動修會誕生的第一手紀錄。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '盧卡里斯書信集', title_orig: 'Epistolae Cyrilli Lucaris', author: '基里羅斯‧盧卡里斯', era: '1602–1638', place: '君士坦丁堡／亞歷山卓', language: '希臘文／拉丁文', intro: '君士坦丁堡宗主教盧卡里斯與坎特伯里、日內瓦及荷蘭改革宗的通信，贈英王亞歷山卓抄本、遣士子留學西歐，終遭鄂圖曼絞殺。其加爾文化的信仰告白掀起正教百年風暴，這批信是正教與新教相遇最深的一次檔案。' },
    ...
    divisions: [
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '佛瑞安魂曲', title_orig: 'Requiem op. 48', author: '加布里埃爾‧佛瑞', era: '1887–1890', place: '巴黎馬德萊娜教堂', language: '拉丁文', intro: '教堂樂師佛瑞刻意淡去震怒之日、以「在天國」的童聲收束的安魂曲，靜謐如搖籃曲，自稱「死亡的搖籃曲」。它代表法國教會音樂的內斂路線，與威爾第的戲劇路線互為兩極，同列安魂曲雙璧。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '亞美尼亞初刊祈禱書', title_orig: 'Urbatagirk', author: '哈科布‧梅加帕特（刊印）', era: '1512', place: '威尼斯', language: '亞美尼亞文', intro: '亞美尼亞史上第一部印刷書籍：威尼斯刊行的《週五書》祈禱文集，收治病禳災禱文與納雷克的格里高爾禱詞選。流散商人社群以印刷術續命民族禮儀傳統，本書是東方基督教印刷文化的破曉之作。' },
    ...
    divisions: [
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '特拉赫恩世紀默想集', title_orig: 'Centuries of Meditations', author: '託馬斯‧特拉赫恩', era: '約 1670（1908 刊）', place: '赫里福德', language: '英文', intro: '鄉村牧師特拉赫恩的默想散文湮沒二百餘年，二十世紀初自舊書攤重見天日，「麥浪是永恆的金黃」的童真視景震驚文壇。受造界的榮福直觀寫得如初晨，英語密契散文最喜樂的聲音。' },
          ...
          { title_zh: '尼坎‧莫波瓦', title_orig: 'Nican Mopohua', author: '安東尼奧‧瓦萊里亞諾（傳）', era: '約 1556（1649 刊）', place: '墨西哥谷', language: '納瓦特爾文', intro: '以納瓦特爾語記述瓜達盧佩聖母四度顯現於原住民胡安‧迭戈的敘事詩文，「我不在這裡嗎，我不是你的母親嗎」為美洲信仰的母語原點。原住民語言承載的顯現敘事，拉美宗教文學的第一文本。' },
          ...
          { title_zh: '醫者的宗教', title_orig: 'Religio Medici', author: '託馬斯‧布朗', era: '1643', place: '諾里奇', language: '英文', intro: '醫生布朗自剖信仰與科學共存之道的隨筆，寬容的懷疑與虔敬的驚奇交織，「我們裡面自有一個非洲與她的神奇」。本書風行歐陸而入禁書目錄，科學革命前夜信仰心靈的自畫像。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '無染原罪（穆里羅）', title_orig: 'La Inmaculada Concepción', author: '巴託洛梅‧穆里羅', era: '約 1660–1678', place: '塞維亞', language: '油畫（西班牙）', intro: '穆里羅一生繪無染原罪聖母二十餘幅，白衣藍帶、踏月而升的少女形象自此成為此端信理的通用圖式。塞維亞的甜美聖母走遍天下教堂與經卡，大眾聖母圖像的定稿者。' },
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '茨溫利講道與神學', title_orig: 'Predigten und Schriften (Huldrych Zwingli)', author: '烏爾里希‧茨溫利', era: '1520 年代', place: '蘇黎世', language: '德文', intro: '蘇黎世改革家茨溫利逐卷連續講解聖經的講道與《論真假宗教》。改革宗連續解經講道的開創者，瑞士宗教改革的講壇奠基。' },
      ...
      },
      {
        ...
        ,
          ...
          { title_zh: '李維香格里高蘇格蘭復興講道', title_orig: 'Sermons of the Kilsyth and Dundee Revival (W. C. Burns / M\'Cheyne)', author: '羅伯特‧默里‧麥克謙', era: '1839–1843', place: '蘇格蘭鄧迪', language: '英文', intro: '蘇格蘭青年牧者麥克謙聖潔動人的講道與書信，鄧迪復興的核心。十九世紀蘇格蘭奮興的聖徒典範，其屬靈日記傳頌至今。' }
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '塞涅里四旬期講道集', title_orig: 'Quaresimale (Paolo Segneri)', author: '保羅‧塞涅里', era: '17 世紀', place: '義大利', language: '義大利文', intro: '耶穌會士塞涅里赤足巡迴義大利鄉間佈道的四旬期講章，樸實動人催人悔改。義大利民間傳道復興的代表，巴洛克天主教巡迴佈道的典範。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '貝里奇鄉村佈道', title_orig: 'The Christian World Unmasked (John Berridge)', author: '約翰‧貝里奇', era: '1773', place: '英格蘭埃弗頓', language: '英文', intro: '福音派巡迴佈道家貝里奇詼諧懇切的鄉村講道。英格蘭福音復興的草根之聲，衛斯理與懷特腓的同工。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '阿曼達‧史密斯佈道自述', title_orig: 'An Autobiography (Amanda Berry Smith)', author: '阿曼達‧貝里‧史密斯', era: '1893', place: '美國／印度／賴比瑞亞', language: '英文', intro: '獲釋奴隸出身的成聖佈道家阿曼達‧史密斯橫跨美印非三洲的佈道自述。黑人女性跨國宣教的傳奇，聖潔運動與世界宣教的交會之聲。' },
    ...
    divisions: [
      {
        ...
        ,
          ...
          { title_zh: '法蘭西文學史', title_orig: 'Histoire littéraire de la France', author: '聖莫爾本篤會士（里韋主持）', era: '1733 起', place: '巴黎', language: '法文', intro: '聖莫爾學派系統編纂的法蘭西作家文學史，按世紀逐一考訂中世紀教會作者生平著作，革命後由法蘭西學會續修至今。修道學術轉為國家工程的活化石，中世紀研究的基準書目。' },
          ...
          { title_zh: '胡克教會辭典', title_orig: 'A Church Dictionary', author: '沃爾特‧法誇爾‧胡克', era: '1842', place: '里茲', language: '英文', intro: '里茲教區牧師胡克為平信徒編寫的教會知識辭典，禮儀、聖職與教義條分縷析，再版十餘次。維多利亞教會復興運動的普及讀物，堂區書架上的標準配備。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '史瓦希里語辭典', title_orig: 'A Dictionary of the Suahili Language', author: '路德維希‧克拉普夫', era: '1882', place: '倫敦', language: '史瓦希里文／英文', intro: '德國宣教士克拉普夫東非卅年心血的史瓦希里語辭典，身後刊行，並曾首譯聖經段落入該語。東非通用語的第一部大辭典，宣教語言學為非洲語文書面化奠基的代表。' },
          ...
          { title_zh: '里德爾韓法辭典', title_orig: 'Dictionnaire coréen-français', author: '里德爾主教（巴黎外方傳教會）', era: '1880', place: '橫濱刊行', language: '韓文／法文', intro: '巴黎外方傳教會朝鮮代牧裡德爾在教難流亡中主持編成的韓法辭典，為朝鮮語第一部近代辭書，次年續出文法。地下教會時代的語言學遺產，韓語近代辭書史的起點。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '魯伊納特殉道者真行錄', title_orig: 'Acta primorum martyrum sincera et selecta', author: '提耶里‧魯伊納特', era: '1689', place: '巴黎', language: '拉丁文', intro: '馬比雍高弟魯伊納特自浩繁聖傳中甄選文獻可信的原始殉道紀錄七十餘篇，剔除後世增飾。「真行錄」的批判標準沿用至今，古代殉道研究的第一手文獻選集。' },
