...
const GANDHI_AUTOBIOGRAPHY_CHAPTER_TITLES = [
  'Birth And Parentage',
  'Childhood',
  'Child Marriage',
  'Playing The Husband',
...
const GANDHI_AUTOBIOGRAPHY_CHAPTERS: DazangWork[] = GANDHI_AUTOBIOGRAPHY_CHAPTER_TITLES.map((chapterTitle, index) => {
  const number = index + 1
  return {
    title_zh: `甘地《我對真理的實驗》第${number}章`,
    title_orig: `An Autobiography: The Story of My Experiments with Truth, Chapter ${number}: ${chapterTitle}`,
    author: '莫罕達斯‧卡拉姆昌德‧甘地著；馬哈德夫‧德賽英譯',
    era: '1925–1929 年連載；英文單行本 1927–1929 年',
    place: '英屬印度古吉拉特／阿默達巴德',
    language: '古吉拉特文／英文',
    parent: '我對真理的實驗：甘地自傳（An Autobiography or The Story of My Experiments with Truth）',
    note: `來源：https://www.mkgandhi.org/autobio/autobio.php；原書固定目錄第 ${number} 章〈${chapterTitle}〉`,
    intro: `本卷是甘地以「真理實驗」統攝其生平、信仰與公共實踐的自傳固定第 ${number} 章〈${chapterTitle}〉。原作以古吉拉特文連載，德賽在作者生前譯成英文；章目從家世、婚姻、節食、宗教閱讀與南非反歧視經驗，逐步呈現真理、非暴力、自制、贖罪和跨宗教比較如何成為可反省的生命操練。此處依出版者所列實際章題著錄，不把甘地思想或印度獨立運動的概稱當作史傳作品。`,
  }
})

const GOD_PASSES_BY: DazangWork = {
  title_zh: '神臨證記',
  title_orig: 'God Passes By',
  author: '守基‧阿芬（Shoghi Effendi）',
  era: '1944 年',
  place: '巴勒斯坦託管地海法',
  language: '英文',
  note: '來源：https://www.bahai.org/library/authoritative-texts/shoghi-effendi/god-passes-by/；巴哈伊信仰第一世紀歷史回顧',
  intro: '守基‧阿芬為巴哈伊紀元百周年撰寫的權威歷史回顧，按巴孛、巴哈歐拉、阿博都巴哈與形成期四段敘述一八四四至一九四四年的啟示、迫害、流放、制度建立和全球傳播。作品雖追述十九世紀事件，卻在一九四四年完成並以當時共同體的自我理解整理第一個百年，因此按文本成書年代歸入現代史傳外藏，而不再誤置近世。它是有明確作者、篇章與出版時點的歷史著作，不是泛稱的「巴哈伊信仰史」。',
}

const ERE_VOLUME_ONE_ARTICLE_TITLES = [
  ['A 與 Ω', 'A and Ω'],
  ['阿阿盧', 'Aalu'],
  ['棄置與暴露', 'Abandonment and Exposure'],
  ['自卑', 'Abasement'],
  ['修院院長', 'Abbot'],
  ['狂歡院長', 'Abbot of Unreason'],
  ['誘拐', 'Abduction'],
  ['阿伯拉爾', 'Abelard'],
  ['教唆', 'Abetment'],
  ['無畏山寺派', 'Abhayagiri'],
  ['阿毘達磨', 'Abhidhamma'],
  ['俱舍論釋', 'Abhidharma Kosa Vyakhya'],
  ['能力', 'Ability'],
  ['自然發生說', 'Abiogenesis'],
  ['阿比蓬人', 'Abipones'],
  ['阿博爾與阿博爾－米里人', 'Abor, Abor-Miri'],
  ['原住民族', 'Aborigines'],
  ['墮胎', 'Abortion'],
  ['意志缺失', 'Aboulia'],
  ['亞伯拉罕會', 'Abraham-Men'],
  ...
  ['阿赫里亞人', 'Aheria'],
  ['不害', 'Ahimsa'],
  ['阿希卡爾故事', 'Ahiqar, The Story of'],
  ['艾哈邁達巴德', 'Ahmadabad, Ahmedabad'],
  ['阿洪人', 'Ahoms'],
  ['阿里曼', 'Ahriman'],
  ['阿胡納', 'Ahuna'],
  ['阿胡納－瓦伊里亞禱詞', 'Ahuna-Vairya'],
  ['阿胡拉‧馬茲達', 'Ahura Mazda'],
  ['阿伊努人', 'Ainus'],
  ['艾亞納爾神', 'Aiyanar'],
  ['阿旃陀', 'Ajanta'],
  ...
  ['酒精', 'Alcohol'],
  ['阿留申人', 'Aleuts'],
  ['亞歷山大神學', 'Alexandrian Theology'],
  ['阿爾岡昆人', 'Algonquins'],
  ['阿拉哈巴德', 'Allahabad'],
  ['寓意與寓意詮釋', 'Allegory, Allegorical Interpretation'],
  ['愚人節', 'All Fools’ Day'],
  ['施捨', 'Almsgiving'],
  ['祭壇', 'Altar'],
  ['利他主義', 'Altruism'],
...
const ERE_VOLUME_ONE_ARTICLES: DazangWork[] = ERE_VOLUME_ONE_ARTICLE_TITLES.map(([titleZh, titleOrig], index) => {
  const number = index + 1
  return {
    title_zh: `宗教與倫理百科全書‧卷一‧${titleZh}`,
    title_orig: `Encyclopaedia of Religion and Ethics, Volume I, Article ${number}: ${titleOrig}`,
    author: '詹姆斯‧黑斯廷斯主編；約翰‧塞爾比、路易斯‧格雷協編；各條撰稿人',
    era: '1908 年（全套續出至 1926 年；索引卷約 1927 年）',
    place: '英國愛丁堡／美國紐約',
    language: '英文',
    parent: '宗教與倫理百科全書第一卷：A–Art（Encyclopaedia of Religion and Ethics, Volume I）',
    note: `來源：https://archive.org/details/b29001225_0001；依卷一原書條目次序核對之第 ${number} 條〈${titleOrig}〉`,
    intro: `本卷為黑斯廷斯主編《宗教與倫理百科全書》第一卷 A 至 Art 範圍中的固定條目〈${titleOrig}〉，此處按原書條目順序著錄為第 ${number} 條。全書由宗教史、倫理學、民俗學、神學、哲學與人類學等領域作者協作，將人物、概念、儀式、族群、地點與宗派置於跨文化比較框架。這是具有明確詞頭和篇界的現代宗教知識工程；此處以卷一影像與全文核對，不把單篇心理學、祕學或人類學專著誤列為類書。`,
  }
})
...
export const MODERN_ERA: DazangEra = {
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '一九一七年天主教法典', title_orig: 'Codex Iuris Canonici (1917)', author: '聖座（本篤十五世頒布，甘斯帕里主編）', era: '1917', place: '羅馬', language: '拉丁文', intro: '教會史上第一部現代法典化的教會法，甘斯帕裡樞機把千年教令彙編為兩千四百餘條，庇護十世發起、本篤十五世頒行。它以拿破崙法典式的體例重塑教會治理，行用至一九八三年新法典取代。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '蘭柏會議決議彙編', title_orig: 'Resolutions of the Lambeth Conferences', author: '普世聖公宗蘭柏會議', era: '1908–1998（現代各屆）', place: '倫敦蘭柏宮／坎特伯里', language: '英文', intro: '聖公宗全球主教十年一會的決議彙編：一九三〇年首開節育之禁、一九六八年論戰爭與和平、一九九八年第一一〇決議定性婚姻議題至今爭論不休。無中央法權的宗派如何以決議維繫共融的百年檔案。' },
  ...
  wai: {
      "summary": "現代與基督教交鋒、對話、批判的他宗教哲學神學與世俗思想。猶太傳統以對話哲學、他者倫理與大屠殺神學重構信仰；伊斯蘭世界從現代主義改革到政治伊斯蘭與女性主義釋經；京都學派與禪學西傳開啟了最深入的佛耶哲學對話；印度教以吠檀多普遍主義回應宣教；中國知識界則以文化與哲學論斷質疑宗教的必要。西方自身則產生涂爾幹、韋伯、佛洛伊德以降對宗教的世俗化約，以及世紀之交的新無神論論戰。",
      "divisions": [
        {
          "key": "jewish-modern",
          "label": "猶太現代思想與大屠殺神學部",
          "label_en": "Modern Jewish Thought & Holocaust Theology",
          "desc": "布伯的對話哲學、列維納斯的他者倫理、赫舍爾的靈性神學，及奧許維茲之後的神義論爭議與見證文學。",
          "works": [
            {
              "title_zh": "我與你",
              "title_orig": "Ich und Du",
              "author": "馬丁‧布伯",
              "era": "1923年",
              "place": "德國萊比錫（Insel-Verlag）",
              "language": "德文",
              "intro": "區分「我—你」與「我—它」兩種基本語詞，一切關係延長線指向「永恆之你」；深刻影響布倫納、蒂利希、巴特（《教會教義學》III/2 人論）等辯證神學家的人論。"
            },
            {
              "title_zh": "兩種類型的信仰",
              "title_orig": "Zwei Glaubensweisen",
              "author": "馬丁‧布伯",
              "era": "1950年",
              "place": "瑞士蘇黎世",
              "language": "德文",
              "intro": "區分希伯來 emunah 與希臘化 pistis，主張猶太教與基督教分歧在信仰型態而非耶穌本人。"
            },
            {
              "title_zh": "神之蝕",
              "title_orig": "Gottesfinsternis",
              "author": "馬丁‧布伯",
              "era": "1953年（德文版）／1952年（英文初版）",
              "place": "瑞士蘇黎世（德文版 Manesse）／美國紐約（英文初版 Harper）",
              "language": "德文",
              "intro": "以日蝕為喻回應沙特、海德格、榮格對神的化約；附與榮格論戰，為宗教心理學爭議一手材料。"
            },
            {
              "title_zh": "救贖之星",
              "title_orig": "Der Stern der Erlösung",
              "author": "法蘭茨‧羅森茨威格",
              "era": "1919年成稿、1921年出版",
              "place": "德國法蘭克福",
              "language": "德文",
              "extent": "三部",
              "intro": "以新思維對抗黑格爾整體觀念論；神/世界/人經創造、啟示、救贖結成大衛之星，並置猶太教與基督教為真理雙重形態。"
            },
            {
              "title_zh": "人並非孤獨",
              "title_orig": "Man Is Not Alone: A Philosophy of Religion",
              "author": "亞伯拉罕‧約書亞‧赫舍爾",
              "era": "1951年（紐約 Farrar, Straus and Young 初版）",
              "place": "美國紐約",
              "language": "英文",
              "parent": "赫舍爾宗教哲學兩卷",
              "intro": "赫舍爾的宗教哲學代表作，主張人對「根本的驚奇」（radical amazement）的敬畏才是宗教的起點，而非教義推論。他批評現代人把上帝化約為觀念，強調是上帝在尋找人、人被神所需要。此書以詩性的希伯來先知語言重述猶太靈性，深刻影響二十世紀基督教靈修與猶太—基督教對話。"
            },
            {
              "title_zh": "先知",
              "title_orig": "The Prophets",
              "author": "亞伯拉罕‧約書亞‧赫舍爾",
              "era": "1962年（原德文博論1936）",
              "place": "美國紐約",
              "language": "英文（原德文）",
              "intro": "核心為神的悲憫：先知與上帝情感同構，故對不義有不成比例的憤怒；為民權運動提供神學語言。"
            },
            {
              "title_zh": "總體與無限",
              "title_orig": "Totalité et infini : essai sur l'extériorité",
              "author": "伊曼紐埃爾‧列維納斯",
              "era": "1961年",
              "place": "荷蘭海牙",
              "language": "法文",
              "intro": "列維納斯的哲學主著，以「他者的面容」顛覆西方存有論傳統：倫理先於存有，他者的臉以絕對的無限性向我發出「不可殺人」的召喚，抵抗一切把他者吸納入「總體」的暴力。此書為戰後倫理學轉向的樞紐，對基督教神學的他者論、面容神學與解放神學影響極深。"
            },
            {
              "title_zh": "別於存有，或超越本質",
              "title_orig": "Autrement qu'être ou au-delà de l'essence",
              "author": "埃馬紐埃爾‧列維納斯",
              "era": "1974年",
              "place": "海牙／巴黎",
              "language": "法文",
              "intro": "列維納斯後期主著，比《總體與無限》更徹底：主體並非先存有而後負責，而是從一開始就被他者「劫持」，在「替代」中為他人承擔到受苦的地步。他以此描述一種先於自由的責任結構，與基督教代贖論形成深刻的哲學呼應與張力。"
            },
            {
              "title_zh": "塔木德四講",
              "title_orig": "Quatre lectures talmudiques",
              "author": "埃馬紐埃爾‧列維納斯",
              "era": "1968年",
              "place": "法國巴黎",
              "language": "法文",
              "parent": "列維納斯塔木德講讀系列",
              "extent": "講讀四篇",
              "intro": "列維納斯在法國猶太知識分子年會上的塔木德解讀輯錄，示範如何以哲學方式從拉比文本中讀出普遍的倫理意涵。他主張塔木德的繁瑣律法辯論其實承載著最嚴格的倫理思考，藉此回應西方哲學對猶太教的貶抑，也為猶太—基督教經典詮釋的對話開闢新徑。"
            },
            {
              "title_zh": "孤獨的信仰之人",
              "title_orig": "The Lonely Man of Faith",
              "author": "約瑟夫‧多夫‧索洛維奇克",
              "era": "1965年／1992年單行本",
              "place": "美國紐約／波士頓",
              "language": "英文",
              "intro": "索洛維奇克以創世記兩個亞當敘事為軸，區分「威嚴的亞當」（征服世界的創造者）與「盟約的亞當」（尋求救贖與交契的孤獨者），論證信仰之人在現代社會中無可避免的孤獨。此書是現代正統猶太教最重要的存在主義神學文本，常與基督教存在神學並讀。"
            },
            {
              "title_zh": "奧許維茲之後",
              "title_orig": "After Auschwitz",
              "author": "理查‧魯本斯坦",
              "era": "1966年",
              "place": "美國印第安納波利斯",
              "language": "英文",
              "intro": "魯本斯坦以大屠殺為神學斷裂點，主張傳統「歷史中的上帝」信仰在奧許維茲之後已不可能——若上帝是歷史的主宰，則納粹屠殺亦成其旨意，此結論不可接受。他因而提出「上帝已死」的猶太表述。此書引爆猶太大屠殺神學的論戰，亦迫使基督教神學正面處理苦難與神義論。"
            },
            {
              "title_zh": "上帝在歷史中的臨在",
              "title_orig": "God's Presence in History: Jewish Affirmations and Philosophical Reflections",
              "author": "埃米爾‧法肯海姆",
              "era": "1970年",
              "place": "美國紐約（紐約大學出版社）",
              "language": "英文",
              "intro": "法肯海姆回應魯本斯坦的大屠殺神學，主張猶太人不可把勝利拱手讓給希特勒，提出著名的「第六百十四條誡命」：猶太人有義務存活、記憶並繼續信仰，否則便是給希特勒死後的勝利。此書把大屠殺確立為猶太思想的核心事件，也是基督教反省其反猶遺產的重要對話對象。"
            },
            {
              "title_zh": "夜",
              "title_orig": "La Nuit",
              "author": "埃利‧維瑟爾",
              "era": "1956年（意第緒）／1958年法文",
              "place": "布宜諾斯艾利斯／巴黎",
              "language": "意第緒文、法文",
              "parent": "《夜‧黎明‧白晝》三部曲",
              "intro": "維瑟爾根據自身在奧許維茲與布痕瓦爾德的經歷寫成的見證文學，記述少年信仰在集中營中被焚毀的過程。「絞刑架上的上帝」一幕成為二十世紀神義論最常被引用的場景。此書是大屠殺見證文學的代表，深刻衝擊戰後基督教與猶太教的上帝觀與苦難神學。"
            },
            {
              "title_zh": "如果這是一個人",
              ...
              "language": "義大利文",
              "parent": "奧許維茲三部曲",
              "intro": "萊維以化學家的冷靜筆調記錄其奧許維茲囚禁經歷，追問極端處境如何系統地剝奪人的人性。他拒絕以神學或報復解釋苦難，只求精確作證。此書與維瑟爾《夜》並列為大屠殺見證文學雙璧，是任何苦難神學都必須面對的一手材料。"
            },
            {
              "title_zh": "猶太神祕主義主流",
              "title_orig": "Major Trends in Jewish Mysticism",
              "author": "格爾肖姆‧朔勒姆",
              "era": "1941年",
              "place": "耶路撒冷",
              "language": "英文",
              "extent": "九講",
              "intro": "朔勒姆奠定猶太神祕主義研究學科地位的經典講稿，系統梳理從默卡巴神祕主義、中世紀哈西迪、卡巴拉、盧里亞派到沙巴泰運動與東歐哈西迪的發展脈絡。他主張神祕主義不是猶太教的邊緣異流而是其活力所在，徹底改寫了猶太教史的圖像，也影響基督教神祕主義研究。"
            },
            {
              "title_zh": "猶太教的本質",
              "title_orig": "Das Wesen des Judentums",
              "author": "利奧‧貝克",
              "era": "1905年初版、1922年改寫",
              "place": "德國柏林",
              "language": "德文",
              "intro": "貝克針對哈納克《基督教的本質》而作的回應，主張猶太教是以誡命與倫理行動為核心的「行動的宗教」，基督教則傾向「感受的宗教」。他為猶太教在現代歐洲的思想尊嚴辯護，是二十世紀初猶太—基督教論辯的重要文獻；作者後於特雷津集中營倖存。"
            }
          ]
        },
        {
          "key": "islamic-modern",
          "label": "伊斯蘭現代主義與復興運動部",
          "label_en": "Islamic Modernism & Revivalism",
          "desc": "阿布杜至阿爾昆的改革思想、庫特卜與霍梅尼的政治伊斯蘭，及伊斯蘭女性主義釋經。",
          "works": [
            {
              "title_zh": "認主獨一論",
              "title_orig": "Risālat al-Tawḥīd",
              "author": "穆罕默德‧阿布杜",
              "era": "1897年",
              "place": "埃及開羅",
              "language": "阿拉伯文（英譯 The Theology of Unity）",
              "intro": "伊斯蘭現代主義奠基文本，源自作者在貝魯特蘇丹尼亞學校的神學講稿，重估凱拉姆（kalām）傳統，主張理性與啟示不衝突、創制（ijtihād）之門未閉。"
            },
            {
              "title_zh": "基督宗教的責難與伊斯蘭的論證",
              "title_orig": "Shubuhāt al-Naṣārā wa-Ḥujaj al-Islām",
              "author": "穆罕默德‧拉希德‧里達",
              "era": "1901–1903年於《al-Manār》連載，1905年於開羅結集成書；英譯2008",
              "place": "埃及開羅",
              "language": "阿拉伯文（Simon A. Wood 英譯，Oneworld 2008，ISBN 9781851686711）",
              "intro": "里達在《燈塔》雜誌連載的護教論戰文集，逐條回應基督教傳教士對伊斯蘭的攻擊，並反過來質疑三位一體、道成肉身與福音書文本的可靠性。此書是二十世紀初阿拉伯世界最具影響力的伊斯蘭護教文獻，界定了此後穆斯林—基督徒論辯的基本議題與語彙。"
            },
            {
              "title_zh": "伊斯蘭宗教思想之重建",
              "title_orig": "The Reconstruction of Religious Thought in Islam",
              "author": "穆罕默德‧伊克巴爾",
              "era": "1930年（拉合爾初版《Six Lectures…》）／1934年牛津版增第七講",
              "place": "英屬印度：講座於馬德拉斯、海德拉巴、阿里格爾；初版於拉合爾",
              "language": "英文",
              "intro": "以柏格森、懷德海、愛因斯坦等現代思想重述伊斯蘭形上學，將終極real者理解為「自我／自性」（khudī, ego），主張重啟伊智提哈德（ijtihād）。"
            },
            {
              "title_zh": "里程碑",
              "title_orig": "Maʿālim fī al-Ṭarīq",
              "author": "賽義德‧庫特卜",
              "era": "1964年",
              "place": "埃及開羅（獄中）",
              "language": "阿拉伯文（英譯）",
              "intro": "庫特卜在獄中寫成的伊斯蘭復興運動綱領（阿拉伯文原題 Maʿālim fī al-Ṭarīq，另譯《路標》）。他主張當代社會（包括名義上的穆斯林國家）已墮入前伊斯蘭的「蒙昧」（jāhiliyya），須由先鋒群體以聖戰重建真主主權。此書使他被處決，卻成為此後伊斯蘭政治運動最具影響力也最具爭議的文本。"
            },
            {
              "title_zh": "在古蘭經的蔭庇下",
              "title_orig": "Fī Ẓilāl al-Qurʾān",
              "author": "賽義德‧庫特卜",
              "era": "1951–1965年",
              "place": "埃及開羅（多在獄中）",
              "language": "阿拉伯文（英譯）",
              "extent": "全三十卷（依古蘭經三十分卷；阿拉伯文原版通常裝訂為六冊，Adil Salahi 英譯本 18 冊）",
              "intro": "流傳最廣的現代古蘭經註，以文學鑑賞與運動綱領並行，批判猶太教、基督宗教與世俗現代性。"
            },
            {
              "title_zh": "伊斯蘭教義淺說",
              "title_orig": "رسالہ دینیات (Risālah-yi Dīniyāt)；英譯本題名 Towards Understanding Islam",
              "author": "阿布‧阿拉‧毛杜迪",
              "era": "1932年",
              "place": "印度海德拉巴",
              "language": "烏爾都文（Khurshid Ahmad 英譯）",
              "intro": "1932 年於海德拉巴以烏爾都文寫成的伊斯蘭教義入門讀本，講信仰、五功與沙里亞，後為印巴地區學校採為神學教科書，並奠定毛杜迪日後伊斯蘭促進會（Jamaat-e-Islami，1941 年創立）的教義基調。"
            },
            {
              "title_zh": "伊斯蘭與現代性",
              "title_orig": "Islam and Modernity: Transformation of an Intellectual Tradition",
              "author": "法茲盧爾‧拉赫曼（Fazlur Rahman, 1919–1988）",
              "era": "1982年",
              "place": "美國芝加哥",
              "language": "英文",
              "intro": "法茲魯拉赫曼檢討伊斯蘭教育傳統的知識轉型困境，主張唯有以歷史脈絡化的「雙重運動」詮釋法——從具體經文上溯普遍原則，再下貫當代處境——伊斯蘭才能真正回應現代性。此書是伊斯蘭現代主義釋經學最系統的方法論陳述，與基督教歷史批判釋經可相互參照。"
            },
            {
              "title_zh": "古蘭經的重大主題",
              "title_orig": "Major Themes of the Qurʾān",
              "author": "法茲魯爾‧拉赫曼（Fazlur Rahman Malik, 1919–1988）",
              "era": "1980年",
              "place": "美國明尼阿波利斯／芝加哥（Bibliotheca Islamica, 1980；芝加哥大學出版社 2009 第二版）",
              "language": "英文",
              "intro": "以八大主題（真主／個體之人／社會中之人／自然／先知與啟示／末世論／撒但與惡／穆斯林社群的興起）貫串全經的主題式古蘭經神學；作者之「雙重運動」詮釋法系統表述於其 1982 年《伊斯蘭與現代性》，本書為其主題詮釋的實作，與聖經神學方法論具對話接口。"
            },
            {
              "title_zh": "知識與神聖",
              "title_orig": "Knowledge and the Sacred",
              "author": "賽義德‧侯賽因‧納斯爾",
              "era": "1981年（吉福德講座）",
              "place": "英國愛丁堡",
              "language": "英文",
              "intro": "納斯爾的吉福德講座，從傳統學派（Traditionalism）立場批判現代世俗知識體系對「神聖」的放逐，主張各大宗教傳統共享一超越的智慧本源。他以伊斯蘭形上學為據，重申知識的神聖性與宗教的多元一致，是現代宗教多元論與跨宗教哲學對話的重要文本。"
            },
            {
              "title_zh": "面紗與男性精英",
              "title_orig": "Le harem politique / The Veil and the Male Elite",
              "author": "法蒂瑪‧梅爾尼西",
              "era": "1987年法文／1991年英譯",
              "place": "摩洛哥拉巴特；巴黎",
              "language": "法文（英譯）",
              "intro": "梅爾尼西以社會學與聖訓考證方法，論證伊斯蘭對女性的種種限制多出於後世男性精英的傳述與詮釋，而非先知本人的實踐。她重讀早期伊斯蘭史，指出先知身邊女性的能動性如何被抹除。此書是伊斯蘭女性主義的奠基之作，也回應了西方對伊斯蘭性別議題的批評。"
            },
            {
              "title_zh": "古蘭經與女性",
              "title_orig": "Qurʾan and Woman",
              "author": "阿米娜‧瓦杜德",
              "era": "1992年／1999年牛津增訂",
              "place": "馬來西亞吉隆坡；美國",
              "language": "英文",
              "intro": "瓦杜德從古蘭經文本內部進行性別詮釋，主張經文的核心是男女在真主前的平等，既有的父權解讀來自詮釋傳統而非文本本身。她提出以「詮釋學循環」重讀經文的方法。此書是伊斯蘭女性主義釋經學的代表作，與基督教女性主義神學形成跨宗教的方法論對話。"
            },
            {
              "title_zh": "伊斯蘭與革命（含《伊斯蘭政府》）",
              "title_orig": "Islam and Revolution",
              "author": "魯霍拉‧霍梅尼",
              "era": "1970年講稿，英譯1981",
              "place": "伊拉克納賈夫；伊朗",
              "language": "波斯文（英譯）",
              "intro": "霍梅尼流亡期間的講稿與著作結集，核心是「教法學家監護」（vilāyat-i faqīh）理論——主張在隱遁伊瑪目缺席期間，教法學家應直接掌握國家統治權。此說為一九七九年伊朗伊斯蘭革命提供了理論基礎，是二十世紀政教關係最具實踐後果的宗教政治論述之一。"
            },
            {
              "title_zh": "重思伊斯蘭",
              "title_orig": "Rethinking Islam: Common Questions, Uncommon Answers（法文原著 Ouvertures sur l'islam, 1989）",
              "author": "穆罕默德‧阿爾昆",
              "era": "1989年法文原著／1994年英譯（Robert D. Lee 譯編，Westview Press）",
              "place": "阿爾及利亞（作者出身）；巴黎／美國博爾德（出版）",
              "language": "法文（Robert D. Lee 英譯）",
              "intro": "阿爾昆運用當代人文科學（歷史人類學、語言學、後結構主義）解構伊斯蘭傳統中「不可思考者」的形成機制，主張經文的神聖性不應阻擋歷史批判的探問。他呼籲一種批判的伊斯蘭思想，與基督教啟蒙後的自我批判歷程可作對照，在穆斯林世界引發極大爭議。"
            },
            {
              "title_zh": "伊斯蘭的第二訊息",
              "title_orig": "The Second Message of Islam",
              "author": "馬赫穆德‧穆罕默德‧塔哈",
              "era": "1967年／1987年英譯",
              "place": "蘇丹恩圖曼（Omdurman，共和兄弟會出版地；英譯本 1987 由美國雪城大學出版社 Syracuse University Press 出版）",
              "language": "阿拉伯文（英譯）",
              "intro": "雙重啟示論：麥地那經文為因應七世紀社會的「第一訊息」，麥加經文才是永恆普世的「第二訊息」；作者1985年1月18日在喀土穆以叛教罪被處決。"
            },
            {
              "title_zh": "人與伊斯蘭",
              "title_orig": "Insān va Islām / Man and Islam",
              "author": "阿里‧沙里亞蒂",
              "era": "講稿為1960年代末–1970年代初；英譯本 1981（Free Islamic Literature, 休士頓，Fatollah Marjani 譯）與 1982（University of Mashhad Press，Ghulam M. Fayez 譯）",
              "place": "講稿：伊朗馬什哈德大學、德黑蘭 Hosseiniyeh Ershad；英譯出版：美國休士頓 / 伊朗馬什哈德",
              "language": "波斯文原著（Insān va Islām），有兩種英譯",
              "intro": "沙里亞蒂在馬什哈德大學等地的系列講稿，從伊斯蘭觀點論人的本質與處境（神學人類學）。作者融合什葉敘事與法農、存在主義，另著有《紅色什葉／黑色什葉》，被視為伊朗革命的意識形態導師。（原「紅色/黑色什葉」屬其另一部作品，非本書主題）"
            }
          ]
        },
        {
          "key": "buddhist-dialogue",
          "label": "佛教現代思想與佛耶對話部",
          "label_en": "Modern Buddhist Thought & Buddhist–Christian Dialogue",
          "desc": "京都學派以「絕對無」重解神與空、鈴木與阿部正雄的禪耶比較、一行禪師與達賴喇嘛的對話，及漢傳人間佛教。",
          "works": [
            {
              "title_zh": "善的研究",
              "title_orig": "善の研究",
              "author": "西田幾多郎",
              "era": "1911（明治44年2月，弘道館）；1921（大正10年）岩波書店改版",
              "place": "日本東京（弘道館刊行）；著述期在金澤，作者時任京都帝國大學",
              "language": "日文",
              "parent": "西田幾多郎全集",
              "intro": "西田幾多郎的處女作與京都學派的起點，以「純粹經驗」——主客未分之前的直接經驗——為一切實在的根柢，重構知識、道德與宗教。他借禪的體證重讀西方哲學，主張宗教是自我與絕對的合一。此書開啟了東亞哲學與基督教神學的實質對話，影響田立克、潘尼卡等神學家。"
            },
            {
              "title_zh": "場所的邏輯與宗教的世界觀",
              "title_orig": "場所的論理と宗教的世界観",
              "author": "西田幾多郎",
              "era": "1945",
              "place": "日本鎌倉",
              "language": "日文",
              "parent": "西田幾多郎全集",
              "intro": "西田臨終前完成的論文，以「絕對矛盾的自我同一」與「絕對無的場所」界定神與世界的關係：真正的絕對者不是與相對者對立的存有，而是自我否定地包含相對者的絕對無。他藉此重解基督教的道成肉身與愛。此文是京都學派宗教哲學的總綱，佛耶對話最常引用的文本。"
            },
            {
              "title_zh": "宗教是什麼（宗教與虛無）",
              "title_orig": "宗教とは何か / Religion and Nothingness",
              "author": "西谷啟治",
              "era": "1961（英譯1982）",
              "place": "日本京都",
              "language": "日文",
              "parent": "西谷啟治著作集",
              "intro": "主張須貫穿虛無而抵達空；專章討論位格神、愛與虛己的限度，歐美最常引述的東亞宗教哲學著作。"
            },
            {
              "title_zh": "神與絕對無",
              "title_orig": "神と絶対無",
              "author": "西谷啟治",
              "era": "1948",
              "place": "日本東京（弘文堂刊；著者時任京都帝大）",
              "language": "日文",
              "parent": "西谷啟治著作集",
              "intro": "以艾克哈特「神與人的關係」為主軸，論基督教神秘主義中突破位格有神論、通向絕對無的思路（路德十字架神學一節待覆核）。"
            },
            {
              "title_zh": "禪與日本文化",
              "title_orig": "Zen Buddhism and Its Influence on Japanese Culture（1938, The Eastern Buddhist Society, 京都）／增訂版 Zen and Japanese Culture（1959, Pantheon/Bollingen, 紐約）；日譯本《禅と日本文化》為北川桃雄譯，岩波新書 1940",
              "author": "鈴木大拙",
              "era": "1938（1959 增訂版）",
              "place": "日本京都（1938 初版）／美國紐約（1959 增訂版）",
              "language": "英文（原著）；日文版為 1940 年北川桃雄譯本",
              "intro": "鈴木大拙向西方讀者闡述禪如何滲透日本的藝術、武士道、俳句、茶道與自然觀的名著。他主張禪不是教義而是直觀生命的方式。此書是禪學西傳最具影響力的著作，塑造了戰後歐美對東方靈性的想像，也促成基督教修士（如默頓）與禪的深度接觸。"
            },
            {
              "title_zh": "神祕主義：基督教與佛教",
              "title_orig": "Mysticism, Christian and Buddhist",
              "author": "鈴木大拙",
              "era": "1957",
              "place": "美國紐約",
              "language": "英文",
              "intro": "鈴木大拙比較艾克哈特大師的德意志神祕主義與淨土真宗、禪的體驗結構，主張二者在「無我」與「絕對的當下」上高度契合。他以此論證東西方神祕經驗的可通約性。此書是佛耶神祕主義比較研究的開創之作，也是默頓等基督教靈修作家的重要對話對象。"
            },
            {
              "title_zh": "禪與西方思想",
              "title_orig": "Zen and Western Thought",
              "author": "阿部正雄",
              "era": "1985（Honolulu: University of Hawaii Press；同年 London: Macmillan）",
              "place": "日本／美國",
              "language": "英文",
              "intro": "阿部正雄（1915–2006）繼鈴木大拙之後向西方詮釋禪的代表哲學家，京都學派第二代。本書由 William R. LaFleur 編選其英文論文集，John Hick 作序，以「動態空（dynamic Sunyata）」為軸，與海德格、尼采、懷德海、田立克等西方哲學神學對話，並闡明佛教立場的宗教交談觀。"
            },
            {
              "title_zh": "虛己的神",
              "title_orig": "The Emptying God",
              "author": "阿部正雄；柯布、艾夫斯編",
              "era": "1990",
              "place": "美國紐約州馬利諾（Maryknoll, NY，Orbis Books）",
              "language": "英文",
              "extent": "阿部正雄主論文〈Kenotic God and Dynamic Sunyata〉＋七位學者回應＋阿部答辯；xix + 212 頁",
              "intro": "環繞基督宗教「神的虛己（kenosis）」是否可與佛教「空（sunyata）」互譯、以及奧許維茲之後的神觀；回應者含阿爾提澤、波洛維茨、柯布、凱勒、莫特曼、奧格登、崔西，編排嚴謹的跨宗教辯論合集。"
            },
            {
              "title_zh": "靈魂中的上帝誕生與突破至神性——艾克哈特大師的神祕人學及其與禪佛教神祕主義的對觀",
              "title_orig": "Die Gottesgeburt in der Seele und der Durchbruch zur Gottheit: Die mystische Anthropologie Meister Eckharts und ihre Konfrontation mit der Mystik des Zen-Buddhismus",
              "author": "上田閑照",
              "era": "1965",
              "place": "德國居特斯洛（Gütersloh，Gütersloher Verlagshaus Mohn 出版；博士學位取自馬爾堡大學）",
              "language": "德文",
              "intro": "上田閑照的德文博士論文，細密比對艾克哈特「靈魂中神的誕生」與「突破至神性」兩階段，與禪的見性、無位真人結構。他指出艾克哈特的「神性」（Gottheit）超越位格神，正可與禪的「絕對無」對觀。此書是佛耶神祕主義比較研究最嚴謹的學術範本。"
            },
            {
              "title_zh": "佛教與基督教的接點",
              "title_orig": "仏教とキリスト教の接点",
              "author": "八木誠一",
              "era": "1975",
              "place": "日本京都",
              "language": "日文",
              "intro": "八木誠一以新約學者兼佛教研究者的雙重身分，尋找佛教「緣起」與基督教「在基督裡」的結構性接點，主張二者皆指向自我中心性的破除與「場」的實在。此書是日本佛耶對話最具原創性的神學嘗試，開啟了以佛教範疇重述基督論的路徑。"
            },
            {
              "title_zh": "生生基督世世佛",
              "title_orig": "Living Buddha, Living Christ",
              "author": "一行禪師",
              "era": "1995",
              "place": "美國／法國梅村",
              "language": "英文",
              "intro": "一行禪師以正念修行的視角並讀耶穌與佛陀，主張二者皆是覺醒的導師，其教誨在慈悲、當下與轉化上深度相通。他強調對話不是把對方化約為自己，而是讓兩個傳統彼此照亮。此書是當代最廣為流傳的佛耶對話著作，深刻影響西方的跨宗教靈修實踐。"
            },
            {
              "title_zh": "善心：耶穌教誨的佛教觀點",
              "title_orig": "The Good Heart",
              "author": "第十四世達賴喇嘛丹增嘉措",
              "era": "1996",
              "place": "美國波士頓（Wisdom Publications 出版）；講座地為英國倫敦密德薩斯大學（Middlesex University）",
              "language": "英文（1994 年講座現場由圖登晉巴 Thupten Jinpa 自藏文口譯，講稿整理成書）",
              "intro": "1994 年倫敦「約翰‧梅茵研討會」（John Main Seminar）講稿。達賴喇嘛就四福音書中八段經文逐段講解，含登山寶訓（八福）、芥菜種比喻、愛仇敵、天國、復活、變容、差遣與信心；書中另收與基督徒與會者的對談、佛教與基督教名詞對照表。屬選段講疏，非全本福音書註釋，宜避免「唯一完整福音書講疏」之說。"
            },
            {
              "title_zh": "佛法概論",
              "title_orig": "佛法概論",
              "author": "印順",
              "era": "1949",
              "place": "中國廈門／香港（1949 出版於香港，後於臺灣流通）",
              "language": "漢文",
              "parent": "妙雲集‧中編",
              "intro": "印順以《阿含經》為本，系統重構佛法的根本義理——緣起、三法印、四諦與菩薩道，力主回歸釋尊本懷。此書奠定「人間佛教」的教義基礎，主張佛法在人間、成佛在人間，對台灣與華人佛教影響深遠，亦是漢傳佛教與基督教對話時最常被引用的當代教義綱要。"
            },
            {
              "title_zh": "契理契機之人間佛教",
              "title_orig": "契理契機之人間佛教",
              "author": "印順",
              "era": "1989",
              "place": "臺灣新竹",
              "language": "漢文",
              "extent": "單篇長文成冊",
              "intro": "印順晚年總結其思想歷程與人間佛教主張的關鍵論文，闡明佛法弘傳須「契理」（不失根本義理）又「契機」（回應時代處境）。他批判天神化、鬼神化的佛教流變，主張回歸人間。此文是理解當代漢傳佛教改革方向的核心文獻，與基督教的處境化神學課題相呼應。"
            }
          ]
        },
        {
          "key": "hindu-modern",
          "label": "印度教現代思想部",
          "label_en": "Modern Hindu Thought",
          "desc": "拉達克里希南的哲學辯護、甘地的非暴力與對宣教的批評、奧羅賓多的整體瑜伽與不二論證悟傳統。",
          "works": [
            {
              "title_zh": "東方宗教與西方思想",
              "title_orig": "Eastern Religions and Western Thought",
              "author": "薩爾瓦帕利‧拉達克里希南",
              "era": "1939年（基於 1936–38 年牛津 Upton Lectures 及 Haskell Lectures 等講稿）",
              "place": "英國牛津（Clarendon Press／Humphrey Milford, Oxford University Press）",
              "language": "英文",
              "extent": "單卷，xiii+394 頁",
              "intro": "主張西方思想受東方宗教滋養，批評基督宗教排他主義；以吠檀多不二論倡諸教殊途同歸。"
            },
            {
              "title_zh": "印度教徒的生活觀",
              "title_orig": "The Hindu View of Life",
              "author": "薩爾瓦帕利‧拉達克里希南",
              "era": "1926年講座，1927年出版",
              "place": "英國牛津",
              "language": "英文",
              "extent": "單卷，四講",
              "intro": "拉達克里希南的希伯特講座，向西方聽眾闡述印度教並非偶像崇拜或宿命論，而是一種容納多元進路的靈性生活觀，其核心是自我證悟而非教條順從。他藉此回應基督教傳教士對印度教的貶抑。此書是印度教現代自我詮釋的代表作，也是宗教多元論的早期重要陳述。"
            },
            {
              "title_zh": "理想主義的人生觀",
              "title_orig": "An Idealist View of Life",
              "author": "薩爾瓦帕利‧拉達克里希南",
              "era": "1929–1930年希伯特講座，1932年出版",
              "place": "英國曼徹斯特／倫敦（George Allen & Unwin，倫敦出版）",
              "language": "英文",
              "extent": "單卷（初版351頁；1937年修訂二版）",
              "intro": "拉達克里希南的希伯特講座，主張唯物論與實證主義無法安頓人的精神生活，須以「理想主義」——以精神為實在之根本——重建人生觀。他融吠檀多與西方觀念論，論證宗教直觀的知識地位。此書是他向西方哲學界系統陳述印度形上學的主著。"
            },
            {
              "title_zh": "我對真理的實驗（自傳）",
              "title_orig": "An Autobiography, or The Story of My Experiments with Truth",
              "author": "莫罕達斯‧甘地",
              "era": "1925–1929連載，1927–1929成書",
              "place": "印度亞美達巴德",
              "language": "古吉拉特文原著，英文譯本",
              "extent": "全五部",
              "intro": "甘地的自傳，記述他一生以「真理」（satya）與「非暴力」（ahimsa）為軸的種種實驗，包括飲食、獨身、政治抗爭與宗教探索。他坦言曾深受登山寶訓感動卻不改信基督教，並批評傳教士的改宗事業。此書是理解甘地宗教觀與其對基督教之愛憎交織的核心文本。"
            },
            {
              "title_zh": "印度自治",
              "title_orig": "Hind Swaraj",
              "author": "莫罕達斯‧甘地",
              "era": "1909 年 11 月撰於倫敦返南非的 SS Kildonan Castle 船上；古吉拉特文連載於《Indian Opinion》1909 年 12 月 11 日、18 日兩期，1910 年 1 月出單行本；甘地自譯英文版 1910 年由鳳凰城 International Press 出版（此為他唯一自譯成英文的著作）；1921 年再版加新序，非重新翻譯",
              "place": "撰於倫敦—南非航程船上；出版於南非納塔爾鳳凰村（Phoenix Settlement，德班近郊）",
              "language": "古吉拉特文原著，1910 年甘地本人英譯",
              "extent": "對話體二十章",
              "intro": "甘地早期的政治宣言，以對話體批判現代西方文明——鐵路、律師、醫生與機器——主張真正的自治（swaraj）是自我節制而非取代英國人統治。他把政治問題根本地轉為道德與靈性問題。此書是非暴力政治哲學的奠基文獻，也是對西方（含基督教文明）現代性最尖銳的殖民地批判。"
            },
            {
              "title_zh": "基督教宣教：其在印度的地位",
              "title_orig": "Christian Missions: Their Place in India",
              "author": "莫罕達斯‧甘地（庫馬拉帕編）",
              "era": "1941年",
              "place": "印度亞美達巴德",
              "language": "英文",
              "extent": "文集",
              "intro": "甘地歷年談論基督教與傳教事業言論的結集。他一面推崇耶穌與登山寶訓，一面嚴厲批評以改宗為目的的宣教是對印度文化的暴力，主張傳教士應以服務而非勸改為職志。此書是二十世紀宣教學最重要的非基督徒批評，直接促成普世宣教運動反省其方法。"
            },
            {
              "title_zh": "神聖人生論",
              "title_orig": "The Life Divine",
              "author": "室利‧奧羅賓多",
              "era": "1914–1919連載，1939–1940成書",
              "place": "印度本地治里",
              "language": "英文",
              "extent": "全二卷",
              "intro": "奧羅賓多的哲學主著，主張宇宙是「超心思」（Supermind）逐級下降又逐級上升的演化歷程，物質、生命、心思之上還有待實現的神聖意識，人的使命是使神聖生命在地上實現。此書融吠檀多與演化論，是現代印度形上學最龐大的體系，常與德日進的演化神學並讀。"
            },
            {
              "title_zh": "瑜伽的綜合",
              "title_orig": "The Synthesis of Yoga",
              "author": "室利‧奧羅賓多",
              "era": "1914–1921 於《Arya》月刊連載；1948 第一部〈神聖事業瑜伽〉單行本（馬德拉斯 Sri Aurobindo Library），1955 導論＋四部全帙合刊",
              "place": "印度本地治里",
              "language": "英文",
              "extent": "導論〈綜合的條件〉＋四部（神聖事業瑜伽／整體知識瑜伽／神聖愛的瑜伽／自我圓成瑜伽）",
              "intro": "奧羅賓多綜合業瑜伽、智瑜伽、信愛瑜伽與王瑜伽，提出「整體瑜伽」——不出世棄世，而是使整個生命向神聖意識轉化。他主張瑜伽的目的不是個人解脫而是集體的神聖化。此書是整體瑜伽的實踐總綱，對西方新靈性運動與跨宗教靈修影響深遠。"
            },
            {
              "title_zh": "我是誰？",
              "title_orig": "Nāṉ Yār?",
              "author": "拉瑪那‧馬哈希",
              "era": "1901/1902年問答，1923年泰米爾文初刊（問答本），散文本約1926–1927年由本人改寫",
              "place": "印度蒂魯瓦納馬萊",
              "language": "泰米爾文原著，英文譯本",
              "extent": "問答本三十則（後另有二十八則刪訂本，1932年第四版）；散文本二十段",
              "intro": "拉瑪那‧馬哈希最著名的教誨小品，以問答體闡述其核心方法「自我探問」（ātma-vichāra）——不斷追問「我是誰」，直至一切身心認同脫落，唯餘純粹的「我—我」自明存在。此書是二十世紀不二論（Advaita）最簡潔有力的實修文本，廣泛影響西方靈性追尋者。"
            },
            {
              "title_zh": "最初與最後的自由",
              "title_orig": "The First and Last Freedom",
              "author": "吉杜‧克里希那穆提",
              "era": "1954年",
              "place": "英國倫敦／美國",
              "language": "英文",
              "extent": "附赫胥黎序",
              "intro": "克里希那穆提的講話結集，主張一切組織化宗教、權威、教條與上師都是自由的障礙，真理是「無路之國」，須由個人在無選擇的覺察中自行發現。他徹底拒絕成為救主或建立體系。此書是二十世紀反體制靈性最具代表性的文本，對制度性宗教（含基督教）構成根本質疑。"
            },
            {
              "title_zh": "室利羅摩克里希那福音書",
              "title_orig": "The Gospel of Sri Ramakrishna",
              "author": "馬亨德拉納特‧笈多記錄，尼基拉南達英譯",
              "era": "孟加拉文1902–1932；英譯1942",
              "place": "加爾各答／紐約",
              "language": "孟加拉文原著，英文譯本",
              "extent": "英譯一卷本約 1,063 頁（原著孟加拉文五卷）",
              "intro": "笈多以日記體逐日記錄其師羅摩克里希那的言談與行止，記述這位孟加拉神祕家如何親身修習印度教各派乃至伊斯蘭與基督教法門，皆達同一證悟，據以主張諸道同歸。此書是現代印度教最重要的一手靈性文獻，也是宗教多元論最常被援引的實證見證。"
            },
            {
              "title_zh": "薩達那：生命的證悟",
              "title_orig": "Sādhanā: The Realisation of Life",
              "author": "羅賓德拉納特‧泰戈爾（Rabindranath Tagore, 1861–1941）",
              "era": "1913年",
              "place": "哈佛（麻州劍橋）宣讀／倫敦‧紐約 Macmillan 出版；文稿源自桑蒂尼蓋登孟加拉語講話",
              "language": "英文",
              "extent": "八講",
              "intro": "泰戈爾在哈佛的講稿，以奧義書「梵我一如」的傳統闡述其靈性觀：人的圓滿不在棄世苦修，而在於在有限的日常、自然與愛中體證無限。他反對把靈性與生活二分，也批評制度化宗教的形式主義。此書是泰戈爾向西方陳述印度靈性最完整的哲學文本，深受西方讀者喜愛。"
            }
          ]
        },
        {
          "key": "chinese-modern",
          "label": "中國近現代反教與宗教思想部",
          "label_en": "Modern Chinese Anti-Christian & Religious Thought",
          "desc": "一九二二年非基督教運動文獻，及梁漱溟、陳獨秀、熊十力、馮友蘭對宗教與中國文化的論斷。",
          "works": [
            {
              "title_zh": "非基督教運動文獻選譯",
              "title_orig": "The Anti-Christian Movement",
              "author": "非基督教運動諸團體（中華基督教男女學生青年會譯印）",
              "era": "1925（第二版）",
              "place": "上海",
              "language": "英文（譯自中文）",
              "extent": "35頁小冊（第二版）",
              "intro": "1920年代中國非基督教運動宣言與論文的英譯結集，攻擊教會與帝國主義、資本主義的共謀；由中華基督教男女學生青年會為英語讀者譯印。"
            },
            {
              "title_zh": "東西文化及其哲學",
              "title_orig": "東西文化及其哲學",
              "author": "梁漱溟",
              "era": "1920–1921 講稿，1921 初版（1922 商務印書館上海版）",
              "place": "北京（講稿；財政部印刷局初版）／上海（商務印書館通行版）",
              "language": "中文",
              "intro": "以「意欲」三路向（西方向前、中國調和持中、印度反身向後）解釋文化差異；論西方宗教與基督教屬向前路向下的產物，主張未來世界文化為中國孔家生活態度之復興，以「剛」的人生態度取代宗教式救贖。"
            },
            {
              "title_zh": "中國文化要義",
              "title_orig": "中國文化要義",
              "author": "梁漱溟",
              "era": "1949（1941 構思、1942 著筆、1949 年 6 月完稿，同年 11 月成都路明書店初版豎排本）",
              "place": "成都（路明書店初版）",
              "language": "中文",
              "intro": "梁漱溟從倫理本位、職業分立等角度剖析中國社會結構與文化特質，主張中國文化以道德代宗教，因而缺乏西方式的宗教組織與階級對抗。此書是理解近代中國知識分子如何界定「中國不需要宗教」的關鍵文本，構成基督教在華傳播的深層文化障礙。"
            },
            {
              "title_zh": "獨秀文存",
              "title_orig": "獨秀文存",
              ...
              "place": "上海",
              "language": "中文",
              "intro": "陳獨秀《新青年》時期文章結集，包含〈基督教與中國人〉等直接論及宗教的重要篇章。他早年肯定基督教的「愛與犧牲」精神可救中國人的冷酷，其後轉向以科學與民主批判一切宗教。此書是五四時期宗教觀轉折的第一手材料，也是非基督教運動的思想前奏。"
            },
            {
              "title_zh": "新唯識論",
              "title_orig": "新唯識論",
              "author": "熊十力",
              "era": "1932 文言文本，1944 語體文本",
              "place": "杭州／重慶",
              "language": "中文",
              "intro": "以體用不二、翕闢成變立說，援《易》生生之本體，批判佛教唯識學之空寂，亦不取外來創造神觀。"
            },
            {
              "title_zh": "讀經示要",
              "title_orig": "讀經示要",
              "author": "熊十力",
              "era": "1945（重慶南方印書館初版）；1949 後台北廣文書局多次重印",
              "place": "重慶（初版）／台北（重印）",
              "language": "中文",
              "intro": "熊十力闡述其讀經方法與儒學本體論的講稿，力主六經非史料而是體證性命之學的門徑，並批判以西方科學或宗教格套裁量中國經典。此書是現代新儒家為傳統經學辯護的代表作，展現儒家在基督教與科學主義雙重衝擊下的自我重建。"
            },
            {
              "title_zh": "新原人",
              "title_orig": "新原人",
              ...
              "place": "昆明",
              "language": "中文",
              "intro": "馮友蘭「貞元六書」之一，提出人生四境界說——自然、功利、道德、天地——主張哲學的任務是提高人的精神境界，使人達到「同天」的境地。他以此主張中國哲學可取代宗教的功能。此書是現代中國哲學回應「中國需不需要宗教」之問的系統答案。"
            },
            {
              "title_zh": "當代儒佛之爭：熊十力新唯識論論戰選輯",
              "title_orig": "當代儒佛之爭",
              "author": "熊十力、太虛、印順等著；林安梧選編",
              "era": "1932年《新唯識論》文言本引發之論戰（延續至1950年代印順評論），1981年結集",
              "place": "台北市",
              "language": "中文",
              "extent": "3, 396 頁；21 公分",
              "intro": "輯錄熊十力《新唯識論》引發的儒佛論戰文獻，收太虛、印順、歐陽竟無一系的駁議與熊氏答辯，爭點在於熊氏以儒家《易》理改造唯識學是否背離佛法。此輯是二十世紀中國最重要的宗教哲學論戰紀錄，展現本土思想傳統在現代處境中的自我釐清。"
            }
          ]
        },
        {
          "key": "new-religions",
          "label": "新興宗教與新靈性運動部",
          "label_en": "New Religious Movements & New Spirituality",
          "desc": "山達基、伊斯蘭民族、巴哈伊、天理教、創價學會等新興宗教教典，美洲原住民復振與新時代靈性文獻。",
          "works": [
            {
              "title_zh": "戴尼提：現代心靈健康科學",
              "title_orig": "Dianetics: The Modern Science of Mental Health",
              "author": "L‧羅恩‧賀伯特",
              "era": "1950",
              "place": "美國紐約",
              "language": "英文",
              "extent": "單卷",
              "intro": "賀伯特提出「戴尼提」療法的奠基之作，主張人的心靈存有「印痕」（engram）記錄，藉聽析（auditing）可清除之而成為「清新者」。此書後發展為山達基教會的教義基礎。作為二十世紀最具爭議的新興宗教教典，它是研究現代科技語彙如何被轉化為救贖敘事的關鍵案例。"
            },
            {
              "title_zh": "致美洲黑人的信息",
              "title_orig": "Message to the Blackman in America",
              "author": "以利亞‧穆罕默德",
              "era": "1965",
              "place": "美國芝加哥",
              "language": "英文",
              "extent": "單卷",
              "intro": "伊利亞‧穆罕默德闡述「伊斯蘭民族」（Nation of Islam）教義的核心文本，主張黑人是原初人類、白人是後造之族，並以伊斯蘭之名建構黑人自尊與分離主義主張。此書是二十世紀美國黑人宗教運動的重要文獻，也對黑人教會與民權運動構成內部挑戰。"
            },
            {
              "title_zh": "神之經過",
              "title_orig": "God Passes By",
              ...
              "language": "英文",
              "extent": "單卷",
              "intro": "巴哈伊信仰首任聖護守基‧阿芬第為紀念巴比宣道百年而作的權威史述兼神學詮釋，敘述從巴孛、巴哈歐拉到阿博都巴哈的歷程，並闡明巴哈伊「漸進啟示」的核心教義——諸大宗教皆為同一神聖教育的階段。此書是巴哈伊自我理解的基準文本。"
            },
            {
              "title_zh": "天理教教典",
              "title_orig": "天理教教典",
              ...
              "language": "日文",
              "extent": "全10章",
              "intro": "天理教教會本部制定的官方教義綱要，系統陳述教祖中山美伎所傳「元初的理」——世人皆為神之子女、身體乃向神所借、須掃除心之塵埃以達「陽氣生活」。此書是日本近代最大新宗教之一的教義定本，是研究非西方新興宗教如何自我體系化的重要文本。"
            },
            {
              "title_zh": "御筆先",
              "title_orig": "おふでさき",
              ...
              "language": "日文（和歌體）",
              "extent": "全17號",
              "intro": "天理教教祖中山美伎以平假名和歌體親筆書寫的根本經典，凡一千七百餘首，記述神意的直接啟示。其平易的和歌形式使教義得以在庶民間流傳。作為日本新宗教中罕見由女性教祖親撰的核心經典，它在宗教創教學與性別研究上皆具高度價值。"
            },
            {
              "title_zh": "人間革命",
              "title_orig": "人間革命",
              "author": "池田大作",
              "era": "1965年起於《聖教新聞》連載，1993年完結；英譯首卷 The Human Revolution 1972",
              "place": "日本東京",
              "language": "日文",
              "extent": "全12卷",
              "intro": "池田大作以小說體記述創價學會第二代會長戶田城聖重建教團的歷程，並闡發「一人的人間革命可轉變全人類命運」的核心理念。此書是創價學會會員的必讀文本，也是理解日蓮系佛教如何在戰後轉化為龐大現代宗教社會運動的關鍵材料。"
            },
            {
              "title_zh": "黑麋鹿如是說",
              "title_orig": "Black Elk Speaks",
              "author": "黑麋鹿（Nicholas Black Elk）口述、約翰‧G‧內哈特（John G. Neihardt）筆錄",
              "era": "1932",
              "place": "美國南達科他州派恩里奇保留地（曼德森）",
              "language": "英文",
              "extent": "單卷（1932 年 William Morrow 初版，紐約）",
              "intro": "蘇族聖者口述生命史；其晚年天主教要理員身分使本書成為原住民靈性與基督教相遇的經典難題。"
            },
            {
              "title_zh": "上帝是紅色的",
              "title_orig": "God Is Red",
              "author": "小凡恩‧德洛里亞",
              "era": "1973",
              "place": "美國紐約",
              "language": "英文",
              "extent": "單卷",
              "intro": "德洛里亞以美洲原住民立場對基督教提出系統批判，主張基督教的線性時間觀與對土地的工具化，正是生態破壞與文化滅絕的根源；原住民宗教則以空間與土地為神聖的中心。此書是原住民神學的奠基之作，迫使北美基督教正視其殖民共謀。"
            },
            {
              "title_zh": "奇蹟課程",
              "title_orig": "A Course in Miracles",
              "author": "海倫‧舒克曼（Helen Schucman）筆錄，威廉‧塞特福（William Thetford）謄錄",
              "era": "1965–1972 筆錄；1975 年小量試印本、1976 年 Foundation for Inner Peace 正式出版",
              "place": "美國紐約",
              "language": "英文",
              "extent": "全3部（正文‧練習手冊‧教師指南）",
              "intro": "舒克曼以「內在聽寫」方式記錄成書的靈性教程，借用大量基督教語彙（聖靈、救贖、寬恕）卻徹底重解之：世界是幻相，救恩在於以寬恕消解小我的投射。此書是新時代運動最重要的教典之一，也是研究基督教語彙如何被挪用重構的典型案例。"
            },
            {
              "title_zh": "新世紀運動文獻",
              "title_orig": "New Age Movement Writings",
              "author": "佚名（多人）",
              "era": "1970年代以降",
              "place": "歐美",
              "language": "英文",
              "intro": "新世紀運動是二十世紀後期興起的鬆散靈性潮流,雜糅東方神祕主義、神智學、心理學與基督教元素,強調個人靈性覺醒、宇宙意識與身心整全。其文獻多元而無統一教義,共通點在於對建制宗教的疏離與對自我神性的肯定。此一運動反映現代世俗社會中靈性需求的轉向,是當代宗教光譜中重要的非建制現象。"
            },
            {
              "title_zh": "原理講論",
              "title_orig": "원리강론",
              ...
              "place": "韓國",
              "language": "韓文",
              "intro": "統一教的根本教典,由教主文鮮明的啟示整理而成。書中以「創造原理」「墮落論」「復歸原理」重述聖經史,主張耶穌的使命因被釘十架而未竟,須由再臨的「彌賽亞」完成肉身與屬靈的雙重救贖、建立理想家庭。其義理大幅改寫正統基督教教義,自成體系。此書是理解統一教世界觀與其爭議性的核心文獻。"
            },
            {
              "title_zh": "拉斯塔法里神學文獻",
              "title_orig": "Rastafari Theology Writings",
              "author": "佚名（多人）",
              "era": "1930年代以降",
              "place": "牙買加",
              "language": "英文",
              "intro": "拉斯塔法里運動發源於一九三〇年代的牙買加,尊衣索比亞皇帝海爾‧塞拉西一世為再臨的彌賽亞「賈」(Jah)的化身,融會聖經、非洲認同與反殖民意識。其神學以「巴比倫」象徵壓迫體制,以「錫安」象徵非洲歸回,強調黑人尊嚴與屬靈解放。此一文獻群是現代以聖經元素重構的黑人本土宗教運動的代表。"
            }
          ]
        },
        {
          "key": "secular-critique",
          "label": "西方宗教世俗解釋與新無神論部",
          "label_en": "Secular Interpretation of Religion & New Atheism",
          "desc": "涂爾幹、韋伯、佛洛伊德、伊利亞德等對宗教的社會學、心理學與現象學化約，存在主義的拒絕，及新無神論論戰。",
          "works": [
            {
              "title_zh": "宗教社會學論文集",
              "title_orig": "Gesammelte Aufsätze zur Religionssoziologie",
              "author": "馬克斯‧韋伯",
              "era": "1920–1921",
              "place": "德國圖賓根",
              "language": "德文",
              "extent": "三卷本合集",
              "intro": "收《新教倫理》與《世界宗教的經濟倫理》系列及〈中間考察〉，追問西方何以走出理性化道路。"
            },
            {
              "title_zh": "禮物：古式社會中交換的形式與理由（論禮物）",
              "title_orig": "Essai sur le don. Forme et raison de l'échange dans les sociétés archaïques",
              "author": "馬塞爾‧牟斯（Marcel Mauss）",
              "era": "1925（原刊《社會學年鑑》新輯第一卷，1923–1924 年卷，1925 年出版）",
              "place": "法國巴黎",
              "language": "法文",
              "intro": "給予—接受—回報三重義務構成全面性給付制度；影響對獻祭、聖餐與恩典的人類學解讀。"
            },
            {
              "title_zh": "一個幻覺的未來",
              "title_orig": "Die Zukunft einer Illusion",
              "author": "西格蒙德‧佛洛伊德",
              "era": "1927",
              "place": "奧地利維也納",
              "language": "德文",
              "intro": "佛洛伊德以精神分析論證宗教是人類面對自然無助感所產生的集體幻覺——上帝是被投射放大的父親形象，宗教教義的力量來自願望而非證據。他預言宗教終將被科學取代。此書是二十世紀對宗教最具影響力的心理學化約，基督教護教學至今仍須回應。"
            },
            {
              "title_zh": "摩西其人與一神教",
              "title_orig": "Der Mann Moses und die monotheistische Religion",
              "author": "西格蒙德‧佛洛伊德",
              "era": "1934–1939（前兩篇 1937 刊於《Imago》，全書 1939 出版）",
              "place": "維也納／倫敦（撰寫）；阿姆斯特丹（1939 初版，Verlag Allert de Lange）",
              "language": "德文",
              "intro": "佛洛伊德晚年爭議之作，主張摩西實為埃及人、承繼阿頓一神教，後遭以色列人殺害，其記憶的壓抑與回返造就了猶太教的罪責結構與一神信仰。此書把精神分析用於宗教起源的重建，史學上多不獲採信，卻是宗教心理學與集體創傷理論的重要文本。"
            },
            {
              "title_zh": "精神分析與宗教",
              "title_orig": "Psychoanalysis and Religion",
              "author": "埃里希‧佛洛姆",
              "era": "1950",
              "place": "美國紐哈芬",
              "language": "英文",
              "intro": "佛洛姆修正佛洛伊德對宗教的全盤否定，區分「權威主義的宗教」（要求順服、貶低人）與「人本主義的宗教」（促成人的自我實現），主張精神分析的目標與後者一致。此書為宗教心理學開闢了非化約的路徑，深受自由派基督教與存在主義神學重視。"
            },
            {
              "title_zh": "聖與俗：宗教的本質",
              "title_orig": "Das Heilige und das Profane: Vom Wesen des Religiösen（1957 德文首版）／Le sacré et le profane（1965 法文版, Gallimard）",
              "author": "米爾恰‧伊利亞德",
              "era": "1957（德文首版）",
              "place": "德國漢堡（德文首版）／法國",
              "language": "德文／法文",
              "intro": "伊利亞德闡述其宗教學核心範疇：宗教人（homo religiosus）藉「神顯」（hierophany）把空間與時間區分為神聖與世俗，藉神話與儀式回到原初時刻。他主張現代世俗人仍保留這些結構的偽裝形式。此書是宗教現象學最廣為流傳的入門經典。"
            },
            {
              "title_zh": "薩滿教：古老的入迷術",
              "title_orig": "Le chamanisme et les techniques archaïques de l'extase",
              "author": "米爾恰‧伊利亞德",
              "era": "1951",
              "place": "法國巴黎",
              "language": "法文",
              "intro": "伊利亞德跨文化梳理薩滿的入會、出神、靈魂飛升與宇宙軸象徵，主張薩滿教是一種古老而普遍的「入迷技術」而非精神病理。此書確立薩滿研究的學術地位，也深刻影響了西方新靈性運動對原始宗教的想像與挪用。"
            },
            {
              "title_zh": "暴力與神聖",
              "title_orig": "La violence et le sacré",
              "author": "勒內‧吉拉爾",
              "era": "1972",
              "place": "法國巴黎",
              "language": "法文",
              "intro": "吉拉爾提出「模仿慾望—替罪羊機制」理論，主張古代宗教的獻祭是把群體暴力導向single受害者以恢復秩序，神聖起源於被神化的受害者。他其後主張福音書獨特之處在於揭穿而非重演此機制。此書是二十世紀宗教理論最具原創性的貢獻之一，與基督教救贖論深度糾纏。"
            },
            {
              "title_zh": "看不見的宗教",
              "title_orig": "The Invisible Religion",
              "author": "托馬斯‧盧克曼",
              "era": "1963 德文原著《Das Problem der Religion in der modernen Gesellschaft》／1967 英文擴充版《The Invisible Religion: The Problem of Religion in Modern Society》",
              "place": "德國（原著出版）／美國（英文擴充版出版）；作者生於斯洛維尼亞、奧地利籍",
              "language": "德文、英文",
              "intro": "盧克曼主張現代社會中宗教並未消失，而是從教會制度轉入私人領域，成為個人自行拼裝的「看不見的宗教」——關於自我實現與人生意義的私密體系。此書預告了當代「靈性而非宗教」的現象，是世俗化論辯中最具前瞻性的修正意見。"
            },
            {
              "title_zh": "薛西弗斯的神話",
              ...
              "place": "法國巴黎",
              "language": "法語",
              "intro": "卡繆從「荒謬」——人對意義的渴求與宇宙沉默之間的斷裂——出發，拒斥自殺與「哲學的自殺」（訴諸宗教的飛躍），主張人應在清醒的反抗中承擔荒謬，想像薛西弗斯是幸福的。此書是無神論存在主義對基督教信仰之躍的正面拒絕，其倫理姿態深受神學家重視。"
            },
            {
              "title_zh": "存在與虛無",
              "title_orig": "L'Être et le Néant",
              "author": "沙特",
              "era": "1943",
              "place": "法國巴黎",
              "language": "法語",
              "intro": "沙特的哲學主著，以「存在先於本質」論證人被判定為自由、無任何既定人性或神聖目的可依託，上帝的概念（自因存有）自相矛盾故不可能。他據此主張一切逃避自由的信仰皆是「自欺」。此書是二十世紀無神論人本主義最系統的哲學陳述。"
            },
            {
              "title_zh": "上帝沒什麼了不起",
              "title_orig": "God Is Not Great",
              "author": "克里斯多福‧希鈞斯",
              "era": "2007",
              "place": "美國紐約",
              "language": "英語",
              "intro": "希鈞斯的新無神論代表作，主張宗教是人類蒙昧時期的產物，不僅在知識上錯誤，更在道德上有害——它毒害一切。他遍舉各大宗教的暴力與壓迫紀錄，並嘲諷神學的辯解。此書與道金斯《上帝錯覺》同為二十一世紀初新無神論浪潮的旗艦作品。"
            },
            {
              "title_zh": "信仰的終結",
              "title_orig": "The End of Faith",
              "author": "山姆‧哈里斯",
              "era": "2004",
              "place": "美國紐約",
              "language": "英語",
              "intro": "哈里斯在九一一之後寫成的新無神論宣言，主張宗教信仰因其不受證據約束的本質而必然滋生暴力，溫和派信仰則為極端主義提供了掩護。他呼籲以理性與世俗倫理取代宗教。此書開啟了新無神論運動，也迫使基督教重新思考信仰與暴力的關聯。"
            },
            {
              "title_zh": "文明及其不滿",
              "title_orig": "Das Unbehagen in der Kultur",
              "author": "西格蒙德‧佛洛伊德",
              "era": "1930",
              "place": "奧地利維也納",
              "language": "德文",
              "intro": "佛洛伊德晚年的文明論，主張文明以壓抑本能為代價換取秩序，宗教則是為緩解此不滿而生的集體幻覺與「群體妄想」。他評「愛人如己」的誡命違反人性現實。此書把宗教批判擴展為整體的文明診斷，是二十世紀最具影響力的宗教與文化批判文本之一。"
            },
            {
              "title_zh": "儀式過程：結構與反結構",
              "title_orig": "The Ritual Process: Structure and Anti-Structure",
              "author": "維克多‧特納",
              "era": "1969",
              "place": "美國（田野於尚比亞恩登布人）",
              "language": "英文",
              "intro": "特納由非洲恩登布人的儀式研究提出「閾限」（liminality）與「交融」（communitas）概念，主張儀式的過渡階段暫時消解社會結構，生成平等而直接的人際連結。此書深刻影響了對朝聖、修道與宗教運動的理解，是宗教人類學最具生產力的理論工具之一。"
            },
            {
              "title_zh": "想像宗教：從巴比倫到瓊斯鎮",
              "title_orig": "Imagining Religion: From Babylon to Jonestown",
              "author": "喬納森‧Z‧史密斯",
              "era": "1982",
              "place": "美國芝加哥（芝加哥大學出版社）",
              "language": "英文",
              "intro": "史密斯論文集，核心主張是「宗教」乃學者為研究之便所建構的範疇——「宗教資料之外別無宗教資料，宗教是學術想像的產物」。他以嚴格的比較方法拆解本質化的宗教定義。此書是宗教學方法論反省的里程碑，迫使學界檢視自身的西方與基督教預設。"
            },
            {
              "title_zh": "超越信仰",
              "title_orig": "Beyond Belief: Essays on Religion in a Post-Traditional World",
              "author": "羅伯特‧貝拉",
              "era": "1970",
              "place": "美國紐約",
              "language": "英文",
              "intro": "貝拉的宗教社會學論文集，收錄影響深遠的〈宗教演化〉與〈美國的公民宗教〉。他主張宗教象徵並非認知命題而是自成一格的實在表述，不可化約為社會功能，並提出現代社會存在超越宗派的「公民宗教」。此書修正了化約論路線，是宗教社會學的重要轉折。"
            },
            {
              "title_zh": "反抗者",
              ...
              "place": "法國巴黎",
              "language": "法語",
              "intro": "卡繆從荒謬轉向「反抗」的倫理學，考察形上反抗與歷史反抗的譜系，批判把反抗推向絕對的革命意識形態（含世俗末世論）如何轉為新的暴政。他主張真正的反抗須守住限度與對他人的團結。此書是無神論人本主義最成熟的倫理陳述，並與基督教救贖史觀正面交鋒。"
            },
            {
              "title_zh": "破除魔咒",
              "title_orig": "Breaking the Spell: Religion as a Natural Phenomenon",
              "author": "丹尼爾‧丹尼特",
              "era": "2006",
              "place": "美國紐約",
              "language": "英語",
              "intro": "丹尼特主張宗教應被當作一種自然現象接受科學研究，以演化論與迷因理論解釋宗教信念何以廣泛傳播並持存。他呼籲打破「宗教不可被檢驗」的禁忌。此書是新無神論陣營中最偏向學術論證的一部，開啟了宗教認知科學的公共討論。"
            },
            {
              "title_zh": "基督教中的無神論",
              "title_orig": "Atheismus im Christentum",
              "author": "恩斯特‧布洛赫",
              "era": "1968",
              "place": "德國法蘭克福",
              "language": "德語",
              "intro": "布洛赫以馬克思主義的希望哲學重讀聖經，主張聖經中蘊含一條由出埃及與先知傳統而來的反抗潛流——「唯有無神論者才是好基督徒，唯有基督徒才是好無神論者」。他把上帝解讀為尚未實現的人類未來。此書深刻影響了莫特曼的希望神學與拉美解放神學。"
            },
            {
              "title_zh": "我為甚麼不是基督徒",
              "title_orig": "Why I Am Not a Christian",
              "author": "羅素（Bertrand Russell）",
              "era": "1927",
              "place": "英國",
              "language": "英文",
              "intro": "羅素以分析哲學家的明晰,逐一駁斥上帝存在的傳統論證,並批判基督教在歷史上助長恐懼、壓制理性與道德進步。他主張倫理應奠基於人類福祉而非神聖權威,人當以勇氣與理智面對無神的宇宙。此講演結集是二十世紀理性無神論最廣為流傳的通俗宣言,代表科學理性主義對宗教的世俗化挑戰。"
            },
            {
              "title_zh": "上帝錯覺",
              "title_orig": "The God Delusion",
              "author": "道金斯（Richard Dawkins）",
              "era": "2006",
              "place": "英國",
              "language": "英文",
              "intro": "演化生物學家道金斯的暢銷之作,新無神論運動的旗艦。他主張有神論是站不住腳的科學假設,宗教信仰是未經檢證的迷思,且常為暴力與蒙昧張本。他以演化論解釋宗教的起源,呼籲以科學世界觀取代信仰。此書引爆二十一世紀初的有神/無神論大辯,是當代世俗批判最具影響力與爭議的代表作。"
            }
          ]
        },
        {
          ...
          "desc": "主張諸宗教皆為終極實在之不同回應的多元論主張。",
          "works": [
            {
              "title_zh": "宗教多元論",
              "title_orig": "An Interpretation of Religion",
              "author": "希克（John Hick）",
              "era": "1989",
              "place": "英國",
              "language": "英文",
              "intro": "希克是宗教多元論最系統的倡導者。他主張各大宗教都是人類對同一「終極實在」的不同文化回應,如同盲人摸象,沒有一個傳統可獨佔真理。他呼籲基督論從「上帝道成肉身」轉向隱喻式理解,使基督教放棄獨一救恩的宣稱。此書以康德的現象/本體之分為架構,是宗教神學中多元論立場的奠基之作,激起與排他論、兼容論的長久論辯。"
            }
          ]
        }
      ]
    ...
    divisions: [
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '先知哈里斯：西非的「黑色以利亞」', title_orig: 'Prophet Harris, the \'Black Elijah\' of West Africa', author: 'David A. Shank（默里縮編）', era: '1994年', place: '賴比瑞亞／西非', language: '英文', intro: '尚克數十年田野調查成果，深入描繪哈里斯的神學觀、先知身份認同及其在賴比瑞亞至科特迪瓦的廣大復興影響，為最完整的哈里斯傳記。' },
  ...
  wai: {
    summary: '外編收巴哈伊信仰第一世紀的內部權威史著，以及甘地以真理與非暴力為軸的自傳章目，呈現現代基督教之外兩種重要宗教歷史自述。',
    divisions: [
      {
        key: 'bahai-history',
        label: '巴哈伊史部',
        label_en: 'Bahá’í History',
        desc: '巴哈伊權威作者對信仰第一世紀所作的歷史回顧。',
        works: [GOD_PASSES_BY],
      },
      {
        key: 'gandhi-autobiography',
        label: '真理實驗自傳部',
        label_en: 'Autobiography of Experiments with Truth',
        desc: '甘地以跨宗教倫理、真理與非暴力為軸的固定自傳章目。',
        works: GANDHI_AUTOBIOGRAPHY_CHAPTERS,
      }
    ]
  }
},
    ...
    divisions: [
...

      {
        ...
        works: [
          ...
          { title_zh: '死海古卷聖經英譯', title_orig: 'The Dead Sea Scrolls Bible', author: '阿貝格、弗林特與烏爾里希', era: '1999', place: '聖地牙哥', language: '英文', intro: '首部按古卷文本譯出的英文舊約，逐卷標示與馬所拉的出入。古卷文本學走向普及讀者的里程碑，「最古的聖經」的直接閱讀通道。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '史瓦希里合一譯本', title_orig: 'Swahili Union Version', author: '東非聖經公會譯經團', era: '1952', place: '奈洛比／達累斯薩拉姆', language: '史瓦希里文', intro: '整合桑吉巴與內陸譯本傳統的史瓦希裡語聯合聖經。東非通用語的標準聖經，克拉普夫百年志業的成全之卷。' },
    ...
    divisions: [
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '保祿六世與拉姆齊共同宣言', title_orig: 'Common Declaration of Paul VI and Michael Ramsey', author: '保祿六世與坎特伯里大主教拉姆齊', era: '1966', place: '羅馬', language: '英文', intro: '宗教改革後坎特伯里大主教首度正式訪問教宗，共同宣言啟動聖公宗-天主教對話（ARCIC）。教宗以自己的主教戒指相贈，四百年隔絕破冰的儀式性文本。' },
          ...
          { title_zh: '韋爾比與方濟各共同宣言', title_orig: 'Common Declaration of Pope Francis and Archbishop Justin Welby', author: '方濟各與坎特伯里大主教韋爾比', era: '2016', place: '羅馬', language: '英文', intro: '紀念教宗與坎特伯里對話五十年的共同宣言，坦承按立女性與性倫理的新分歧，仍差遣聖公會與天主教主教兩兩結伴出行宣教。「分歧中同行」模式的當代文本。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '貝里根獄中書信', title_orig: 'Prison Letters of Daniel Berrigan', author: '丹尼爾‧貝里根', era: '1968–1972', place: '丹伯里聯邦監獄', language: '英文', intro: '耶穌會詩人貝里根因焚毀徵兵檔案入獄的書信與詩文，把反越戰的公民不服從寫成十字架的門徒操練。「凱頓斯維爾九人」的精神文本，美國天主教和平主義的代表文獻。' },
          ...
          { title_zh: '生存的習慣', title_orig: 'The Habit of Being', author: '弗蘭納里‧奧康納', era: '1948–1964（1979 刊）', place: '喬治亞米利奇維爾', language: '英文', intro: '奧康納與友人編輯的千封書信，紅斑狼瘡陰影下談寫作、孔雀與聖體，「若聖體只是象徵，就讓它見鬼去」。美國文學最鋒利的天主教心靈自畫像，書信文學的當代經典。' },
          ...
          { title_zh: '薛華書信集', title_orig: 'Letters of Francis A. Schaeffer', author: '法蘭西斯‧薛華', era: '1948–1984', place: '瑞士拉布里', language: '英文', intro: '拉布裡團契創辦人薛華答問尋道者的書信選，存在疑惑、婚姻與文化議題逐一懇談。福音派文化護教運動的私人面向，「誠實的答案給誠實的問題」的書信實踐。' },
    ...
    divisions: [
      {
        ...
        works: [
          { title_zh: '禮儀年', title_orig: 'Das Jahr des Heiles / The Church\'s Year of Grace', author: '加比尼‧瑪利亞‧拉特曼(Pius Parsch)', era: '1923–1934', place: '奧地利‧克洛斯特新堡', language: '德文', intro: '克洛斯特新堡奧思定詠禮會士帕施（Pius Parsch）所編的禮儀年釋義鉅著，逐主日逐瞻禮疏解彌撒經文與日課，把學院化的禮儀學帶進堂區信眾。帕施與本篤會學者並列為二十世紀「禮儀運動」（Liturgical Movement）的奠基者，主張「彌撒是信眾的公共行動」而非神父獨演。此書以牧靈語言貫通聖經、教父與禮儀文本，深刻影響了梵二前的崇拜更新，被視為後來《禮儀憲章》強調「信眾完整、主動、有意識參與」的先聲。' },
          ...
          { title_zh: '禮儀的形成', title_orig: 'The Shape of the Liturgy', author: '格雷戈里‧迪克斯', era: '1945', place: '納什多姆修道院', language: '英文', intro: '聖公會本篤會士迪克斯提出感恩禮的「四重動作」——拿起、祝謝、擘開、分給——為跨宗派禮儀修訂共同採納。名段「自那夜以來，人們何曾停止行此禮」傳誦不絕，英語禮儀學最有影響的一部書。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '庫蒂里耶合一祈禱文獻', title_orig: 'Écrits sur l\'œcuménisme spirituel (Paul Couturier)', author: '保羅‧庫蒂里耶', era: '1935–1953', place: '里昂', language: '法文', intro: '里昂司鐸庫蒂里耶把合一祈禱週改造為「照基督所願的合一」共同祈求，使各宗派得以無保留同禱，並倡「看不見的修道院」屬靈網絡。他被尊為屬靈合一運動之父，這批文獻是合一靈修的憲章。' },
          ...
          { title_zh: '天路客的行囊', title_orig: 'A Long Obedience in the Same Direction', author: '尤金‧畢德生', era: '1980', place: '馬里蘭', language: '英文', intro: '畢德生以上行之詩十五篇對治「即食文化」的靈性浮躁，題句借尼采語「在同一方向上恆久的順服」。本書確立其牧養靈修學的聲音，緩慢、在地、一生之久的門徒之路自此成為當代靈修的關鍵語彙。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '基督徒合一祈禱週禮文', title_orig: 'Week of Prayer for Christian Unity Services', author: '信仰與教制委員會／宗座合一委員會合編', era: '1908 創始，1966 起合編', place: '日內瓦／羅馬', language: '多語', intro: '每年一月十八至廿五日全球教會共用的合一祈禱禮文，自聖公會華生創始，經庫蒂里耶轉化，至天主教與世界教協共同編訂。它是分裂教會每年一度的共同呼吸，普世運動最持久的祈禱建制。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '伯沙撒王的盛宴', title_orig: 'Belshazzar\'s Feast', author: '威廉‧沃爾頓', era: '1931', place: '里茲音樂節', language: '英文', intro: '沃爾頓以但以理書的宮牆文字譜成的合唱神劇，爵士節奏與雙銅管隊轟然並進，首演即震動英倫。座堂一度以其「野蠻」拒演，終成英語合唱曲目的支柱，聖經敘事音樂的現代爆發。' },
          ...
          { title_zh: '合唱協奏曲', title_orig: 'Концерт для хора (Schnittke)', author: '阿爾弗雷德‧施尼特凱', era: '1985', place: '莫斯科', language: '俄文', intro: '施尼特凱取亞美尼亞聖者納雷克的格里高爾《哀歌之書》俄譯為詞的無伴奏合唱協奏曲，於無神論蘇聯公然詠唱千年懺悔詩。俄國合唱傳統與中世紀亞美尼亞靈魂的相遇，晚期蘇聯宗教復甦的音樂事件。' },
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '智血', title_orig: 'Wise Blood', author: '弗蘭納里‧奧康納', era: '1952', place: '喬治亞州', language: '英文', intro: '退伍青年黑茲爾創立「沒有基督的教會」沿街佈道，愈逃離愈被恩典追獵，終以自瞎苦行收場。奧康納自言為「基督縈繞的南方」作傳，怪誕哥德筆法下的severe mercy，美國天主教文學的利刃。' },
          ...
          { title_zh: '教堂尖塔', title_orig: 'The Spire', author: '威廉‧戈爾丁', era: '1964', place: '索爾茲伯里', language: '英文', intro: '諾貝爾獎得主戈爾丁寫中世紀座堂主任喬斯林不顧地基執意加建尖塔，異象與傲慢、獻身與情慾在塔身升高中糾纏崩解。信仰心理的哥德式解剖，英語現代小說中最陡峭的宗教寓言。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '祂看顧麻雀', title_orig: 'His Eye Is on the Sparrow', author: '西維拉‧馬丁詞、查爾斯‧加布里埃爾曲', era: '1905', place: '紐約', language: '英文', intro: '馬丁夫人探望臥病友人聞「祂既看顧麻雀，必然看顧我」而成此歌，經黑人教會與埃塞爾‧沃特斯的演唱成為靈魂樂級的信心頌。女性創作、黑人聲音發揚的福音金曲，苦難中盼望的世紀旋律。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '時禱書', title_orig: 'Das Stunden-Buch', author: '萊納‧瑪利亞‧里爾克', era: '1905', place: '巴黎／俄羅斯行旅', language: '德文', intro: '里爾克託體為俄國修士向「鄰人上帝」的三卷禱告詩，「我繞著上帝、繞著古塔盤旋千年」。承俄羅斯朝聖經驗的神秘詩學，雖溢出教義而滋養無數尋道者，現代德語宗教抒情的起點。' },
          ...
          { title_zh: '安息日詩集', title_orig: 'Sabbaths', author: '溫德爾‧貝里', era: '1979 起', place: '肯塔基農場', language: '英文', intro: '農夫作家貝里數十年間每主日獨行林間所得的安息日詩，土地、勞動與復活的盼望循環如四季。農耕靈性與創造神學的詩化實踐，美國生態信仰書寫的長河之作。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '亞穆蘇克羅和平之後大殿', title_orig: 'Basilique Notre-Dame de la Paix', author: '皮埃爾‧法克胡里（烏弗埃-博瓦尼總統委建）', era: '1985–1989', place: '象牙海岸亞穆蘇克羅', language: '建築（西非）', intro: '象牙海岸總統在故鄉叢林邊緣建成超越聖彼得的世界最大教堂，穹頂彩窗中總統本人隨東方博士朝聖。後殖民非洲的信仰、權力與奢侈之辯全聚於此，二十世紀最具爭議的宗教建築。' },
    ...
    divisions: [
      {
        ...
        works: [
          ...
          { title_zh: '布特里克講道學講座', title_orig: 'Homiletic: Moves and Structures', author: '大衛‧布特里克', era: '1987', place: '納什維爾範德堡大學', language: '英文', intro: '布特里克以「語言如何在群體意識中成形」為起點，將講道分解為連續的「語步」（moves），建構現象學取向的講道學體系。全書體大思精，是二十世紀末講道理論最具野心的綜合，與新講道學諸家共同改寫了講壇的文法。' },
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '如疾風烈火：印尼復興紀實', title_orig: 'Like a Mighty Wind', author: '梅爾‧塔里', era: '1971', place: '印尼帝汶', language: '英文（印尼見證）', intro: '印尼帝汶青年塔里親歷一九六五年後印尼大復興的見證錄：赤足佈道隊深入村落，伴隨認罪、醫治與異象，數十萬穆斯林與泛靈信仰者歸信。本書風行世界而也引發查證爭論，是東南亞本土復興運動最廣為人知的第一身敘述。' },
  ...
  zheng: {
    ...
    divisions: [
          ...
          { title_zh: '基督教考古與禮儀辭典', title_orig: 'Dictionnaire d\'archéologie chrétienne et de liturgie (DACL)', author: '卡布羅爾與勒克萊爾（主編）', era: '1907–1953', place: '巴黎', language: '法文', intro: '本篤會學者主編的基督教考古與禮儀十五巨冊辭典，銘文器物與禮文並考。早期教會物質文化的總帳，禮儀學與考古學交會的世紀工程。' },
          { title_zh: '天主教神學大辭典', title_orig: 'Dictionnaire de théologie catholique (DTC)', author: '瓦康、曼熱諾與阿曼（主編）', era: '1899–1950', place: '巴黎', language: '法文', intro: '法語天主教神學的十五巨冊大辭典，教義史條目至今被徵引不衰。新士林學術的紀念碑，二十世紀前半神學研究的第一參考。' },
          { title_zh: '教會史地大辭典', title_orig: 'Dictionnaire d\'histoire et de géographie ecclésiastiques (DHGE)', author: '博德里亞爾發起', era: '1912 起', place: '巴黎', language: '法文', intro: '按字母收錄教區、修院與教會人物的巨型辭典，百年續編仍未過半字母。教會史微觀資料的最大礦脈，永遠未完的辭典工程之最。' },
          { title_zh: '牛津拜占庭辭典', title_orig: 'The Oxford Dictionary of Byzantium (ODB)', author: '卡日丹（主編）', era: '1991', place: '牛津／敦巴頓橡樹園', language: '英文', intro: '卡日丹主持的拜占庭研究三卷辭典，政教藝術社會五千條目。拜占庭學的標準入口，本藏拜占庭諸條目的通用參考。' },
          { title_zh: '科普特百科全書', title_orig: 'The Coptic Encyclopedia', author: '阿提亞（主編）', era: '1991', place: '紐約', language: '英文', intro: '科普特史地人物語文的八卷百科，克萊蒙特續建數位增訂版。科普特研究的總門戶，埃及基督教千年知識的系統集成。' },
          { title_zh: '敘利亞遺產百科辭典', title_orig: 'Gorgias Encyclopedic Dictionary of the Syriac Heritage (GEDSH)', author: '布羅克等（主編）', era: '2011', place: '皮斯卡塔韋', language: '英文', intro: '布羅克領銜的敘利亞傳統單卷百科，人物寫本教派地名千條。敘利亞學半世紀復興的結晶，本藏敘利亞條目考訂的案頭標準。' },
          { title_zh: '非洲基督教傳記辭典', title_orig: 'Dictionary of African Christian Biography (DACB)', author: '桑內與沃爾斯發起', era: '1995 起（線上）', place: '波士頓／阿克拉', language: '英文（多語）', intro: '收錄非洲信仰人物數千條的開放線上辭典，非洲學者為主要撰者。「非洲教會史由非洲人書寫」的建制實踐，世界基督教研究的南方檔案。' },
          { title_zh: '世界基督教百科全書', title_orig: 'World Christian Encyclopedia', author: '大衛‧巴雷特（主編）', era: '1982（歷版增訂）', place: '奈洛比／牛津', language: '英文', intro: '巴雷特窮廿年統計全球每一宗派教會的巨型百科，首版即震動學界與宣教界。宗教人口統計學的奠基之作，「全球基督教」論述的數據母庫。' },
          { title_zh: '新聖經辭典', title_orig: 'New Bible Dictionary (IVP)', author: '道格拉斯等（主編）', era: '1962（歷版修訂）', place: '萊斯特', language: '英文', intro: '福音派學界合力的單卷聖經辭典，考據穩健而立場明晰。英語福音派書房的標準配備，中譯本亦為華人神學生通用。' },
          { title_zh: '當代神學辭典', title_orig: '當代神學辭典', author: '楊牧谷（主編）', era: '1997', place: '臺北', language: '中文', intro: '楊牧谷主持中譯增補的雙卷神學辭典，西方條目外增華人神學與處境詞條。華語神學教育廿餘年的通用工具，中文神學語彙的整編里程碑。' },
          { title_zh: '神學辭典（輔仁）', title_orig: '神學辭典（輔仁神學著作編譯會）', author: '輔仁神學著作編譯會', era: '1996（增修再版）', place: '臺北', language: '中文', intro: '臺灣天主教神學界集體編譯的中文神學辭典，梵二後神學語彙的漢語定名庫。華語天主教神學教育的基準工具，兩岸教會通用的術語橋樑。' },
          { title_zh: '教父希臘文辭典', title_orig: 'A Patristic Greek Lexicon (Lampe)', author: '蘭普（主編）', era: '1961', place: '牛津', language: '希臘文／英文', intro: '蘭普主編的教父希臘語辭典，接續 LSJ 而專收教父語彙與神學語義。教父研究的必備座標，希臘神學語言史的總詞庫。' },
          { title_zh: '基督教拉丁語辭典', title_orig: 'Dictionnaire latin-français des auteurs chrétiens (Blaise)', author: '阿爾貝‧布萊斯', era: '1954', place: '斯特拉斯堡', language: '拉丁文／法文', intro: '專收基督教作家拉丁語彙的辭典，補古典辭書之所不載。教父與中世紀拉丁閱讀的隨身工具，基督教拉丁語學的標準參考。' },
          { title_zh: '佩恩‧史密斯敘利亞語辭典', title_orig: 'A Compendious Syriac Dictionary', author: '佩恩‧史密斯父女', era: '1903', place: '牛津', language: '敘利亞文／英文', intro: '佩恩‧史密斯的敘利亞語寶庫辭典由其女瑪格麗特縮編為通用單卷。敘利亞語學習的百年標準，女兒續成父業的辭書佳話。' },
          { title_zh: '克拉姆科普特語辭典', title_orig: 'A Coptic Dictionary (Crum)', author: '沃爾特‧克拉姆', era: '1939', place: '牛津', language: '科普特文／英文', intro: '克拉姆窮卅年輯成的科普特語大辭典，至今無可替代。科普特文獻學的基石工具，拿戈瑪第研究的先決條件。' },
          { title_zh: '新約希臘文文法', title_orig: 'Grammatik des neutestamentlichen Griechisch (Blass-Debrunner-Funk)', author: '布拉斯、德布倫納與芬克', era: '1896 初版（歷版修訂）', place: '哥廷根', language: '德文／英文', intro: '新約希臘語文法的標準參考書，語法條目為註釋書通用引據。「BDF」三字母即新約語法的代名詞，原文釋經的百年基座。' },
          { title_zh: '希伯來文法（GKC）', title_orig: 'Gesenius\' Hebrew Grammar (Kautzsch-Cowley)', author: '格森紐斯（考茨編訂、考利英譯）', era: '1909（英譯 28 版）', place: '牛津', language: '希伯來文／英文', intro: '格森紐斯文法經考茨修訂的英譯定版，舊約語法徵引的標準座標。希伯來語文學的皇家法典，「GKC 節號」通行學界百年。' },
          { title_zh: '牛津聖人辭典', title_orig: 'The Oxford Dictionary of Saints', author: '大衛‧法默', era: '1978（歷版修訂）', place: '牛津', language: '英文', intro: '單卷精審的聖人辭典，逐條考訂史實與崇敬流變。聖人研究的便捷門戶，博蘭德學術的普及化結晶。' },
          { title_zh: '牛津教宗辭典', title_orig: 'The Oxford Dictionary of Popes', author: 'J.N.D.凱利', era: '1986', place: '牛津', language: '英文', intro: '教父學家凱利逐任考述歷代教宗與對立教宗的單卷辭典。教宗史的標準速查，批判嚴謹與可讀性兼備的典範辭書。' },
          { title_zh: '俄羅斯正教百科全書', title_orig: 'Православная энциклопедия', author: '莫斯科宗主教區百科中心', era: '2000 起', place: '莫斯科', language: '俄文', intro: '莫斯科宗主教區主持的正教大百科，已刊七十餘卷仍在續出。後蘇聯正教學術復興的旗艦工程，斯拉夫教會知識的當代總匯。' },
          { title_zh: '中世紀大辭典', title_orig: 'Lexikon des Mittelalters (LexMA)', author: '慕尼黑中世紀辭典編委會', era: '1977–1999', place: '慕尼黑', language: '德文', intro: '中世紀研究的九卷標準辭典，教會條目居半。中世紀學的德語總參考，本藏中代諸條目的學術後盾。' },
          { title_zh: '牛津宗教改革百科', title_orig: 'The Oxford Encyclopedia of the Reformation', author: '希勒布蘭德（主編）', era: '1996', place: '牛津', language: '英文', intro: '宗教改革研究的四卷百科，社會史轉向後的學術總結。改革史條目的當代標準，近代藏書目考訂的常備參考。' },
          { title_zh: '威斯敏斯特禮儀與崇拜辭典', title_orig: 'The New Westminster Dictionary of Liturgy and Worship', author: '戴維斯（主編）', era: '1972（歷版修訂）', place: '倫敦', language: '英文', intro: '跨宗派的禮儀崇拜單卷辭典，禮儀運動成果的辭書化。崇拜學教學的通用工具，本藏禮儀諸條目的檢核參考。' },
          { title_zh: '衣索比亞百科全書', title_orig: 'Encyclopaedia Aethiopica', author: '烏利希（主編）', era: '2003–2014', place: '漢堡／威斯巴登', language: '英文', intro: '衣索比亞與厄利垂亞研究的五卷百科，教會條目為其主脈。衣索比亞基督教文明的學術總圖，吉茲文獻研究的當代門戶。' },
          { title_zh: '基督教大事典', title_orig: 'キリスト教大事典', author: '教文館編委會', era: '1963（增訂版 1988）', place: '東京', language: '日文', intro: '日本教文館編纂的基督教綜合大事典，日本教會史條目尤詳。日語基督教學術的標準辭書，東亞基督教研究的重要參照。' },
          { title_zh: '中世紀拉丁語簡明辭典', title_orig: 'Mediae Latinitatis Lexicon Minus (Niermeyer)', author: '尼爾邁耶', era: '1976', place: '萊頓', language: '拉丁文／英法文', intro: '尼爾邁耶專為史料閱讀編纂的中世紀拉丁單卷辭典，例句皆出文書憲章。杜康熱的案頭替身，中世紀史學生的隨身工具。' },
          { title_zh: '宗教與倫理百科全書', title_orig: 'Encyclopaedia of Religion and Ethics', author: '詹姆斯‧黑斯廷斯（主編）', era: '1908–1926', place: '愛丁堡', language: '英文', intro: '黑斯廷斯動員各國學者編成的十三卷宗教倫理大百科，比較宗教視野收羅全球信仰。二十世紀初宗教學的總集成，伊利亞德百科之前的世界標準。' },
          { title_zh: '牛津晚期古代辭典', title_orig: 'The Oxford Dictionary of Late Antiquity', author: '尼科爾森（主編）', era: '2018', place: '牛津', language: '英文', intro: '首部以晚期古代為斷代的兩卷辭典，羅馬波斯與早期教會條目並收。「晚期古代研究」成學的辭書標誌，本藏古代卷條目的當代參照。' }
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '新教倫理與資本主義精神', title_orig: 'Die protestantische Ethik und der Geist des Kapitalismus', author: '韋伯（Max Weber）', era: '一九〇四–一九〇五年', place: '德國', language: '德文', intro: '社會學古典名著,論證加爾文宗的天職觀與禁慾倫理如何在無意間培育出近代資本主義的理性化精神。韋伯以「理念型」方法將宗教信念與經濟行為相連,開創宗教社會學的核心議題,雖其因果論點後世爭辯不休,仍是科際整合研究宗教與社會關係的奠基文本。' },
          ...
          { title_zh: '宗教經驗之種種', title_orig: 'The Varieties of Religious Experience', author: '威廉‧詹姆斯', era: '1902', place: '愛丁堡（吉福德講座）', language: '英文', intro: '詹姆斯以心理學考察皈依、聖徒性與密契經驗的吉福德講座，以「果實而非根源」評判宗教。宗教心理學的奠基之作，個人宗教經驗研究的永恆起點。' },
          { title_zh: '宗教生活的基本形式', title_orig: 'Les Formes élémentaires de la vie religieuse', author: '埃米爾‧塗爾幹', era: '1912', place: '巴黎', language: '法文', intro: '塗爾幹以澳洲圖騰制論證「神聖／世俗」二分與宗教的社會本質——社會崇拜其自身。宗教社會學的奠基經典，一切宗教功能論的共同祖先。' },
          { title_zh: '宗教現象學', title_orig: 'Phänomenologie der Religion', author: '赫拉爾杜斯‧範德列烏', era: '1933', place: '格羅寧根', language: '德文', intro: '荷蘭學者範德列烏以現象學「懸置」態度分類宗教現象的體系鉅著，力量、形式與人神關係逐層鋪展。宗教現象學派的集大成，宗教學方法論史的必經一站。' },
          { title_zh: '千面英雄', title_orig: 'The Hero with a Thousand Faces', author: '約瑟夫‧坎伯', era: '1949', place: '紐約', language: '英文', intro: '坎伯融榮格心理學與全球神話提出「英雄旅程」單一神話結構，基督生平亦入其環。神話學普及的世紀暢銷書，比較神話與流行文化的橋樑之作。' },
          { title_zh: '宗教的意義與終結', title_orig: 'The Meaning and End of Religion', author: '威爾弗雷德‧坎特威爾‧史密斯', era: '1962', place: '紐約', language: '英文', intro: '史密斯考掘「宗教」概念史，主張以「累積傳統」與「個人信仰」取代物化的 religion 範疇。宗教研究的概念自省之作，比較宗教對話學派的理論基石。' },
          { title_zh: '神聖的帷幕', title_orig: 'The Sacred Canopy', author: '彼得‧伯格', era: '1967', place: '紐約', language: '英文', intro: '伯格以知識社會學論宗教如何為人間秩序架起神聖天幕，並剖析世俗化的侵蝕。世俗化理論的經典表述，作者晚年自承預測落空更添學術史戲劇性。' },
          { title_zh: '潔淨與危險', title_orig: 'Purity and Danger', author: '瑪麗‧道格拉斯', era: '1966', place: '倫敦', language: '英文', intro: '人類學家道格拉斯以「不潔即失序」重讀利未記飲食律與各文化禁忌。潔淨體系研究的轉捩點，聖經律法人類學解讀的開山之作。' },
          { title_zh: '儀式過程', title_orig: 'The Ritual Process', author: '維克多‧特納', era: '1969', place: '芝加哥', language: '英文', intro: '特納以恩登布儀式提出「閾限」與「交融」概念，並延伸解讀朝聖與修道運動。儀式研究的理論引擎，基督教朝聖與禮儀研究的常用透鏡。' },
          { title_zh: '基督教社會思想史', title_orig: 'Die Soziallehren der christlichen Kirchen und Gruppen', author: '恩斯特‧特洛爾奇', era: '1912', place: '圖賓根', language: '德文', intro: '特洛爾奇縱貫兩千年考察教會、教派與密契三型的社會學說鉅著。「教會／教派」類型學的誕生地，宗教社會學與教會史的共同經典。' },
          { title_zh: '宗教觀念史', title_orig: 'Histoire des croyances et des idées religieuses', author: '米爾恰‧伊利亞德', era: '1976–1983', place: '巴黎', language: '法文', intro: '伊利亞德晚年縱寫石器時代至宗教改革的三卷宗教觀念通史。宗教史學派的總結性敘事，比較視野下基督教定位的經典參照。' },
          { title_zh: '中國社會中的宗教', title_orig: 'Religion in Chinese Society', author: '楊慶堃', era: '1961', place: '柏克萊', language: '英文', intro: '楊慶堃以「制度性／彌散性宗教」二分重構中國宗教的社會學全景。中國宗教研究的典範之作，理解基督教入華處境的必備框架。' },
          { title_zh: '德川宗教', title_orig: 'Tokugawa Religion', author: '羅伯特‧貝拉', era: '1957', place: '波士頓', language: '英文', intro: '貝拉以韋伯命題檢視德川日本的心學與商人倫理，探問東亞的「新教倫理」等價物。宗教與現代化研究的經典個案，日本宗教社會學的西方起點。' },
          { title_zh: '基督教的興起', title_orig: 'The Rise of Christianity', author: '羅德尼‧斯塔克', era: '1996', place: '普林斯頓', language: '英文', intro: '社會學家斯塔克以人口模型與網絡理論重算早期教會增長，瘟疫照護與婦女地位為關鍵變項。社會科學重寫教會史的代表作，數據進路的爭議樣本。' },
          { title_zh: '宗教的系譜', title_orig: 'Genealogies of Religion', author: '塔拉勒‧阿薩德', era: '1993', place: '巴爾的摩', language: '英文', intro: '阿薩德追問「宗教」範疇如何由基督教西方建構，並以中世紀修道紀律與世俗主義為個案。後殖民宗教研究的理論支點，學科自我批判的鋒刃。' },
          { title_zh: '人的宗教', title_orig: 'The World\'s Religions (The Religions of Man)', author: '休斯頓‧史密士', era: '1958（修訂 1991）', place: '紐約', language: '英文', intro: '史密士以同情之筆概說七大傳統的世界宗教入門，售逾三百萬冊。半世紀通識課的標準讀本，華語譯本亦廣為流傳的宗教學公共窗口。' },
          { title_zh: '神的歷史', title_orig: 'A History of God', author: '凱倫‧阿姆斯壯', era: '1993', place: '倫敦', language: '英文', intro: '前修女阿姆斯壯縱寫猶太教基督教伊斯蘭四千年的上帝觀念史。宗教公共書寫的暢銷典範，三教一神論比較的普及地圖。' },
          { title_zh: '當科學遇到宗教', title_orig: 'When Science Meets Religion', author: '伊安‧巴伯', era: '2000', place: '舊金山', language: '英文', intro: '物理學家神學家巴伯提出衝突、獨立、對話、整合四模式，為科學與宗教關係定下通用座標。科學與宗教學科的奠基者手筆，坦普頓獎的代表成果。' },
          { title_zh: '世界宗教傳統', title_orig: 'The World\'s Religions (Ninian Smart)', author: '尼尼安‧斯馬特', era: '1989', place: '劍橋', language: '英文', intro: '斯馬特以七向度模型（儀式、神話、教義、倫理、社會、經驗、物質）綜覽世界宗教。宗教研究「向度分析」的定式之作，世俗宗教教育的方法奠基。' },
          { title_zh: '巫術、科學與宗教', title_orig: 'Magic, Science and Religion', author: '布羅尼斯瓦夫‧馬林諾夫斯基', era: '1948（文集）', place: '波士頓', language: '英文', intro: '馬林諾夫斯基以特羅布里恩群島田野論證巫術、科學與宗教各司其職的功能論名篇文集。田野民族誌進入宗教研究的轉捩點，功能學派的代表文獻。' },
          { title_zh: '比較宗教學史', title_orig: 'Comparative Religion: A History', author: '埃里克‧夏普', era: '1975', place: '倫敦', language: '英文', intro: '夏普縱述自繆勒以降宗教學一百年的學科史，各學派得失並陳。宗教研究的自我畫像，方法論課堂的標準讀本。' }
      ...
      },
      {
        ...
        ,
          ...
          { title_zh: '教父聖經引文索引', title_orig: 'Biblia Patristica', author: '斯特拉斯堡教父分析中心', era: '1975–2000（線上版 BiblIndex）', place: '斯特拉斯堡', language: '法文', intro: '逐卷索引教父著作聖經引文的巨型工具，七冊之後轉為線上資料庫。教父釋經研究的座標網格，經文效應史檢索的第一入口。' },
          { title_zh: '教父文獻總目', title_orig: 'Clavis Patrum Graecorum / Clavis Patrum Latinorum', author: '赫拉德與德克斯（編）', era: '1951 起（歷版增訂）', place: '斯滕布魯赫／圖恩豪特', language: '拉丁文', intro: '給每部希臘拉丁教父作品編定唯一號碼並考訂真偽的總目錄。教父學的「編號憲法」，託名文獻甄別的裁判基準，本藏考訂的底層座標。' },
          { title_zh: '聖傳文獻總目', title_orig: 'Bibliotheca Hagiographica Graeca / Latina / Orientalis', author: '博蘭德學社', era: '1898 起（歷版增訂）', place: '布魯塞爾', language: '拉丁文', intro: '博蘭德學社為希臘、拉丁與東方聖人傳記文獻編定的三系總目。聖傳研究的檢索骨架，「BHG／BHL／BHO 號」通行學界的編目標準。' },
          { title_zh: 'ATLA 宗教學術資料庫', title_orig: 'ATLA Religion Database', author: '美國神學圖書館協會', era: '1949 起（數位化）', place: '芝加哥', language: '英文（多語收錄）', intro: '神學圖書館協會累積的宗教學期刊索引資料庫，收錄文獻數百萬條。宗教學術檢索的全球基礎設施，神學研究數位化的中樞。' },
          { title_zh: '聖經歷史地圖集', title_orig: 'The Macmillan Bible Atlas', author: '阿哈羅尼與阿維-約納', era: '1968（歷版修訂）', place: '耶路撒冷／紐約', language: '英文', intro: '以色列考古學家逐事件繪製聖經歷史的二百餘幅地圖集。聖經地理教學的標準掛圖，考古學與地圖學聯姻的典範。' },
          { title_zh: '教父學手冊', title_orig: 'Patrology (Quasten)', author: '約翰內斯‧奎斯騰', era: '1950–1986（第四卷由義大利團隊續成）', place: '烏得勒支／西敏', language: '英文', intro: '逐位教父綜述生平著作神學並附書目的四卷手冊。教父學入門的世界標準，「查奎斯騰」為研究起手式的代名詞。' },
          { title_zh: '基督教藝術圖像學', title_orig: 'Ikonographie der christlichen Kunst', author: '格特魯德‧席勒', era: '1966–1991', place: '居特斯洛', language: '德文', intro: '席勒按主題梳理基督教圖像傳統的多卷圖像學總覽，基督生平至啟示錄逐題溯源。聖藝研究的標準參考，圖像與教義互證的工具化成果。' },
          { title_zh: '坎特伯里聖詩學辭典', title_orig: 'The Canterbury Dictionary of Hymnology', author: '瓦森與霍金斯（主編）', era: '2013（線上）', place: '諾里奇', language: '英文', intro: '接續朱利安百年之後全面重修的線上聖詩學辭典，全球詩歌傳統並收。聖詩研究的當代總匯，辭書由紙本轉生數位的示範。' },
          { title_zh: '基督教宣教傳記辭典', title_orig: 'Biographical Dictionary of Christian Missions', author: '傑拉德‧安德森（主編）', era: '1998', place: '紐約', language: '英文', intro: '收錄兩千四百位宣教人物的傳記辭典，非西方本土同工大量入列。宣教學研究的人物總索引，世界基督教史觀的辭書落實。' },
          { title_zh: '華人基督教史人物辭典', title_orig: 'Biographical Dictionary of Chinese Christianity', author: '李可柔等（主編，線上計畫）', era: '2005 起', place: '線上（美國／香港協作）', language: '中英雙語', intro: '收錄華人教會史人物的雙語線上辭典，本土佈道家與平信徒領袖並錄。華人基督教史的人物資料庫，中文世界教會記憶的數位工程。' },
          { title_zh: '希臘語文獻電子總庫', title_orig: 'Thesaurus Linguae Graecae (TLG)', author: '加州大學爾灣分校（布倫納創始）', era: '1972 起', place: '爾灣', language: '希臘文', intro: '數位化自荷馬至拜占庭滅亡全部希臘文獻的電子總庫，教父著作盡入檢索。古典與教父研究的數位革命起點，語料檢索時代的開山工程。' },
          { title_zh: '梵蒂岡圖書館數位典藏', title_orig: 'DigiVatLib', author: '梵蒂岡宗座圖書館', era: '2010 起', place: '梵蒂岡', language: '多語', intro: '宗座圖書館將八萬餘部寫本高解析上網的數位化工程，梵蒂岡大卷亦全卷公開。寫本研究的民主化里程碑，古抄本從深庫走向人人瀏覽器。' },
          { title_zh: '基督教會文獻選編', title_orig: 'Documents of the Christian Church (Bettenson)', author: '亨利‧貝滕森（編）', era: '1943（歷版增訂）', place: '牛津', language: '英文', intro: '自使徒時代至現代精選教會關鍵文獻的單卷讀本，歷版增補流通八十年。教會史課堂的標準文獻包，一冊在手的原典門徑。' },
          { title_zh: '信理彙編（現代修訂版）', title_orig: 'Enchiridion Symbolorum (Denzinger-Hünermann)', author: '丹青格（徐訥曼修訂）', era: '1991（DH 第 37 版起雙語）', place: '弗萊堡', language: '拉丁文／德文', intro: '丹青格信理彙編經徐訥曼全面修訂的拉丁原文對照版，收梵二與現代文獻並重編號。「DH 號」為教義引據的世界通貨，信理檢索的現行標準。' },
          { title_zh: '歷代信條與信仰告白大全', title_orig: 'Creeds and Confessions of Faith in the Christian Tradition', author: '佩利坎與霍奇森（主編）', era: '2003', place: '紐黑文', language: '英文', intro: '佩利坎晚年主編的三卷信條總集，東西方古今告白並收注釋。沙夫之後百年的信條學總結，比較信條研究的當代基準。' },
          { title_zh: '國際批判注釋叢書', title_orig: 'International Critical Commentary (ICC)', author: '德賴弗、普盧默與布里格斯（創編）', era: '1895 起', place: '愛丁堡', language: '英文', intro: '逐字考據原文的跨宗派批判注釋叢書，百餘年仍在續修新卷。學術聖經注釋的黃金標準，「查 ICC」即窮盡考據的代稱。' },
          { title_zh: '安克爾聖經注釋叢書', title_orig: 'Anchor Bible Commentary Series', author: '奧爾布賴特與弗裡德曼（創編）', era: '1964 起', place: '紐約', language: '英文', intro: '猶太教基督教學者共撰的逐卷注釋叢書，考古語文並重。跨信仰聖經學術的旗艦系列，與其辭典地圖集合組安克爾家族。' },
          { title_zh: '古代基督信仰聖經註釋叢書', title_orig: 'Ancient Christian Commentary on Scripture (ACCS)', author: '託馬斯‧奧登（主編）', era: '1998–2010', place: '唐納斯格羅夫', language: '英文（多語中譯）', intro: '奧登率團隊自教父著作輯出逐節註釋的廿九卷總集，重現「教父讀經」的釋經鏈傳統。古今釋經的橋樑工程，中譯本亦為華語教會重新發現教父的入口。' },
          { title_zh: '新約導論（雷蒙‧布朗）', title_orig: 'An Introduction to the New Testament (Raymond E. Brown)', author: '雷蒙‧布朗', era: '1997', place: '紐約', language: '英文', intro: '天主教聖經學家布朗晚年綜述新約各卷的導論巨冊，學術公允而立場溫和。跨宗派通用的新約教科書，「布朗導論」為一代學生的共同記憶。' },
          { title_zh: 'IVP 聖經神學辭典系列', title_orig: 'IVP Bible Dictionary Series (DJG, DPL, etc.)', author: '格林、霍桑與馬歇爾等（主編）', era: '1992 起', place: '唐納斯格羅夫', language: '英文', intro: '耶穌與福音、保羅書信等分卷專題的「黑皮辭典」系列，福音派學術成熟期的集體成果。新約專題檢索的當代標準，多卷已有中譯。' },
          { title_zh: '北美教會年鑑', title_orig: 'Yearbook of American and Canadian Churches', author: '美國教會聯合會（編）', era: '1916–2012', place: '紐約', language: '英文', intro: '逐年統計北美各宗派會籍財務的教會年鑑，出版近百年。宗派消長的第一手數據序列，美國宗教社會學的基礎史料。' },
          { title_zh: '普世運動文獻史', title_orig: 'A Documentary History of the Ecumenical Movement / The Ecumenical Movement: An Anthology', author: '魯斯與尼爾等（編）', era: '1954 起（歷卷續編）', place: '日內瓦', language: '英文', intro: '普世教會協會系統輯錄合一運動文獻與史述的總集。二十世紀合一史的官方檔案彙編，普世神學研究的文獻基座。' },
          { title_zh: '中國之景教', title_orig: 'The Nestorian Documents and Relics in China', author: '佐伯好郎', era: '1916（增訂 1937）', place: '東京', language: '英文／日文', intro: '佐伯好郎彙集景教碑文與敦煌文獻並考釋英譯的景教研究總集。景教學的奠基文獻彙編，東亞學者主導早期漢語基督教研究的標誌。' },
          { title_zh: '證主聖經百科全書', title_orig: '證主聖經百科全書', author: '福音證主協會（編譯）', era: '1995', place: '香港', language: '中文', intro: '以英語聖經百科為底全面編譯增補的三卷中文百科，條目圖版並茂。華語教會通行的聖經百科，中文查經工具的代表工程。' },
          { title_zh: '教會史話', title_orig: '教會史話（賴永祥）', author: '賴永祥', era: '1990–2011（六輯）', place: '臺南', language: '中文', intro: '史學家賴永祥以短篇考據連載臺灣教會人物史事，累積六輯數百篇。臺灣基督教史料學的一人工程，長老教會歷史記憶的檢索寶庫。' },
          { title_zh: '基督教傳統：教義發展史', title_orig: 'The Christian Tradition: A History of the Development of Doctrine', author: '雅羅斯拉夫‧佩利坎', era: '1971–1989', place: '芝加哥', language: '英文', intro: '佩利坎縱寫五卷的教義發展通史，東方傳統罕見地與西方等量齊觀。二十世紀教義史的巔峰綜述，「傳統是死者的活信仰」名句所出。' },
          { title_zh: '劍橋基督教史', title_orig: 'The Cambridge History of Christianity', author: '劍橋大學出版社（多主編）', era: '2005–2009', place: '劍橋', language: '英文', intro: '九卷全球視野的基督教通史，各卷由領域專家集體撰成。世界基督教史的當代標準敘事，本藏史傳條目的學術基準線。' },
          { title_zh: '聖地考古發掘新百科', title_orig: 'The New Encyclopedia of Archaeological Excavations in the Holy Land', author: '以法蓮‧斯特恩（主編）', era: '1993（補卷 2008）', place: '耶路撒冷', language: '英文', intro: '以色列探勘學會按遺址條列聖地百年發掘成果的四卷百科，補卷續收新掘資料。聖經考古一世紀成績的總帳簿，遺址檢索與地層對照的第一參考。' },
          { title_zh: '劍橋聖經史', title_orig: 'The Cambridge History of the Bible', author: '格林斯萊德、蘭普與阿克羅伊德等（主編）', era: '1963–1970', place: '劍橋', language: '英文', intro: '縱寫聖經文本、正典、翻譯與詮釋兩千年流傳史的三卷通史，其後有新劍橋聖經史續修。聖經流傳史的標準敘事，譯本與正典研究的總參考。' }
  ...
  wai: {
    summary: '外藏收入二十世紀初跨宗教、倫理、民俗、哲學與人類學的大型百科條目，以現代比較宗教知識工程與正藏基督教工具書互為對照。',
    divisions: [
      {
        key: 'religion-ethics-encyclopaedia',
        label: '宗教與倫理百科部',
        label_en: 'Encyclopaedia of Religion and Ethics',
        desc: '黑斯廷斯主編跨宗教與倫理知識工程第一卷的固定百科條目。',
        works: ERE_VOLUME_ONE_ARTICLES,
      }
    ]
  }
}
