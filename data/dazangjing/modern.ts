    ...
    divisions: [
      ...
      },
      {
        ...
        works: [
          ...
          { title_zh: '比較宗教學史', title_orig: 'Comparative Religion: A History', author: '埃裡克‧夏普', era: '1975', place: '倫敦', language: '英文', intro: '夏普縱述自繆勒以降宗教學一百年的學科史，各學派得失並陳。宗教研究的自我畫像，方法論課堂的標準讀本。' }
      ...
      },
      {
        ...
        ,
          ...
          { title_zh: '坎特伯裡聖詩學辭典', title_orig: 'The Canterbury Dictionary of Hymnology', author: '瓦森與霍金斯（主編）', era: '2013（線上）', place: '諾裡奇', language: '英文', intro: '接續朱利安百年之後全面重修的線上聖詩學辭典，全球詩歌傳統並收。聖詩研究的當代總匯，辭書由紙本轉生數位的示範。' },
