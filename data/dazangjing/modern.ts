...
export const MODERN_ERA: DazangEra = {
  ...
  glyph: '經',
  genres: '校勘版‧現代譯本‧外經',
  summary: '現代基督教大藏經之經藏，收錄一九〇〇年以降普世合一運動時代精神下的聖經文本：以 Nestle-Aland、UBS、BHS 等現代批判校勘版為骨幹，輔以二十世紀以來各語系現代譯本（中文以和合本至和合本2010、思高、現代中文譯本為主），並收納死海古卷、納戈瑪第文庫的現代刊行成果，以及拉斯塔法里、合一教等現代新興與合成宗教的新啟示經典為外經。',
  portal: { to: '/scripture', label: '前往聖經閱讀器' },
  zheng: {
    summary: '正經部收錄現代學術界與各宗派公認的聖經正典文本，分為現代批判校勘版、現代各語系譯本（以現代中文譯本為主軸）、以及死海古卷與納戈瑪第文庫的現代學術刊行三大支系，呈現一九〇〇年後文本批判學與聖經翻譯運動的集大成。',
    divisions: [
      {
        key: 'critical-editions',
        label: '現代批判校勘版',
        label_en: 'Modern Critical Editions',
        desc: '二十世紀以降以系譜學與折衷法重建的希臘文新約與希伯來聖經學術校勘本，為當代一切聖經翻譯與研究的底本。',
        works: [
          { title_zh: '聶斯特勒—阿蘭希臘文新約', title_orig: 'Novum Testamentum Graece (Nestle-Aland)', author: '聶斯特勒、阿蘭夫婦及聯合聖經公會編委會', era: '1898 初版／第28版 2012', place: '德國明斯特新約文本研究所', language: '古希臘文（科伊內）', intro: '由聶斯特勒於一八九八年創編、後由阿蘭夫婦與明斯特新約文本研究所接續的希臘文新約批判校勘本，現行為第二十八版。其特色在於以折衷法綜合各大抄本家族證據，重建最接近原初的新約文本，並附詳盡的校勘欄（apparatus criticus）列出異文與抄本支持。此版與聯合聖經公會希臘文新約共用文本，成為二十世紀後全球新約學術研究與聖經翻譯的標準底本，深刻形塑普世合一運動時代的聖經理解。' },
          { title_zh: '聯合聖經公會希臘文新約', title_orig: 'The Greek New Testament (UBS)', author: '聯合聖經公會編輯委員會', era: '1966 初版／第5版 2014', place: '德國斯圖加特', language: '古希臘文（科伊內）', intro: '聯合聖經公會為全球聖經翻譯者編纂的希臘文新約校勘本，文本與聶斯特勒—阿蘭版一致，但其校勘欄專為翻譯者設計，集中處理影響翻譯抉擇的重要異文，並以 A 至 D 評級標示文本重建的確定程度。此版伴隨梅茨格的文本註釋本（Textual Commentary），成為現代各語系聖經翻譯（包括現代中文譯本與和合本修訂）共同倚賴的工具，體現了跨宗派合作的普世合一精神。' },
          { title_zh: '斯圖加特希伯來聖經', title_orig: 'Biblia Hebraica Stuttgartensia (BHS)', author: '艾利格、魯道夫等編', era: '1968–1977／修訂 1997', place: '德國斯圖加特', language: '聖經希伯來文、亞蘭文', intro: '以列寧格勒抄本（Codex Leningradensis B19A）為底本的希伯來聖經學術校勘版，由德國聖經公會於一九六八至一九七七年陸續刊行。其完整保留馬所拉註記（Masorah），並以校勘欄列出撒瑪利亞五經、死海古卷、七十士譯本等旁證的異文。BHS 是二十世紀後舊約研究與翻譯的標準希伯來文底本，正由新的希伯來聖經校訂本（BHQ）逐卷接替，見證現代文本批判學的持續深化。' }
        ]
      },
      {
        key: 'modern-versions',
        label: '現代各語系譯本',
        label_en: 'Modern Vernacular Versions',
        desc: '一九〇〇年以降各語系的現代聖經譯本，以現代中文譯本系統為主軸，反映白話化、跨宗派與普世合一的翻譯精神。',
        works: [
          ...
          { title_zh: '和合本修訂版', title_orig: '和合本修訂版', author: '聯合聖經公會修訂委員會', era: '2010', place: '香港', language: '繁體中文', intro: '聯合聖經公會於二〇一〇年完成的和合本修訂版，在保留一九一九年和合本典雅語感的前提下，依據現代批判校勘版底本（UBS/NA）修訂譯文，更新已變遷的詞語、訂正舊譯的文本與用字問題，並改善標點分段。修訂工程歷時近三十年，由華人聖經學者跨宗派協作完成，使百年和合本得以承接現代文本批判學的成果，繼續服事當代華人教會。', link: '/scripture' },
          { title_zh: '思高聖經', title_orig: '思高聖經譯釋本', author: '思高聖經學會（雷永明神父主持）', era: '1968', place: '香港', language: '繁體中文', intro: '思高聖經學會由方濟會雷永明神父創立，於一九六八年出版完整的思高聖經，是天主教會中文聖經的權威譯本。其直接譯自希伯來文、亞蘭文與希臘文原典，包含全部次經（天主教稱「正經」），並附詳盡的引言與註釋。思高本譯名系統嚴謹，成為華語天主教界的標準，也是跨宗派經文對照的重要參照，體現天主教在現代聖經運動中的學術貢獻。', link: '/scripture' },
          { title_zh: '現代中文譯本', title_orig: '現代中文譯本', author: '許牧世、駱維仁等', era: '1979／修訂 1997', place: '香港、台灣', language: '繁體中文', intro: '現代中文譯本由聯合聖經公會委託許牧世、駱維仁等學者依「意義相符、效果相等」（功能對等）原則翻譯，一九七九年出版。其文字淺白通俗，力求讓未受神學訓練的現代讀者與初信者皆能理解，在翻譯理論上代表了二十世紀奈達功能對等學派的應用。此譯本亦是天主教與新教合作的成果之一，反映普世合一運動推動的共同聖經事工。', link: '/scripture' },
          { title_zh: '聖經新譯本', title_orig: '聖經新譯本', author: '中文聖經新譯會', era: '1992', place: '香港', language: '繁體中文', intro: '聖經新譯本由華人聖經學者組成的中文聖經新譯會主持，於一九九二年完成全書，是少數完全由華人學者直接從原文翻譯的現代中文聖經。其譯文在忠實原文與現代語感之間求取平衡，並採用現代批判校勘版為底本，註重神學詞彙的精確。新譯本主要服事華人福音派教會，與和合本、思高本並列為當代重要的中文聖經系統，展現華人教會自主譯經的成熟。', link: '/scripture' }
        ]
      },
      {
        key: 'manuscript-corpora',
        label: '古卷與文庫現代刊行',
        label_en: 'Modern Editions of Manuscript Corpora',
        desc: '二十世紀重大寫本發現經現代學術整理刊行的成果，深刻改寫了對聖經文本與早期猶太教、基督教的理解。',
        works: [
          { title_zh: '死海古卷', title_orig: 'Dead Sea Scrolls / Discoveries in the Judaean Desert', author: '昆蘭國際編輯團隊（DJD 系列）', era: '1947 發現／刊行 1955–2009', place: '猶大曠野昆蘭、耶路撒冷', language: '希伯來文、亞蘭文、希臘文', intro: '死海古卷於一九四七年起在昆蘭一帶陸續出土，是二十世紀最重大的聖經考古發現。其包含公元前三世紀至公元一世紀的希伯來聖經抄本、次經、以及艾賽尼派社群文獻，經由《猶大曠野發現》（DJD）系列數十卷的現代學術刊行而公諸於世。這批寫本將希伯來聖經的文本見證上溯逾千年，印證馬所拉傳統的可靠性並揭示文本的多樣性，成為現代文本批判學不可或缺的基石。' },
          { title_zh: '納戈瑪第文庫', title_orig: 'The Nag Hammadi Library', author: '納戈瑪第文庫國際編委會（羅賓遜主編英譯本）', era: '1945 發現／英譯本刊行 1977', place: '埃及納戈瑪第', language: '科普特文（原）／英文、中文（譯）', intro: '納戈瑪第文庫於一九四五年在埃及上游出土，為一批四世紀的科普特文抄本，收錄逾五十篇諾斯底主義及相關文獻，包括多馬福音、腓力福音、真理福音等。經由羅賓遜主編的英譯本（一九七七）等現代學術刊行，這批一度被視為異端而失傳的文本得以重見天日，徹底改寫了學界對早期基督教多元面貌的認識。本站諾斯底文獻對照即以此文庫的現代刊行為主要來源。' }
        ]
      }
    ]
  },
  ...
  zheng: {
    ...
    divisions: [
      ...
      {
        key: 'discovered-texts',
        label: '出土與比較文獻部',
        label_en: 'Discovered and Comparative Texts',
        desc: '收錄二十世紀重大考古發現的刊行成果，及七十士譯本的現代校訂，為聖經研究提供文本與歷史的比較基礎。',
        works: [
          { title_zh: '猶大曠野發現文獻（死海古卷正式刊行）', title_orig: 'Discoveries in the Judaean Desert (DJD)', author: '國際死海古卷編輯團隊（牛津大學出版社）', era: '1955–2010', place: '英國‧牛津／以色列', language: '希伯來文‧亞蘭文‧希臘文（附英文校註）', intro: '死海古卷的官方刊行叢書，共四十卷，逐一刊布昆蘭洞穴與猶大曠野出土的近千份抄本與殘片，附以照片、轉寫、復原與英文翻譯註解。這批公元前後的猶太抄本是二十世紀最重大的聖經考古發現，將希伯來聖經的可考抄本提前了一千年，徹底改寫了學界對舊約文本傳承、第二聖殿時期猶太教與早期基督教背景的認識。' },
          { title_zh: '納戈瑪第文庫（英譯刊行）', title_orig: 'The Nag Hammadi Library in English', author: '詹姆斯‧羅賓遜主編', era: '1977（修訂版1988）', place: '美國／埃及', language: '英文（譯自科普特文）', intro: '1945年埃及納戈瑪第出土的科普特文抄本集的權威英譯本，收錄逾五十部諾斯底派及相關文獻，包含多馬福音、腓力福音、真理福音等。此批四世紀抄本使學界首次得以直接閱讀諾斯底派自身的文獻，而非僅憑教父的駁斥來認識他們，對早期基督教多元面貌、正典形成史與諾斯底主義研究具有劃時代的意義。' },
          { title_zh: '七十士譯本（哥廷根校訂版）', title_orig: 'Septuaginta (Göttingen Edition)', author: '哥廷根七十士譯本研究院', era: '二十世紀至今陸續出版', place: '德國‧哥廷根', language: '希臘文', intro: '希伯來聖經最早、最重要的古希臘文譯本的現代批判校訂，由哥廷根研究院以譜系方法重建最接近原始譯文的文本，附極詳盡的校勘欄。七十士譯本是新約作者與早期教會所用的聖經，也是研究希伯來文本早期形態的關鍵見證。此校訂工程是現代古典與聖經學術協作的典範，為舊約文本史與早期基督教研究奠定不可或缺的基礎。' }
        ]
      }
    ]
  },
