      ...
      divisions: [
        {
          ...
          works: [
            ...
            { title_zh: '特勒戈努斯', title_orig: 'Τηλεγόνεια / Telegonia', author: '傳為昔蘭尼的歐伽蒙', era: '約前 6 世紀', language: '古希臘文', extent: '傳為 2 卷', status: 'fragment', via: '普羅克洛斯《文選》摘要', parent: '史詩循環', note: '奧德修斯死於己子之手，全循環於此收束。' },
          ],
        },
        {
      ...
      divisions: [
        {
          ...
          works: [
            ...
            { title_zh: '偽彼拉多行傳', title_orig: 'Acta Pilati (pagana)', author: '佚名（馬克西米努斯‧達伊亞頒行）', era: '公元 311–312 年', language: '古希臘文', status: 'hostile', via: '優西比烏《教會史》九‧5、九‧7', intro: '大迫害的最後幾年，東部皇帝馬克西米努斯‧達伊亞下令頒行一批託名彼拉多的「行傳」，內容詆毀耶穌其人其死，並命各城張貼於公共場所、令學校教師發給學童背誦抄寫。優西比烏是同時代的目擊者，記下這件事時特別提到那份文書把耶穌受難繫在錯誤的年份上。原件一份未存，連殘篇都沒有——它是被公權力製造、也被公權力銷毀的。本藏經收它不為文本（無文本可收），而為這樁事本身：異教方唯一一次動用國家力量編寫並發行反基督教教材，且瞄準的是小學生。', note: '大迫害末期由皇帝下令公布、命各城張貼並令學童背誦抄寫的官方誹謗文書，內容詆毀耶穌其人其死。異教方唯一一次以國家力量製作反基督教教材。' },
          ],
        },
        {
          ...
          works: [
            {
              ...
              intro: '一位中期柏拉圖派學者對基督教的全面批判：耶穌是私生子——母親與一名叫潘忒拉的羅馬士兵所生，被木匠丈夫逐出——後赴埃及習術而歸，靠術法自立為神；門徒是無知漁夫、復活只有歇斯底里的女人作證、基督徒拒服兵役與公職將使帝國崩解。全書前段刻意假託一名猶太人發言，等於把猶太與希臘兩路指控併為一書。俄利根七十年後為駁斥而逐段引錄，使原書得以幾乎完整還原——這是「敵證」層最典型的個案，也是本藏經必須另設此標記的原因。',
            },
