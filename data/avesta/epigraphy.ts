...
//     這一整套語彙在阿維斯陀裡一一對得上。
//   反對者說——銘文裡從頭到尾沒有出現查拉圖斯特拉、沒有迦薩的專門術語、
...
export const EPIGRAPHY_CANON: ZoroCanon = {
  ...
  era: '約前 520 – 公元 4 世紀',
  summary:
    '波斯兩大王朝刻在岩壁與石柱上的王室文告。**本附錄不是經典**：阿契美尼德銘文是否屬於祆教，學界至今無定論——它們敬拜阿胡拉‧馬茲達、以「真理對謊言」構築世界觀，卻從未提及查拉圖斯特拉，也不見迦薩的專門術語。收錄的唯一理由是年代：這是這個信仰世界最早的、有確切紀年與具名作者的文字證據，比現存最早的阿維斯陀寫本早了約兩千年。閱讀時務必記住，這些是國王的政治文告，不是祭司的禮儀文本。',
  parts: [
    {
      ...
      divisions: [
        {
          ...
          texts: [
            ...
            { slug: 'op-dse', title_zh: '大流士‧蘇薩銘文', title_orig: 'DSe / DSf', siglum: 'DSe', language: OP, era: '前 5 世紀初', status: 'inscription', note: '蘇薩王宮營建誌，逐項記各地貢材與工匠來源。' },
            ...
            { slug: 'op-a2sa', title_zh: '阿爾塔薛西斯二世銘文', title_orig: 'A²Sa / A²Ha', siglum: 'A²Sa', language: OP, era: '前 4 世紀初', status: 'inscription', note: '首次在王室銘文中與阿胡拉‧馬茲達並列呼求阿娜希塔與密特拉；阿契美尼德晚期宗教變化的關鍵證據。' },
