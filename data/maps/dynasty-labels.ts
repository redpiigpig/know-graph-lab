...
export const DYNASTY_LABELS: Record<string, DynastyEntry[]> = {
  ...
  // 中國
  // ============================================================
  // Sinic — 商／西周／春秋（東周）／戰國（東周）
  // polygon 跨 -1500 ~ -501，nameZhOf 預設「華夏」需 override
  'Sinic': [
    { from: -1500, to: -1047, dynasty_zh: '', country_zh: '商' },
    { from: -1046, to: -772,  dynasty_zh: '', country_zh: '西周' },
    { from: -770,  to: -481,  dynasty_zh: '春秋', country_zh: '東周' },
    { from: -480,  to: -221,  dynasty_zh: '戰國', country_zh: '東周' },
  ],
  // Zhou states — polygon 跨 -500 ~ -324，整段為戰國
  'Zhou states': [
  ...
  'Tang Empire': [
    { from: 618, to: 626, dynasty_zh: '武德', country_zh: '唐' },
    { from: 627, to: 649, dynasty_zh: '貞觀之治', country_zh: '唐' },
    { from: 650, to: 683, dynasty_zh: '高宗', country_zh: '唐' },
    ...
    { from: 860, to: 873, dynasty_zh: '懿宗', country_zh: '唐' },
  ...
  'Song Empire': [
    ...
    { from: 1005, to: 1066, dynasty_zh: '北宋鼎盛', country_zh: '北宋' },
    { from: 1067, to: 1085, dynasty_zh: '王安石變法', country_zh: '北宋' },
    { from: 1086, to: 1125, dynasty_zh: '北宋末', country_zh: '北宋' },
    { from: 1126, to: 1127, dynasty_zh: '靖康之變', country_zh: '宋' },
    { from: 1127, to: 1141, dynasty_zh: '南宋建立', country_zh: '南宋' },
    { from: 1142, to: 1206, dynasty_zh: '南宋中期', country_zh: '南宋' },
    { from: 1207, to: 1234, dynasty_zh: '聯蒙滅金前後', country_zh: '南宋' },
    { from: 1235, to: 1275, dynasty_zh: '蒙古攻宋四十年', country_zh: '南宋' },
    { from: 1276, to: 1279, dynasty_zh: '崖山之戰', country_zh: '南宋' },
  ],

  // Yuan Empire — 忽必烈到紅巾軍
  'Yuan Empire': [
    { from: 1271, to: 1279, dynasty_zh: '忽必烈滅宋', country_zh: '元' },
    { from: 1280, to: 1294, dynasty_zh: '忽必烈晚年', country_zh: '元' },
  ...
  'Ming Empire': [
    { from: 1368, to: 1398, dynasty_zh: '洪武', country_zh: '明' },
    { from: 1399, to: 1402, dynasty_zh: '靖難之役', country_zh: '明' },
    { from: 1403, to: 1424, dynasty_zh: '永樂', country_zh: '明' },
    { from: 1425, to: 1435, dynasty_zh: '仁宣之治', country_zh: '明' },
    { from: 1436, to: 1449, dynasty_zh: '正統', country_zh: '明' },
    { from: 1450, to: 1505, dynasty_zh: '景泰／成化／弘治中興', country_zh: '明' },
    { from: 1506, to: 1521, dynasty_zh: '正德', country_zh: '明' },
    { from: 1522, to: 1572, dynasty_zh: '嘉靖／隆慶', country_zh: '明' },
    { from: 1573, to: 1620, dynasty_zh: '萬曆', country_zh: '明' },
    { from: 1621, to: 1627, dynasty_zh: '天啟', country_zh: '明' },
    { from: 1628, to: 1644, dynasty_zh: '崇禎', country_zh: '明' },
  ],
  'Ming Chinese Empire': [
  ...
  'Qing Empire': [
    ...
    { from: 1662, to: 1683, dynasty_zh: '康熙前期', country_zh: '清' },
    { from: 1684, to: 1722, dynasty_zh: '康熙盛世', country_zh: '清' },
    { from: 1723, to: 1735, dynasty_zh: '雍正改革', country_zh: '清' },
    { from: 1736, to: 1795, dynasty_zh: '乾隆盛世', country_zh: '清' },
    { from: 1796, to: 1820, dynasty_zh: '嘉慶', country_zh: '清' },
    { from: 1821, to: 1839, dynasty_zh: '道光前期', country_zh: '清' },
    { from: 1840, to: 1842, dynasty_zh: '第一次鴉片戰爭', country_zh: '清' },
    { from: 1843, to: 1850, dynasty_zh: '道光末', country_zh: '清' },
    { from: 1851, to: 1864, dynasty_zh: '太平天國', country_zh: '清' },
    { from: 1856, to: 1860, dynasty_zh: '第二次鴉片戰爭', country_zh: '清' },
    { from: 1861, to: 1874, dynasty_zh: '同治中興', country_zh: '清' },
    { from: 1875, to: 1894, dynasty_zh: '光緒前期', country_zh: '清' },
  ...
  'Post-Ming Warlords': [
    { from: 1644, to: 1662, dynasty_zh: '南明', country_zh: '中國' },
  ...
  'Umayyad Caliphate': [
    { from: 661, to: 680, dynasty_zh: '建立', country_zh: '伍麥亞' },
    { from: 680, to: 692, dynasty_zh: '第二次內戰', country_zh: '伍麥亞' },
    { from: 692, to: 715, dynasty_zh: '阿卜杜‧麥利克／瓦利德擴張', country_zh: '伍麥亞' },
    { from: 716, to: 740, dynasty_zh: '希沙姆', country_zh: '伍麥亞' },
    { from: 741, to: 750, dynasty_zh: '第三次內戰／阿巴斯革命', country_zh: '伍麥亞' },
  ],

  // Abbasid Caliphate — 用戶提的範例，切超細
  'Abbasid Caliphate': [
    { from: 750, to: 762, dynasty_zh: '建立', country_zh: '阿巴斯' },
    { from: 762, to: 786, dynasty_zh: '巴格達建都到馬赫迪', country_zh: '阿巴斯' },
    { from: 786, to: 809, dynasty_zh: '哈倫‧拉希德黃金時代', country_zh: '阿巴斯' },
    { from: 809, to: 813, dynasty_zh: '第四次內戰', country_zh: '阿巴斯' },
    { from: 813, to: 833, dynasty_zh: '馬蒙', country_zh: '阿巴斯' },
    { from: 833, to: 861, dynasty_zh: '薩瑪拉時期', country_zh: '阿巴斯' },
    { from: 861, to: 870, dynasty_zh: '薩瑪拉混亂', country_zh: '阿巴斯' },
    { from: 870, to: 892, dynasty_zh: '形式恢復', country_zh: '阿巴斯' },
    { from: 892, to: 945, dynasty_zh: '丟省', country_zh: '阿巴斯' },
  ...
  'Mongol Empire': [
    ...
    { from: 1219, to: 1225, dynasty_zh: '第一次西征', country_zh: '蒙古' },
    { from: 1227, to: 1241, dynasty_zh: '窩闊台', country_zh: '蒙古' },
    { from: 1241, to: 1246, dynasty_zh: '攝政期', country_zh: '蒙古' },
    { from: 1246, to: 1248, dynasty_zh: '貴由', country_zh: '蒙古' },
    { from: 1248, to: 1251, dynasty_zh: '攝政', country_zh: '蒙古' },
    { from: 1251, to: 1259, dynasty_zh: '蒙哥', country_zh: '蒙古' },
  ...
  // ============================================================
  'Roman Empire': [
    { from: -27, to: 14, dynasty_zh: '奧古斯都', country_zh: '羅馬帝國' },
    ...
    { from: 96, to: 117, dynasty_zh: '涅爾瓦／圖拉真', country_zh: '羅馬帝國' },
    { from: 117, to: 180, dynasty_zh: '哈德良／安東尼／奧勒留', country_zh: '羅馬帝國' },
    ...
    { from: 284, to: 305, dynasty_zh: '戴克里先', country_zh: '羅馬帝國' },
    { from: 306, to: 337, dynasty_zh: '君士坦丁', country_zh: '羅馬帝國' },
    { from: 337, to: 379, dynasty_zh: '君士坦丁諸子／背教者尤利安', country_zh: '羅馬帝國' },
    { from: 379, to: 395, dynasty_zh: '狄奧多西', country_zh: '羅馬帝國' },
  ],
  'Roman Republic': [
    { from: -509, to: -390, dynasty_zh: '早期共和', country_zh: '羅馬共和' },
    { from: -390, to: -264, dynasty_zh: '征服義大利', country_zh: '羅馬共和' },
    { from: -264, to: -146, dynasty_zh: '布匿戰爭', country_zh: '羅馬共和' },
    { from: -146, to: -88, dynasty_zh: '征服希臘化世界', country_zh: '羅馬共和' },
    { from: -88, to: -31, dynasty_zh: '內戰時期', country_zh: '羅馬共和' },
  ],
  'Eastern Roman Empire': [
    { from: 395, to: 476, dynasty_zh: '東羅馬', country_zh: '東羅馬' },
    { from: 476, to: 565, dynasty_zh: '查士丁尼', country_zh: '東羅馬' },
  ...
  'Western Roman Empire': [
    ...
    { from: 455, to: 476, dynasty_zh: '末期', country_zh: '西羅馬' },
  ],
  ...
  'Byzantine Empire': [
    ...
    { from: 717, to: 802, dynasty_zh: '伊蘇里亞王朝', country_zh: '拜占庭' },
    { from: 802, to: 867, dynasty_zh: '阿摩里亞王朝', country_zh: '拜占庭' },
    { from: 867, to: 1025, dynasty_zh: '馬其頓王朝', country_zh: '拜占庭' },
    { from: 1025, to: 1071, dynasty_zh: '馬其頓末', country_zh: '拜占庭' },
    { from: 1071, to: 1081, dynasty_zh: '曼齊克特後混亂', country_zh: '拜占庭' },
    { from: 1081, to: 1180, dynasty_zh: '科穆寧', country_zh: '拜占庭' },
    { from: 1180, to: 1204, dynasty_zh: '安格洛斯', country_zh: '拜占庭' },
    { from: 1204, to: 1261, dynasty_zh: '尼西亞流亡', country_zh: '拜占庭' },
    { from: 1261, to: 1341, dynasty_zh: '巴列奧略前期', country_zh: '拜占庭' },
  ...
  // ============================================================
  'Ottoman Empire': [
    { from: 1299, to: 1326, dynasty_zh: '奧斯曼一世', country_zh: '奧斯曼' },
    { from: 1326, to: 1389, dynasty_zh: '奧爾汗到穆拉德一世', country_zh: '奧斯曼' },
    { from: 1389, to: 1402, dynasty_zh: '巴耶塞特一世', country_zh: '奧斯曼' },
    ...
    { from: 1481, to: 1512, dynasty_zh: '巴耶塞特二世', country_zh: '奧斯曼' },
    { from: 1512, to: 1520, dynasty_zh: '塞利姆一世', country_zh: '奧斯曼' },
    { from: 1520, to: 1566, dynasty_zh: '蘇萊曼大帝', country_zh: '奧斯曼' },
    { from: 1566, to: 1574, dynasty_zh: '塞利姆二世', country_zh: '奧斯曼' },
    { from: 1574, to: 1603, dynasty_zh: '穆拉德三世／穆罕默德三世', country_zh: '奧斯曼' },
    { from: 1603, to: 1648, dynasty_zh: '艾哈邁德一世到易卜拉欣', country_zh: '奧斯曼' },
    { from: 1648, to: 1683, dynasty_zh: '科普魯律家族大維齊改革', country_zh: '奧斯曼' },
    { from: 1683, to: 1699, dynasty_zh: '維也納之圍到卡洛維茨和約', country_zh: '奧斯曼' },
    { from: 1699, to: 1739, dynasty_zh: '鬱金香時代到貝爾格勒和約', country_zh: '奧斯曼' },
    { from: 1739, to: 1768, dynasty_zh: '相對穩定期', country_zh: '奧斯曼' },
    { from: 1768, to: 1812, dynasty_zh: '俄土戰爭頻繁', country_zh: '奧斯曼' },
    { from: 1812, to: 1839, dynasty_zh: '希獨／埃及叛亂／改革前夜', country_zh: '奧斯曼' },
    { from: 1839, to: 1876, dynasty_zh: '坦志麥特改革', country_zh: '奧斯曼' },
    { from: 1876, to: 1878, dynasty_zh: '第一次立憲', country_zh: '奧斯曼' },
    { from: 1878, to: 1908, dynasty_zh: '阿卜杜哈米德二世威權', country_zh: '奧斯曼' },
    { from: 1908, to: 1914, dynasty_zh: '青年土耳其革命', country_zh: '奧斯曼' },
    { from: 1914, to: 1918, dynasty_zh: '一戰', country_zh: '奧斯曼' },
  ...
  // ============================================================
  'Persia': [
    { from: 400, to: 531, dynasty_zh: '薩珊', country_zh: '波斯' },
    { from: 531, to: 579, dynasty_zh: '霍斯勞一世', country_zh: '波斯' },
    { from: 579, to: 651, dynasty_zh: '薩珊末', country_zh: '波斯' },
    ...
    { from: 945, to: 1055, dynasty_zh: '白益', country_zh: '波斯' },
  ...
  'Iran': [
    ...
    { from: 1989, to: 9999, dynasty_zh: '伊斯蘭共和國', country_zh: '伊朗' },
  ],
  'Sasanian Empire': [
    { from: 224, to: 309, dynasty_zh: '建立', country_zh: '薩珊' },
    { from: 309, to: 379, dynasty_zh: '沙普爾二世', country_zh: '薩珊' },
    { from: 379, to: 488, dynasty_zh: '中期', country_zh: '薩珊' },
    { from: 488, to: 531, dynasty_zh: '卡瓦德一世', country_zh: '薩珊' },
    { from: 531, to: 579, dynasty_zh: '霍斯勞一世', country_zh: '薩珊' },
    { from: 579, to: 628, dynasty_zh: '霍斯勞二世', country_zh: '薩珊' },
    { from: 628, to: 651, dynasty_zh: '阿拉伯滅亡前', country_zh: '薩珊' },
  ],
  'Parthian Empire': [
    { from: -247, to: -141, dynasty_zh: '建立到征服美索不達米亞', country_zh: '帕提亞' },
    { from: -141, to: -53, dynasty_zh: '密特里達梯二世', country_zh: '帕提亞' },
    { from: -53, to: -53, dynasty_zh: '卡萊戰役', country_zh: '帕提亞' },
    { from: -53, to: 114, dynasty_zh: '與羅馬對抗期', country_zh: '帕提亞' },
    { from: 114, to: 224, dynasty_zh: '晚期', country_zh: '帕提亞' },
  ],
  'Achaemenid Empire': [
    { from: -550, to: -530, dynasty_zh: '居魯士大帝', country_zh: '阿契美尼德' },
    { from: -530, to: -522, dynasty_zh: '岡比西斯', country_zh: '阿契美尼德' },
    { from: -522, to: -486, dynasty_zh: '大流士一世', country_zh: '阿契美尼德' },
    { from: -486, to: -465, dynasty_zh: '薛西斯一世', country_zh: '阿契美尼德' },
    { from: -465, to: -404, dynasty_zh: '阿爾塔薛西斯一世到第二次內戰', country_zh: '阿契美尼德' },
    { from: -404, to: -358, dynasty_zh: '阿爾塔薛西斯二世', country_zh: '阿契美尼德' },
    { from: -358, to: -330, dynasty_zh: '末期', country_zh: '阿契美尼德' },
  ],

  // ============================================================
  // 埃及
  // ============================================================
  // 埃及：用 country_zh 直接放完整名（user feedback：保持乾淨，王朝編號就好）
  'Egypt': [
    { from: -4000, to: -3100, dynasty_zh: '', country_zh: '埃及前王朝' },
    { from: -3100, to: -2687, dynasty_zh: '', country_zh: '埃及早王朝' },
    { from: -2686, to: -2161, dynasty_zh: '', country_zh: '埃及古王國' },
    { from: -2160, to: -2056, dynasty_zh: '', country_zh: '埃及第一中間期' },
    { from: -2055, to: -1651, dynasty_zh: '', country_zh: '埃及中王國' },
    { from: -1650, to: -1551, dynasty_zh: '', country_zh: '埃及第二中間期' },
    { from: -1550, to: -1295, dynasty_zh: '', country_zh: '埃及第 18 王朝' },
    { from: -1294, to: -1186, dynasty_zh: '', country_zh: '埃及第 19 王朝' },
    { from: -1185, to: -1070, dynasty_zh: '', country_zh: '埃及第 20 王朝' },
    { from: -1069, to: -664, dynasty_zh: '', country_zh: '埃及第三中間期' },
    { from: -664, to: -525, dynasty_zh: '', country_zh: '埃及第 26 王朝' },
    { from: -525, to: -404, dynasty_zh: '', country_zh: '波斯埃及' },
    { from: -404, to: -343, dynasty_zh: '', country_zh: '埃及末期王朝' },
    { from: -343, to: -332, dynasty_zh: '', country_zh: '波斯埃及' },
    { from: -332, to: -305, dynasty_zh: '', country_zh: '希臘化埃及' },
    { from: -305, to: -200, dynasty_zh: '', country_zh: '托勒密埃及' },
    { from: -200, to: -31, dynasty_zh: '', country_zh: '托勒密埃及' },
    { from: -30, to: 395, dynasty_zh: '', country_zh: '羅馬埃及' },
    { from: 395, to: 640, dynasty_zh: '', country_zh: '拜占庭埃及' },
    { from: 641, to: 750, dynasty_zh: '', country_zh: '伍麥亞埃及' },
    { from: 750, to: 868, dynasty_zh: '', country_zh: '阿巴斯埃及' },
    { from: 868, to: 905, dynasty_zh: '', country_zh: '圖倫埃及' },
    { from: 905, to: 935, dynasty_zh: '', country_zh: '阿巴斯埃及' },
    { from: 935, to: 969, dynasty_zh: '', country_zh: '伊赫希迪埃及' },
    { from: 969, to: 1171, dynasty_zh: '', country_zh: '法蒂瑪埃及' },
    { from: 1171, to: 1250, dynasty_zh: '', country_zh: '阿尤布埃及' },
    { from: 1250, to: 1517, dynasty_zh: '', country_zh: '馬木留克埃及' },
    { from: 1517, to: 1798, dynasty_zh: '', country_zh: '奧斯曼埃及' },
    { from: 1798, to: 1801, dynasty_zh: '', country_zh: '拿破崙埃及' },
    { from: 1805, to: 1882, dynasty_zh: '', country_zh: '穆罕默德‧阿里埃及' },
    { from: 1882, to: 1922, dynasty_zh: '', country_zh: '英屬埃及' },
    { from: 1922, to: 1952, dynasty_zh: '', country_zh: '埃及王國' },
    { from: 1952, to: 9999, dynasty_zh: '', country_zh: '埃及' },
  ],
  ...
  'England': [
    ...
    { from: 1100, to: 1135, dynasty_zh: '亨利一世', country_zh: '英格蘭' },
    { from: 1135, to: 1154, dynasty_zh: '無政府時期', country_zh: '英格蘭' },
    { from: 1154, to: 1189, dynasty_zh: '亨利二世', country_zh: '英格蘭' },
    { from: 1189, to: 1216, dynasty_zh: '獅心王／約翰王', country_zh: '英格蘭' },
    { from: 1216, to: 1272, dynasty_zh: '亨利三世', country_zh: '英格蘭' },
    { from: 1272, to: 1307, dynasty_zh: '愛德華一世', country_zh: '英格蘭' },
    { from: 1307, to: 1327, dynasty_zh: '愛德華二世', country_zh: '英格蘭' },
    { from: 1327, to: 1377, dynasty_zh: '愛德華三世', country_zh: '英格蘭' },
    ...
    { from: 1485, to: 1509, dynasty_zh: '亨利七世', country_zh: '英格蘭' },
    { from: 1509, to: 1529, dynasty_zh: '亨利八世前期', country_zh: '英格蘭' },
  ],
  'England and Ireland': [
    { from: 1530, to: 1547, dynasty_zh: '亨利八世', country_zh: '英格蘭與愛爾蘭' },
    { from: 1547, to: 1558, dynasty_zh: '愛德華六世／瑪麗一世', country_zh: '英格蘭與愛爾蘭' },
    { from: 1558, to: 1603, dynasty_zh: '伊麗莎白一世', country_zh: '英格蘭與愛爾蘭' },
    { from: 1603, to: 1625, dynasty_zh: '詹姆斯一世', country_zh: '英格蘭與愛爾蘭' },
    { from: 1625, to: 1649, dynasty_zh: '查理一世', country_zh: '英格蘭與愛爾蘭' },
    { from: 1649, to: 1659, dynasty_zh: '共和', country_zh: '英格蘭與愛爾蘭' },
    { from: 1660, to: 1685, dynasty_zh: '查理二世', country_zh: '英格蘭與愛爾蘭' },
    { from: 1685, to: 1688, dynasty_zh: '詹姆斯二世', country_zh: '英格蘭與愛爾蘭' },
    { from: 1688, to: 1702, dynasty_zh: '威廉三世與瑪麗二世', country_zh: '英格蘭與愛爾蘭' },
    { from: 1702, to: 1714, dynasty_zh: '安妮女王', country_zh: '英格蘭與愛爾蘭' },
  ],
  'United Kingdom': [
    { from: 1707, to: 1714, dynasty_zh: '聯合條約後', country_zh: '聯合王國' },
    { from: 1714, to: 1727, dynasty_zh: '喬治一世', country_zh: '聯合王國' },
    { from: 1727, to: 1760, dynasty_zh: '喬治二世', country_zh: '聯合王國' },
    { from: 1760, to: 1783, dynasty_zh: '喬治三世前期', country_zh: '聯合王國' },
    { from: 1783, to: 1815, dynasty_zh: '第二次帝國／拿破崙戰爭', country_zh: '聯合王國' },
    { from: 1815, to: 1837, dynasty_zh: '攝政－威廉四世', country_zh: '聯合王國' },
    { from: 1837, to: 1857, dynasty_zh: '維多利亞前期', country_zh: '聯合王國' },
    { from: 1857, to: 1877, dynasty_zh: '印度直轄／工業帝國', country_zh: '聯合王國' },
    { from: 1877, to: 1901, dynasty_zh: '維多利亞稱印度女皇／瓜分非洲', country_zh: '聯合王國' },
    { from: 1901, to: 1910, dynasty_zh: '愛德華七世', country_zh: '聯合王國' },
    { from: 1910, to: 1918, dynasty_zh: '喬治五世前期', country_zh: '聯合王國' },
    { from: 1919, to: 1936, dynasty_zh: '帝國巔峰／戰間期', country_zh: '聯合王國' },
    { from: 1936, to: 1936, dynasty_zh: '愛德華八世', country_zh: '聯合王國' },
    { from: 1936, to: 1945, dynasty_zh: '喬治六世', country_zh: '聯合王國' },
    { from: 1945, to: 1956, dynasty_zh: '戰後重建／印度獨立', country_zh: '聯合王國' },
    { from: 1956, to: 1956, dynasty_zh: '蘇伊士危機', country_zh: '聯合王國' },
    { from: 1957, to: 1979, dynasty_zh: '非洲殖民地獨立潮／經濟衰退', country_zh: '聯合王國' },
  ...
  'Hanover': [
    { from: 1715, to: 1814, dynasty_zh: '漢諾威選侯', country_zh: '德意志' },
    { from: 1815, to: 1837, dynasty_zh: '漢諾威王國', country_zh: '德意志' },
  ...
  // ============================================================
  'France': [
    { from: 843, to: 987, dynasty_zh: '加洛林', country_zh: '法國' },
    { from: 987, to: 1108, dynasty_zh: '卡佩前期', country_zh: '法國' },
    { from: 1108, to: 1180, dynasty_zh: '路易六／七世', country_zh: '法國' },
    { from: 1180, to: 1223, dynasty_zh: '腓力二世', country_zh: '法國' },
    ...
    { from: 1364, to: 1422, dynasty_zh: '查理五世／六世', country_zh: '法國' },
    { from: 1422, to: 1461, dynasty_zh: '查理七世', country_zh: '法國' },
    { from: 1461, to: 1483, dynasty_zh: '路易十一', country_zh: '法國' },
    { from: 1483, to: 1547, dynasty_zh: '查理八／路易十二／法蘭索瓦一世', country_zh: '法國' },
    { from: 1547, to: 1589, dynasty_zh: '宗教戰爭', country_zh: '法國' },
    { from: 1589, to: 1610, dynasty_zh: '亨利四世', country_zh: '法國' },
    { from: 1610, to: 1643, dynasty_zh: '路易十三', country_zh: '法國' },
    { from: 1643, to: 1715, dynasty_zh: '路易十四', country_zh: '法國' },
    { from: 1715, to: 1774, dynasty_zh: '路易十五', country_zh: '法國' },
    { from: 1774, to: 1791, dynasty_zh: '路易十六', country_zh: '法國' },
    { from: 1792, to: 1795, dynasty_zh: '第一共和', country_zh: '法國' },
    { from: 1795, to: 1799, dynasty_zh: '督政府', country_zh: '法國' },
    { from: 1799, to: 1804, dynasty_zh: '執政府', country_zh: '法國' },
    { from: 1804, to: 1814, dynasty_zh: '第一帝國', country_zh: '法國' },
    { from: 1814, to: 1830, dynasty_zh: '波旁復辟', country_zh: '法國' },
    { from: 1830, to: 1848, dynasty_zh: '七月王朝', country_zh: '法國' },
    ...
    { from: 1958, to: 1969, dynasty_zh: '第五共和', country_zh: '法國' },
  ...
  'Holy Roman Empire': [
    ...
    { from: 1138, to: 1190, dynasty_zh: '腓特烈一世', country_zh: '神聖羅馬帝國' },
    ...
    { from: 1438, to: 1517, dynasty_zh: '哈布斯堡', country_zh: '神聖羅馬帝國' },
    { from: 1517, to: 1555, dynasty_zh: '查理五世', country_zh: '神聖羅馬帝國' },
    ...
    { from: 1763, to: 1806, dynasty_zh: '末期', country_zh: '神聖羅馬帝國' },
  ],
  ...
  'Mughal Empire': [
    ...
    { from: 1530, to: 1540, dynasty_zh: '胡馬雍前期', country_zh: '蒙兀兒' },
    { from: 1540, to: 1555, dynasty_zh: '蘇爾王朝中斷', country_zh: '蒙兀兒' },
    { from: 1555, to: 1556, dynasty_zh: '胡馬雍復國', country_zh: '蒙兀兒' },
    { from: 1556, to: 1570, dynasty_zh: '阿克巴早期', country_zh: '蒙兀兒' },
    { from: 1570, to: 1605, dynasty_zh: '阿克巴擴張', country_zh: '蒙兀兒' },
    { from: 1605, to: 1627, dynasty_zh: '賈漢吉爾', country_zh: '蒙兀兒' },
    { from: 1628, to: 1658, dynasty_zh: '沙賈漢', country_zh: '蒙兀兒' },
    { from: 1658, to: 1680, dynasty_zh: '奧朗則布北方統治', country_zh: '蒙兀兒' },
    { from: 1680, to: 1707, dynasty_zh: '奧朗則布德干戰役', country_zh: '蒙兀兒' },
    { from: 1707, to: 1719, dynasty_zh: '繼承內戰', country_zh: '蒙兀兒' },
    { from: 1719, to: 1739, dynasty_zh: '穆罕默德沙', country_zh: '蒙兀兒' },
    { from: 1739, to: 1739, dynasty_zh: '納迪爾沙洗劫德里', country_zh: '蒙兀兒' },
    { from: 1739, to: 1761, dynasty_zh: '衰退', country_zh: '蒙兀兒' },
    { from: 1761, to: 1803, dynasty_zh: '馬拉塔保護下', country_zh: '蒙兀兒' },
    { from: 1803, to: 1857, dynasty_zh: '英印逐步控制', country_zh: '蒙兀兒' },
  ],
  ...
  'Safavid Empire': [
    ...
    { from: 1588, to: 1629, dynasty_zh: '阿巴斯一世', country_zh: '薩法維' },
    { from: 1629, to: 1666, dynasty_zh: '薩菲／阿巴斯二世', country_zh: '薩法維' },
    { from: 1666, to: 1722, dynasty_zh: '衰退', country_zh: '薩法維' },
  ],
  ...
  'Japan': [
    ...
    { from: 1568, to: 1603, dynasty_zh: '安土桃山', country_zh: '日本' },
    { from: 1603, to: 1867, dynasty_zh: '德川幕府', country_zh: '日本' },
    { from: 1868, to: 1889, dynasty_zh: '明治維新', country_zh: '日本' },
    { from: 1889, to: 1911, dynasty_zh: '明治後期', country_zh: '日本' },
  ...
  'Korea': [
    ...
    { from: 1270, to: 1392, dynasty_zh: '高麗末', country_zh: '朝鮮半島' },
    { from: 1392, to: 1592, dynasty_zh: '朝鮮前期', country_zh: '朝鮮半島' },
  ...
  // ============================================================
  'Spain': [
    { from: 1469, to: 1516, dynasty_zh: '雙王時代', country_zh: '西班牙' },
    { from: 1516, to: 1556, dynasty_zh: '查理一世', country_zh: '西班牙' },
    { from: 1556, to: 1598, dynasty_zh: '腓力二世', country_zh: '西班牙' },
    { from: 1598, to: 1665, dynasty_zh: '腓力三世／四世', country_zh: '西班牙' },
    { from: 1665, to: 1700, dynasty_zh: '卡洛斯二世', country_zh: '西班牙' },
    { from: 1700, to: 1714, dynasty_zh: '王位繼承戰爭', country_zh: '西班牙' },
    { from: 1714, to: 1808, dynasty_zh: '波旁前期', country_zh: '西班牙' },
    { from: 1808, to: 1814, dynasty_zh: '半島戰爭', country_zh: '西班牙' },
    ...
    { from: 1975, to: 9999, dynasty_zh: '波旁復辟', country_zh: '西班牙' },
  ],
  ...
  // ============================================================
  'Italy': [
    { from: 1861, to: 1900, dynasty_zh: '統一後', country_zh: '義大利' },
  ...
  // ============================================================
  'Germany': [
    { from: 1871, to: 1890, dynasty_zh: '俾斯麥', country_zh: '德國' },
  ...
  'Tsardom of Muscovy': [
    ...
    { from: 1682, to: 1721, dynasty_zh: '彼得大帝', country_zh: '俄羅斯沙皇國' },
  ],
  'Russian Empire': [
    { from: 1721, to: 1762, dynasty_zh: '彼得到伊麗莎白', country_zh: '俄羅斯帝國' },
    { from: 1762, to: 1796, dynasty_zh: '葉卡捷琳娜二世', country_zh: '俄羅斯帝國' },
    { from: 1796, to: 1825, dynasty_zh: '保羅／亞歷山大一世', country_zh: '俄羅斯帝國' },
    { from: 1825, to: 1855, dynasty_zh: '尼古拉一世', country_zh: '俄羅斯帝國' },
    { from: 1855, to: 1881, dynasty_zh: '亞歷山大二世', country_zh: '俄羅斯帝國' },
    { from: 1881, to: 1894, dynasty_zh: '亞歷山大三世', country_zh: '俄羅斯帝國' },
    { from: 1894, to: 1917, dynasty_zh: '尼古拉二世', country_zh: '俄羅斯帝國' },
  ],
  ...
  // ============================================================
  'Portugal': [
    { from: 1139, to: 1279, dynasty_zh: '勃艮第王朝', country_zh: '葡萄牙' },
    { from: 1279, to: 1383, dynasty_zh: '勃艮第晚期', country_zh: '葡萄牙' },
    { from: 1385, to: 1415, dynasty_zh: '阿維什前期', country_zh: '葡萄牙' },
    { from: 1415, to: 1495, dynasty_zh: '海上探險', country_zh: '葡萄牙' },
    { from: 1495, to: 1521, dynasty_zh: '曼努埃爾一世', country_zh: '葡萄牙' },
    { from: 1521, to: 1580, dynasty_zh: '海上帝國巔峰', country_zh: '葡萄牙' },
    { from: 1580, to: 1640, dynasty_zh: '伊比利亞聯合', country_zh: '葡萄牙' },
    { from: 1640, to: 1668, dynasty_zh: '復國戰爭', country_zh: '葡萄牙' },
  ...
  // ============================================================
  'Frankish Kingdom': [
    { from: 481, to: 511, dynasty_zh: '克洛維一世', country_zh: '法蘭克' },
    { from: 511, to: 561, dynasty_zh: '克洛泰爾一世', country_zh: '法蘭克' },
    { from: 561, to: 687, dynasty_zh: '墨洛溫分裂', country_zh: '法蘭克' },
    { from: 687, to: 751, dynasty_zh: '宮相實控', country_zh: '法蘭克' },
    { from: 751, to: 799, dynasty_zh: '加洛林', country_zh: '法蘭克' },
  ],
  'Carolingian Empire': [
    { from: 768, to: 774, dynasty_zh: '查理曼初期', country_zh: '加洛林' },
    { from: 772, to: 804, dynasty_zh: '薩克森戰爭', country_zh: '加洛林' },
    { from: 778, to: 778, dynasty_zh: '隆塞瓦勒之役', country_zh: '加洛林' },
    { from: 791, to: 803, dynasty_zh: '阿瓦爾戰役', country_zh: '加洛林' },
    { from: 800, to: 814, dynasty_zh: '查理曼加冕', country_zh: '加洛林' },
    { from: 814, to: 840, dynasty_zh: '虔誠者路易', country_zh: '加洛林' },
    { from: 840, to: 843, dynasty_zh: '繼承戰爭', country_zh: '加洛林' },
    { from: 843, to: 855, dynasty_zh: '凡爾登條約後', country_zh: '加洛林' },
    { from: 855, to: 887, dynasty_zh: '梅爾森／里貝蒙條約後', country_zh: '加洛林' },
    { from: 887, to: 911, dynasty_zh: '末期分裂', country_zh: '加洛林' },
    { from: 911, to: 987, dynasty_zh: '西法蘭克末期', country_zh: '加洛林' },
  ],
  ...
  'Netherlands': [
    ...
    { from: 1806, to: 1810, dynasty_zh: '荷蘭王國', country_zh: '荷蘭' },
    { from: 1815, to: 1830, dynasty_zh: '尼德蘭聯合王國', country_zh: '荷蘭' },
  ...
  'Mali': [
    ...
    { from: 1337, to: 1464, dynasty_zh: '衰退', country_zh: '馬利' },
    { from: 1464, to: 1599, dynasty_zh: '桑海取代', country_zh: '馬利' },
    { from: 1880, to: 1959, dynasty_zh: '法屬蘇丹', country_zh: '馬利' },
    { from: 1960, to: 1991, dynasty_zh: '獨立／一黨制', country_zh: '馬利' },
    { from: 1991, to: 9999, dynasty_zh: '多黨制', country_zh: '馬利' },
  ],
  'Songhai': [
    ...
    { from: 1591, to: 1591, dynasty_zh: '通迪比戰役', country_zh: '桑海' },
    { from: 1591, to: 1700, dynasty_zh: '殘餘小國', country_zh: '桑海' },
    { from: 1700, to: 1814, dynasty_zh: '邊緣化', country_zh: '桑海' },
  ],
  'Kanem': [
    { from: 800, to: 1075, dynasty_zh: '建立', country_zh: '加涅姆' },
    { from: 1075, to: 1085, dynasty_zh: '杜納馬‧迪巴萊米', country_zh: '加涅姆' },
    { from: 1085, to: 1259, dynasty_zh: '中世紀擴張', country_zh: '加涅姆' },
    { from: 1259, to: 1278, dynasty_zh: '末期', country_zh: '加涅姆' },
  ],
  'Bornu-Kanem': [
    { from: 1279, to: 1380, dynasty_zh: '重建博爾努', country_zh: '博爾努-加涅姆' },
  ...
  'Ethiopia': [
    ...
    { from: 1769, to: 1855, dynasty_zh: '王公時代', country_zh: '衣索比亞' },
    { from: 1855, to: 1868, dynasty_zh: '特沃德羅斯二世', country_zh: '衣索比亞' },
    { from: 1868, to: 1889, dynasty_zh: '約翰尼斯四世', country_zh: '衣索比亞' },
    { from: 1889, to: 1913, dynasty_zh: '孟尼利克二世', country_zh: '衣索比亞' },
  ...
  // ============================================================
  'Ilkhanate': [
    { from: 1256, to: 1265, dynasty_zh: '旭烈兀建立', country_zh: '伊兒汗' },
    { from: 1265, to: 1295, dynasty_zh: '阿八哈到阿魯渾', country_zh: '伊兒汗' },
    { from: 1295, to: 1304, dynasty_zh: '合贊汗', country_zh: '伊兒汗' },
    { from: 1304, to: 1335, dynasty_zh: '完者都／不賽因', country_zh: '伊兒汗' },
    { from: 1335, to: 1399, dynasty_zh: '分裂', country_zh: '伊兒汗' },
  ],
  'Timurid Empire': [
    { from: 1370, to: 1405, dynasty_zh: '帖木兒', country_zh: '帖木兒' },
    { from: 1405, to: 1447, dynasty_zh: '沙哈魯', country_zh: '帖木兒' },
    { from: 1447, to: 1469, dynasty_zh: '兀魯伯／烏茲別克擴張', country_zh: '帖木兒' },
    { from: 1469, to: 1491, dynasty_zh: '末期', country_zh: '帖木兒' },
  ],
  'Timurid Emirates': [
  ...
  // ============================================================
  'Mauryan Empire': [
    { from: -322, to: -317, dynasty_zh: '月護王起義', country_zh: '孔雀' },
    { from: -317, to: -305, dynasty_zh: '月護王逐塞琉古／印度河谷併入', country_zh: '孔雀' },
    { from: -305, to: -298, dynasty_zh: '塞琉古條約後', country_zh: '孔雀' },
    { from: -298, to: -272, dynasty_zh: '賓頭娑羅', country_zh: '孔雀' },
    { from: -272, to: -261, dynasty_zh: '阿育王初期', country_zh: '孔雀' },
    { from: -261, to: -261, dynasty_zh: '羯陵伽戰爭', country_zh: '孔雀' },
    { from: -261, to: -232, dynasty_zh: '阿育王佛教推廣／石柱詔書', country_zh: '孔雀' },
    { from: -232, to: -185, dynasty_zh: '衰退到滅亡', country_zh: '孔雀' },
  ],
  'Gupta Empire': [
    { from: 320, to: 335, dynasty_zh: '旃陀羅笈多一世', country_zh: '笈多' },
    { from: 335, to: 375, dynasty_zh: '海護王', country_zh: '笈多' },
    { from: 375, to: 415, dynasty_zh: '旃陀羅笈多二世', country_zh: '笈多' },
    { from: 415, to: 455, dynasty_zh: '鳩摩羅笈多一世', country_zh: '笈多' },
    { from: 455, to: 467, dynasty_zh: '塞犍陀笈多', country_zh: '笈多' },
    { from: 467, to: 510, dynasty_zh: '中期衰退', country_zh: '笈多' },
    { from: 510, to: 550, dynasty_zh: '匈那入侵', country_zh: '笈多' },
    { from: 550, to: 599, dynasty_zh: '末期殘餘', country_zh: '笈多' },
  ],
  'Sultanate of Delhi': [
    { from: 1206, to: 1236, dynasty_zh: '奴隸王朝', country_zh: '德里蘇丹' },
    { from: 1236, to: 1266, dynasty_zh: '拉茲亞女蘇丹／權貴鬥爭', country_zh: '德里蘇丹' },
    { from: 1266, to: 1287, dynasty_zh: '巴勒班', country_zh: '德里蘇丹' },
    { from: 1290, to: 1296, dynasty_zh: '卡爾吉王朝建立', country_zh: '德里蘇丹' },
    { from: 1296, to: 1316, dynasty_zh: '阿拉烏丁‧卡爾吉南征德干', country_zh: '德里蘇丹' },
    { from: 1316, to: 1320, dynasty_zh: '卡爾吉末', country_zh: '德里蘇丹' },
    { from: 1320, to: 1351, dynasty_zh: '圖格魯克前期', country_zh: '德里蘇丹' },
    { from: 1351, to: 1388, dynasty_zh: '菲魯茲‧沙‧圖格魯克', country_zh: '德里蘇丹' },
    { from: 1388, to: 1398, dynasty_zh: '圖格魯克分崩', country_zh: '德里蘇丹' },
    { from: 1398, to: 1398, dynasty_zh: '帖木兒洗劫德里', country_zh: '德里蘇丹' },
    { from: 1398, to: 1414, dynasty_zh: '帖木兒劫後殘餘', country_zh: '德里蘇丹' },
    { from: 1414, to: 1451, dynasty_zh: '賽義德王朝', country_zh: '德里蘇丹' },
    { from: 1451, to: 1517, dynasty_zh: '洛迪前期', country_zh: '德里蘇丹' },
    { from: 1517, to: 1526, dynasty_zh: '易卜拉欣‧洛迪到帕尼帕特之戰', country_zh: '德里蘇丹' },
  ],
  'Chola state': [
    { from: 1000, to: 1014, dynasty_zh: '羅闍羅闍一世', country_zh: '朱羅' },
    { from: 1014, to: 1044, dynasty_zh: '羅貞陀羅一世', country_zh: '朱羅' },
    { from: 1044, to: 1118, dynasty_zh: '中期擴張', country_zh: '朱羅' },
    { from: 1118, to: 1279, dynasty_zh: '衰退', country_zh: '朱羅' },
  ],
  'Cholas': [
    { from: 500, to: 850, dynasty_zh: '早期', country_zh: '朱羅' },
    { from: 850, to: 1199, dynasty_zh: '帝國朱羅', country_zh: '朱羅' },
  ],
  'Pallavas': [
    { from: 500, to: 728, dynasty_zh: '中期', country_zh: '帕拉瓦' },
    { from: 728, to: 799, dynasty_zh: '末期', country_zh: '帕拉瓦' },
  ],
  'Pallava state': [
    { from: 500, to: 799, dynasty_zh: '帕拉瓦', country_zh: '帕拉瓦' },
  ],
  'Palas': [
    { from: 750, to: 850, dynasty_zh: '建立', country_zh: '波羅' },
    ...
    { from: 1162, to: 1199, dynasty_zh: '末期', country_zh: '波羅' },
  ],
  'Vijayanagara': [
    { from: 1336, to: 1485, dynasty_zh: '建立', country_zh: '毗奢耶那伽羅' },
    { from: 1485, to: 1505, dynasty_zh: '薩魯瓦王朝', country_zh: '毗奢耶那伽羅' },
    { from: 1505, to: 1565, dynasty_zh: '圖盧瓦王朝', country_zh: '毗奢耶那伽羅' },
    { from: 1565, to: 1565, dynasty_zh: '塔利科塔戰役', country_zh: '毗奢耶那伽羅' },
    { from: 1565, to: 1699, dynasty_zh: '阿拉維杜末期', country_zh: '毗奢耶那伽羅' },
  ],
  'Maratha Confederacy': [
    { from: 1674, to: 1707, dynasty_zh: '希瓦吉建國／與蒙兀兒對抗', country_zh: '馬拉塔' },
    { from: 1707, to: 1761, dynasty_zh: '佩什瓦時代', country_zh: '馬拉塔' },
    { from: 1761, to: 1761, dynasty_zh: '第三次帕尼帕特戰役', country_zh: '馬拉塔' },
  ...
  // ============================================================
  'Khmer Empire': [
    { from: 802, to: 889, dynasty_zh: '闍耶跋摩二世', country_zh: '高棉' },
    { from: 889, to: 1010, dynasty_zh: '早期', country_zh: '高棉' },
    { from: 1010, to: 1080, dynasty_zh: '蘇耶跋摩一世', country_zh: '高棉' },
    { from: 1113, to: 1150, dynasty_zh: '蘇耶跋摩二世', country_zh: '高棉' },
    { from: 1181, to: 1218, dynasty_zh: '闍耶跋摩七世', country_zh: '高棉' },
    { from: 1218, to: 1431, dynasty_zh: '衰退', country_zh: '高棉' },
  ...
  'Bagan': [
    { from: 1044, to: 1112, dynasty_zh: '阿奴律陀', country_zh: '蒲甘' },
  ...
  'Ayutthaya': [
    ...
    { from: 1593, to: 1688, dynasty_zh: '巴薩通／那萊', country_zh: '阿瑜陀耶' },
    { from: 1688, to: 1767, dynasty_zh: '末期', country_zh: '阿瑜陀耶' },
    { from: 1767, to: 1782, dynasty_zh: '吞武里王朝', country_zh: '阿瑜陀耶' },
  ],
  'Đại Việt': [
    { from: 1009, to: 1225, dynasty_zh: '李朝', country_zh: '大越' },
    { from: 1225, to: 1400, dynasty_zh: '陳朝', country_zh: '大越' },
    { from: 1400, to: 1407, dynasty_zh: '胡朝', country_zh: '大越' },
    { from: 1407, to: 1428, dynasty_zh: '明朝占領', country_zh: '大越' },
    { from: 1428, to: 1527, dynasty_zh: '黎朝前期', country_zh: '大越' },
    { from: 1527, to: 1592, dynasty_zh: '莫朝篡位', country_zh: '大越' },
    { from: 1592, to: 1771, dynasty_zh: '黎朝後期', country_zh: '大越' },
  ...
  'Funan': [
    { from: 500, to: 627, dynasty_zh: '末期', country_zh: '扶南' },
  ...
  // ============================================================
  'Inca Empire': [
    { from: 1438, to: 1438, dynasty_zh: '昌卡戰役', country_zh: '印加' },
    { from: 1438, to: 1450, dynasty_zh: '帕查庫蒂重建庫斯科／征服周邊', country_zh: '印加' },
    { from: 1450, to: 1471, dynasty_zh: '帕查庫蒂北征', country_zh: '印加' },
    { from: 1471, to: 1483, dynasty_zh: '圖帕克‧印加征基多／北至厄瓜多', country_zh: '印加' },
    { from: 1483, to: 1493, dynasty_zh: '圖帕克‧印加南征', country_zh: '印加' },
    { from: 1493, to: 1525, dynasty_zh: '瓦伊納‧卡帕克', country_zh: '印加' },
    { from: 1525, to: 1525, dynasty_zh: '天花橫掃', country_zh: '印加' },
    { from: 1525, to: 1532, dynasty_zh: '內戰', country_zh: '印加' },
    { from: 1532, to: 1532, dynasty_zh: '卡哈馬卡之囚', country_zh: '印加' },
    { from: 1532, to: 1533, dynasty_zh: '阿塔瓦爾帕被處決／皮薩羅入庫斯科', country_zh: '印加' },
    { from: 1533, to: 1572, dynasty_zh: '比爾卡班巴殘餘王國', country_zh: '印加' },
  ],
  'Aztec Empire': [
    { from: 1428, to: 1428, dynasty_zh: '三方聯盟成立', country_zh: '阿茲特克' },
    { from: 1428, to: 1440, dynasty_zh: '伊茨科亞特爾', country_zh: '阿茲特克' },
    { from: 1440, to: 1469, dynasty_zh: '蒙特蘇馬一世', country_zh: '阿茲特克' },
    { from: 1469, to: 1481, dynasty_zh: '阿沙亞卡特爾', country_zh: '阿茲特克' },
    { from: 1481, to: 1486, dynasty_zh: '提佐克', country_zh: '阿茲特克' },
    { from: 1486, to: 1502, dynasty_zh: '阿維特索特爾', country_zh: '阿茲特克' },
    { from: 1502, to: 1520, dynasty_zh: '蒙特蘇馬二世', country_zh: '阿茲特克' },
    { from: 1519, to: 1519, dynasty_zh: '科爾特斯登陸', country_zh: '阿茲特克' },
    { from: 1520, to: 1520, dynasty_zh: '悲傷之夜', country_zh: '阿茲特克' },
    { from: 1521, to: 1521, dynasty_zh: '特諾奇蒂特蘭陷落', country_zh: '阿茲特克' },
 ...
 * @returns '安史之亂（唐）' | '東周' | null
 *
 * 規則（user feedback：國名保持乾淨）：
 *   - dynasty_zh 為空 → 只顯示 country_zh
 *   - country_zh 為空 → 只顯示 dynasty_zh
