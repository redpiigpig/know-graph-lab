...
export const DYNASTY_LABELS: Record<string, DynastyEntry[]> = {
  ...
  // ============================================================
  'Ottoman Empire': [
    { from: 1299, to: 1326, dynasty_zh: '奧斯曼一世（部族邦）', country_zh: '奧斯曼' },
    { from: 1326, to: 1389, dynasty_zh: '奧爾汗到穆拉德一世（征服色雷斯／科索沃戰役）', country_zh: '奧斯曼' },
    ...
    { from: 1453, to: 1481, dynasty_zh: '穆罕默德二世擴張（巴爾幹／黑海）', country_zh: '奧斯曼' },
    { from: 1481, to: 1512, dynasty_zh: '巴耶塞特二世（內亂、薩法維崛起）', country_zh: '奧斯曼' },
    { from: 1512, to: 1520, dynasty_zh: '塞利姆一世（征馬木留克／聖城）', country_zh: '奧斯曼' },
    { from: 1520, to: 1566, dynasty_zh: '蘇萊曼大帝（黃金時代）', country_zh: '奧斯曼' },
    { from: 1566, to: 1574, dynasty_zh: '塞利姆二世（勒班陀海戰）', country_zh: '奧斯曼' },
    { from: 1574, to: 1603, dynasty_zh: '穆拉德三世／穆罕默德三世', country_zh: '奧斯曼' },
    { from: 1603, to: 1648, dynasty_zh: '艾哈邁德一世到易卜拉欣（後宮影響擴大）', country_zh: '奧斯曼' },
    { from: 1648, to: 1683, dynasty_zh: '科普魯律家族大維齊改革', country_zh: '奧斯曼' },
    { from: 1683, to: 1699, dynasty_zh: '維也納之圍到卡洛維茨和約（割匈牙利）', country_zh: '奧斯曼' },
    { from: 1699, to: 1739, dynasty_zh: '鬱金香時代到貝爾格勒和約', country_zh: '奧斯曼' },
    { from: 1739, to: 1768, dynasty_zh: '相對穩定期', country_zh: '奧斯曼' },
    { from: 1768, to: 1812, dynasty_zh: '俄土戰爭頻繁（喪克里米亞）', country_zh: '奧斯曼' },
    { from: 1812, to: 1839, dynasty_zh: '希獨／埃及叛亂／改革前夜', country_zh: '奧斯曼' },
    { from: 1839, to: 1876, dynasty_zh: '坦志麥特改革', country_zh: '奧斯曼' },
    { from: 1876, to: 1878, dynasty_zh: '第一次立憲（93 戰爭、柏林條約）', country_zh: '奧斯曼' },
    { from: 1878, to: 1908, dynasty_zh: '阿卜杜哈米德二世威權', country_zh: '奧斯曼' },
    { from: 1908, to: 1914, dynasty_zh: '青年土耳其革命', country_zh: '奧斯曼' },
    { from: 1914, to: 1918, dynasty_zh: '一戰（加里波利／亞美尼亞種族屠殺）', country_zh: '奧斯曼' },
  ...
  'United Kingdom': [
    { from: 1707, to: 1714, dynasty_zh: '聯合條約後（安妮）', country_zh: '聯合王國' },
    { from: 1714, to: 1727, dynasty_zh: '喬治一世（南海泡沫）', country_zh: '聯合王國' },
    { from: 1727, to: 1760, dynasty_zh: '喬治二世（奧地利王位繼承／七年戰爭）', country_zh: '聯合王國' },
    { from: 1760, to: 1783, dynasty_zh: '喬治三世前期（北美獨立失利）', country_zh: '聯合王國' },
    { from: 1783, to: 1815, dynasty_zh: '第二次帝國／拿破崙戰爭', country_zh: '聯合王國' },
    { from: 1815, to: 1837, dynasty_zh: '攝政－威廉四世（廢奴）', country_zh: '聯合王國' },
    { from: 1837, to: 1857, dynasty_zh: '維多利亞前期（東印度公司擴張、克里米亞）', country_zh: '聯合王國' },
    { from: 1857, to: 1877, dynasty_zh: '印度直轄（1858 起）／工業帝國', country_zh: '聯合王國' },
    { from: 1877, to: 1901, dynasty_zh: '維多利亞稱印度女皇／瓜分非洲', country_zh: '聯合王國' },
    { from: 1901, to: 1910, dynasty_zh: '愛德華七世（光榮孤立轉協約）', country_zh: '聯合王國' },
    { from: 1910, to: 1918, dynasty_zh: '喬治五世前期（一戰）', country_zh: '聯合王國' },
    { from: 1919, to: 1936, dynasty_zh: '帝國巔峰／戰間期', country_zh: '聯合王國' },
    { from: 1936, to: 1936, dynasty_zh: '愛德華八世（退位危機）', country_zh: '聯合王國' },
    { from: 1936, to: 1945, dynasty_zh: '喬治六世（二戰）', country_zh: '聯合王國' },
    { from: 1945, to: 1956, dynasty_zh: '戰後重建／印度獨立（去殖民化開始）', country_zh: '聯合王國' },
    { from: 1956, to: 1956, dynasty_zh: '蘇伊士危機（帝國心理終結）', country_zh: '聯合王國' },
  ...
  // ============================================================
  'Mughal Empire': [
    { from: 1526, to: 1530, dynasty_zh: '巴布爾建國（帕尼帕特之戰）', country_zh: '蒙兀兒' },
    { from: 1530, to: 1540, dynasty_zh: '胡馬雍前期（蘇爾入侵前）', country_zh: '蒙兀兒' },
    { from: 1540, to: 1555, dynasty_zh: '蘇爾王朝中斷（謝爾沙）', country_zh: '蒙兀兒' },
    { from: 1555, to: 1556, dynasty_zh: '胡馬雍復國', country_zh: '蒙兀兒' },
    { from: 1556, to: 1570, dynasty_zh: '阿克巴早期（拉吉普特政策）', country_zh: '蒙兀兒' },
    { from: 1570, to: 1605, dynasty_zh: '阿克巴擴張（征古吉拉特／孟加拉／喀什米爾）', country_zh: '蒙兀兒' },
    { from: 1605, to: 1627, dynasty_zh: '賈漢吉爾', country_zh: '蒙兀兒' },
    { from: 1628, to: 1658, dynasty_zh: '沙賈漢（泰姬陵）', country_zh: '蒙兀兒' },
    { from: 1658, to: 1680, dynasty_zh: '奧朗則布北方統治（伊斯蘭教化）', country_zh: '蒙兀兒' },
    { from: 1680, to: 1707, dynasty_zh: '奧朗則布德干戰役（疆域最大、財政枯竭）', country_zh: '蒙兀兒' },
    { from: 1707, to: 1719, dynasty_zh: '繼承內戰（巴哈杜爾沙一世到弒帝）', country_zh: '蒙兀兒' },
    { from: 1719, to: 1739, dynasty_zh: '穆罕默德沙（馬拉塔崛起）', country_zh: '蒙兀兒' },
    { from: 1739, to: 1739, dynasty_zh: '納迪爾沙洗劫德里', country_zh: '蒙兀兒' },
    { from: 1739, to: 1761, dynasty_zh: '衰退（阿富汗多次入侵）', country_zh: '蒙兀兒' },
    { from: 1761, to: 1803, dynasty_zh: '馬拉塔保護下', country_zh: '蒙兀兒' },
    { from: 1803, to: 1857, dynasty_zh: '英印逐步控制（1857 起義廢帝）', country_zh: '蒙兀兒' },
  ],
  ...
  'Carolingian Empire': [
    { from: 768, to: 774, dynasty_zh: '查理曼初期（征倫巴底）', country_zh: '加洛林' },
    { from: 772, to: 804, dynasty_zh: '薩克森戰爭（30 年）', country_zh: '加洛林' },
    { from: 778, to: 778, dynasty_zh: '隆塞瓦勒之役（羅蘭傳奇）', country_zh: '加洛林' },
    { from: 791, to: 803, dynasty_zh: '阿瓦爾戰役（征潘諾尼亞）', country_zh: '加洛林' },
    { from: 800, to: 814, dynasty_zh: '查理曼加冕（西方皇帝）', country_zh: '加洛林' },
    { from: 814, to: 840, dynasty_zh: '虔誠者路易（內亂與三子叛父）', country_zh: '加洛林' },
    { from: 840, to: 843, dynasty_zh: '繼承戰爭（楓特努瓦戰役）', country_zh: '加洛林' },
    { from: 843, to: 855, dynasty_zh: '凡爾登條約後（三分）', country_zh: '加洛林' },
    { from: 855, to: 887, dynasty_zh: '梅爾森／里貝蒙條約後', country_zh: '加洛林' },
    { from: 887, to: 911, dynasty_zh: '末期分裂（東法蘭克絕嗣）', country_zh: '加洛林' },
    { from: 911, to: 987, dynasty_zh: '西法蘭克末期（卡佩篡位）', country_zh: '加洛林' },
  ],
  ...
  // ============================================================
  'Mauryan Empire': [
    { from: -322, to: -317, dynasty_zh: '月護王起義（與旃那克亞）', country_zh: '孔雀' },
    { from: -317, to: -305, dynasty_zh: '月護王逐塞琉古／印度河谷併入', country_zh: '孔雀' },
    { from: -305, to: -298, dynasty_zh: '塞琉古條約後（巔峰）', country_zh: '孔雀' },
    { from: -298, to: -272, dynasty_zh: '賓頭娑羅（南征德干）', country_zh: '孔雀' },
    { from: -272, to: -261, dynasty_zh: '阿育王初期', country_zh: '孔雀' },
    { from: -261, to: -261, dynasty_zh: '羯陵伽戰爭（轉佛）', country_zh: '孔雀' },
    { from: -261, to: -232, dynasty_zh: '阿育王佛教推廣／石柱詔書', country_zh: '孔雀' },
    { from: -232, to: -185, dynasty_zh: '衰退到滅亡（巽伽奪權）', country_zh: '孔雀' },
  ],
  'Gupta Empire': [
    { from: 320, to: 335, dynasty_zh: '旃陀羅笈多一世（與離車聯姻）', country_zh: '笈多' },
    { from: 335, to: 375, dynasty_zh: '海護王（南征達瑪剌耶到坦米爾）', country_zh: '笈多' },
    { from: 375, to: 415, dynasty_zh: '旃陀羅笈多二世（征西部薩特拉普／黃金時代）', country_zh: '笈多' },
    { from: 415, to: 455, dynasty_zh: '鳩摩羅笈多一世（穩定／那爛陀奠基）', country_zh: '笈多' },
    { from: 455, to: 467, dynasty_zh: '塞犍陀笈多（抗匈那）', country_zh: '笈多' },
    { from: 467, to: 510, dynasty_zh: '中期衰退', country_zh: '笈多' },
    { from: 510, to: 550, dynasty_zh: '匈那入侵（米希拉庫拉攻陷）', country_zh: '笈多' },
    { from: 550, to: 599, dynasty_zh: '末期殘餘', country_zh: '笈多' },
  ],
  'Sultanate of Delhi': [
    { from: 1206, to: 1236, dynasty_zh: '奴隸王朝（庫特布丁／伊勒杜米什）', country_zh: '德里蘇丹' },
    { from: 1236, to: 1266, dynasty_zh: '拉茲亞女蘇丹／權貴鬥爭', country_zh: '德里蘇丹' },
    { from: 1266, to: 1287, dynasty_zh: '巴勒班（鎮壓蒙古入侵）', country_zh: '德里蘇丹' },
    { from: 1290, to: 1296, dynasty_zh: '卡爾吉王朝建立', country_zh: '德里蘇丹' },
    { from: 1296, to: 1316, dynasty_zh: '阿拉烏丁‧卡爾吉南征德干（馬拉巴／毗奢耶那伽羅前期）', country_zh: '德里蘇丹' },
    { from: 1316, to: 1320, dynasty_zh: '卡爾吉末（內亂）', country_zh: '德里蘇丹' },
    { from: 1320, to: 1351, dynasty_zh: '圖格魯克前期（穆罕默德‧賓‧圖格魯克遷都）', country_zh: '德里蘇丹' },
    { from: 1351, to: 1388, dynasty_zh: '菲魯茲‧沙‧圖格魯克（修運河／溫和）', country_zh: '德里蘇丹' },
    ...
    { from: 1414, to: 1451, dynasty_zh: '賽義德王朝（地方化）', country_zh: '德里蘇丹' },
    { from: 1451, to: 1517, dynasty_zh: '洛迪前期（巴赫盧勒／西坎達爾）', country_zh: '德里蘇丹' },
  ...
  // ============================================================
  'Inca Empire': [
    { from: 1438, to: 1438, dynasty_zh: '昌卡戰役（帕查庫蒂奪位）', country_zh: '印加' },
    { from: 1438, to: 1450, dynasty_zh: '帕查庫蒂重建庫斯科／征服周邊', country_zh: '印加' },
    { from: 1450, to: 1471, dynasty_zh: '帕查庫蒂北征（吉華卡／欽察伊蘇尤）', country_zh: '印加' },
    { from: 1471, to: 1483, dynasty_zh: '圖帕克‧印加征基多／北至厄瓜多', country_zh: '印加' },
    { from: 1483, to: 1493, dynasty_zh: '圖帕克‧印加南征（智利／西北阿根廷）', country_zh: '印加' },
    { from: 1493, to: 1525, dynasty_zh: '瓦伊納‧卡帕克（巔峰／首都偶遷基多）', country_zh: '印加' },
    { from: 1525, to: 1525, dynasty_zh: '天花橫掃（瓦伊納‧卡帕克突死）', country_zh: '印加' },
    { from: 1525, to: 1532, dynasty_zh: '內戰（瓦斯卡爾 vs 阿塔瓦爾帕）', country_zh: '印加' },
    { from: 1532, to: 1532, dynasty_zh: '卡哈馬卡之囚（皮薩羅伏擊）', country_zh: '印加' },
    { from: 1532, to: 1533, dynasty_zh: '阿塔瓦爾帕被處決／皮薩羅入庫斯科', country_zh: '印加' },
    { from: 1533, to: 1572, dynasty_zh: '比爾卡班巴殘餘王國（圖帕克‧阿馬魯一世亡）', country_zh: '印加' },
  ],
  'Aztec Empire': [
    { from: 1428, to: 1428, dynasty_zh: '三方聯盟成立（特斯科科＋特拉科潘＋特諾奇）', country_zh: '阿茲特克' },
    { from: 1428, to: 1440, dynasty_zh: '伊茨科亞特爾（征阿茲卡波察爾科）', country_zh: '阿茲特克' },
    { from: 1440, to: 1469, dynasty_zh: '蒙特蘇馬一世（東擴維拉克魯斯／南進瓦哈卡）', country_zh: '阿茲特克' },
    { from: 1469, to: 1481, dynasty_zh: '阿沙亞卡特爾（西征塔拉斯科失利）', country_zh: '阿茲特克' },
    { from: 1481, to: 1486, dynasty_zh: '提佐克（短命統治）', country_zh: '阿茲特克' },
    { from: 1486, to: 1502, dynasty_zh: '阿維特索特爾（極盛擴張至索科努斯科）', country_zh: '阿茲特克' },
    { from: 1502, to: 1520, dynasty_zh: '蒙特蘇馬二世（鎮壓叛亂／西班牙來臨）', country_zh: '阿茲特克' },
    { from: 1519, to: 1519, dynasty_zh: '科爾特斯登陸（特拉斯卡拉結盟）', country_zh: '阿茲特克' },
    { from: 1520, to: 1520, dynasty_zh: '悲傷之夜（西班牙人退出）', country_zh: '阿茲特克' },
    { from: 1521, to: 1521, dynasty_zh: '特諾奇蒂特蘭陷落（庫奧赫特莫克被俘）', country_zh: '阿茲特克' },
