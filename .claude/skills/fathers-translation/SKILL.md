...
| 🔄 5 | ANF Vol 5 (Hippolytus + Cyprian + Caius + Novatian) | 翻譯中 (2026-05-28 20:00 在 492/747 = 65.9%) | Haiku 啟動 → ~chunk 175 撞 Anthropic OAuth 限額 → 切到 Gemini engine + resume，預計 5/29 03:00-08:00 完成。`seed_glossary_anf_vol5.py` 樣板已預先 commit (待 translate 完套用) |
| ⏭️ 6 | ANF Vol 6 (Gregory Thaumaturgus + Dionysius the Great + Julius Africanus + Anatolius) | 待翻譯 | 排入下個 overnight (5/29 night)。ebook_id=`dffaae40-e088-41c1-ab7f-9b96f9249661` |
| ⏭️ 7 | ANF Vol 7 (Lactantius + Venantius + Asterius + Methodius + Arnobius) | 待翻譯 | 排入下個 overnight (5/29 night)。ebook_id=`75d8aae0-7431-4be9-baee-c57d26599653` |
