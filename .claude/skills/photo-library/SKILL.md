...
|---|---|---:|---|
| chenwei  | ✅ 完成 (2026-05-17 overnight) | 12,233 / 12,233 | 第一輪 overnight 跑完，202 folders |
| training | ✅ 完成 (2026-05-18 早上) | 4,830 / 4,923 | recursive walk 修完後重跑；93 已是新格式 skip；77 folders |
| hongshi  | ⏳ 等使用者上傳完 | — | 使用者在 Drive 網頁`電腦 > 我的筆記型電腦 > 02. 歷年活動照片-69-119` 慢慢上傳；傳完要先「移動」到 `我的雲端硬碟/資料/儲存資料夾/弘誓相片/` 才能跑 |
