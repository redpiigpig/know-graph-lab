...
**正藏／外藏定義**：正藏＝尼西亞教會（大公傳統）接受者；外藏＝分類與正藏對照、但不被接受者（偽典／異端／猶太教／外教見證）。

**十藏**（user 定名）：經藏‧律藏‧論藏‧史傳藏‧譯校藏‧書信藏‧禮儀藏‧詩文藏‧宣道藏‧類書藏。
...
**待辦**：① 經藏外 9 藏的正/外書目持續擴充到「大多數重要文獻」（目前代表性骨架）② 中世紀/近代/現代三部 collections 待建（仿 ancient.ts，正藏→續藏切割）③ 若日後要全文/搜尋再升 DB。
