...
- `pages/dazangjing/[era].vue` — 該時代的各藏 + 各部 + 書目卡片（藏目 sticky 快速導覽、跨連站內工具）

> ⚠️ **時代命名鐵則（user 2026-06-15）**：四時代就叫「古代/中世紀/近代/現代基督教大藏經」，**別自己發明「古典十藏」之類的傘狀名稱**。十個藏（經/律…）的個別名稱照用。

**十藏**（user 定名，**第 10 藏是「類書藏」不是「子學藏」**）：
