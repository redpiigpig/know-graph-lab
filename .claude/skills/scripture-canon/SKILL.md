...
**~~近‧禮儀藏外藏 3→100~~✅（2026-07-21）**：依巴哈伊權威文獻庫《巴哈歐拉祈禱與默想》固定篇號收入第 1–98 篇，取代原先籠統的《巴哈伊祈禱與聖日》母合集，配合原有兩種近世外教禮儀文本恰達 100。條目清楚區分十九世紀啟示文本與守基‧阿芬第一九三八年英譯編次，並具完整 metadata、母合集、逐篇來源 URL 與長簡介，專項測試 9 綠。⚠️ 後世編譯本可提供固定篇界，但年代欄必須分列原文形成與編譯定序，不能把二十世紀編次誤當原作年代；母合集展開後不再另計。

**~~近‧詩藝藏外藏 3→100~~✅（2026-07-21）**：刪除把《隱言經》與未指明祈禱混成一條的《巴哈伊讚美詩與祈禱》，依杜卡拉姆傳統《詩集》固定 Gatha 編號收入阿邦格第 1–98 首，配合《摩門讚美詩》與蒲柏《人論》恰達 100。來源為編號 1–4,607 的杜卡拉姆詩歌庫與一八六九年公版全集影像，新增各詩具完整 metadata、母合集、來源 URL 與長簡介，專項測試 9 綠。⚠️ 虔信詩的後世抄刊與譯本只作校讀來源，年代仍依作者原作；混合多種作品的模糊選集必須先刪除。

**~~近‧譯校藏外藏 6→100~~✅（2026-07-21）**：把薩爾《古蘭經》母本展開為一七三四年初版前 46 個固定譯章，並以杜佩龍《奧義祕藏》五十篇固定編次取代籠統的「東方宗教經典初譯」，配合原有四部譯校作品恰達 100。來源為 Wikisource 初版影像、法國國家圖書館書目與兩卷本目錄，各卷具完整 metadata、母合集、來源 URL 與長簡介，專項測試 9 綠。⚠️ 間接轉譯必須把原文→中介語→目標語的譯路寫清楚；不能用「等」把多部原典與多位譯者混成一條。

**~~近‧史傳藏外藏 3→100~~✅（2026-07-21）**：把吉本《羅馬帝國衰亡史》展開為原有七十一章，將模糊的《摩門教早期史》改為《後期聖徒教會史》第一卷前二十九章，並把實際一九四四年成書的《神臨證記》移出近世，合計恰為 100。來源為 Project Gutenberg 完整章目與 Joseph Smith Papers 的稿本史說明，各章具完整 metadata、母合集、來源 URL 與長簡介，專項測試 9 綠。⚠️ 歷史敘述所寫年代不等於文本成書年代；後世編本如承載早期稿本，須分列稿本形成與刊本編輯兩層。

**~~近‧類書藏外藏 4→100~~✅（2026-07-21）**：刪除模糊的狄德羅「宗教條目」、合併兩篇宣言的玫瑰十字會文獻、誤屬律藏的共濟會憲章及未展開的培爾辭典母題，改依晚明《三才圖會》原刻一百零六卷收入前 100 卷。來源為中國哲學書電子化計劃的卷數與分類資料，新增各卷具完整 metadata、母合集、來源 URL 與長簡介，專項測試 9 綠。**至此近世非經藏九格外藏全部 100。** ⚠️ 類書藏不可用「某百科宗教條目」這種無篇界的概稱；應選有固定卷次或可辨條目的原始知識工程。

**~~今‧律藏外藏 4→100~~✅（2026-07-21）**：刪除十九世紀《教義與聖約》、第一修正案及無固定文本的「新世紀倫理」等誤代／概稱條目，改依正式條號收入《世界人權宣言》30 條、《公民與政治權利國際公約》53 條、《消除宗教或信仰不容忍宣言》8 條與《防止及懲治滅絕種族罪公約》前 9 條，合計 100。來源均為聯合國與 OHCHR 正式文本，各條具完整 metadata、母文書、來源 URL 與長簡介，專項測試 9 綠。⚠️ 世俗公共法可作外律對照，但必須是正式可核的規範文本；不能以後世判例影響為由把早期法條改判今世。

**~~今‧宣道藏外藏 5→100~~✅（2026-07-21）**：保留兩部具有明確版本的耶和華見證人與後期聖徒宣教手冊，刪除「新世紀講座文選」、三版混合的人本宣言及跨作者無神論演說概稱，依巴哈伊權威文庫收入阿博都巴哈一九一二年美加巡講前 98 篇，合計 100。每篇具明確講述場合、固定目錄順序、完整 metadata、來源 URL 與長簡介，專項測試 9 綠。⚠️ 宣言與未指明講者篇目的「演說集」不能充作宣道作品；速記講辭可收，但要說明記錄者與講述文本的關係。

**~~今‧書函藏外藏 3→100~~✅（2026-07-21）**：移除十九世紀巴哈歐拉致諸王書及兩篇非書信的人本主義宣言，改依印度政府尼赫魯入口與原書固定信次，收入尼赫魯一九三〇至一九三三年獄中致女兒《世界史瞥見》前 100 封。每封具完整 metadata、母合集、來源 URL 與長簡介，專項測試 9 綠。⚠️ 書信內容可以是歷史、哲學或宗教教育，但必須先確認它是真實通信文書；宣言的公開性不能取代書信體裁。

**~~今‧禮儀藏外藏 2→100~~✅（2026-07-21）**：刪除無固定文本的「新世紀冥想手冊」與僅描述口傳現象的尼亞賓基儀典，依克勞利《謊言之書》原編九十三個一頁單元收入 93 章，再收泰勒瑪七部具有獨立書號與程序的儀式／修持文本；並排除已內含於《謊言之書》的星紅寶石、星藍寶石與鳳凰彌撒重複，合計 100。來源為 Sacred Texts 全文與泰勒瑪文獻目錄，專項測試 9 綠。⚠️ 口傳儀式現象不能用描述性概稱當作品；混合書中的儀式章可收，但另收獨立禮文時必須做語義去重。

**~~今‧詩藝藏外藏 3→100~~✅（2026-07-21）**：刪除無固定篇目的拉斯塔法里讚美詩概稱、跨多位歌手的「雷鬼神學詩文」及跨作者「新世紀靈性文學選」，依泰戈爾一九一二年英語自譯《吉檀迦利》固定 103 首收入前 100 首。來源為 Project Gutenberg 公版英語全文，各詩具完整 metadata、母合集、來源 URL 與長簡介，專項測試 9 綠。⚠️ 作者自譯選本可以自身固定編號著錄，但必須說明它與原語詩集不是逐首對應；流派、歌單或市場類型不能冒充作品。

**~~今‧譯校藏外藏 5→100~~✅（2026-07-21）**：刪除跨越近世的《東方聖書叢書》母題、不是具體作品的「歷史批判法導論」，以及屬方法論／研究成果而非譯校原典的形式批判和耶穌研討會條目；把二〇一五年《研究版古蘭經》展開為前 100 個固定譯章。每章具完整譯者群、語言、母合集、來源 URL 與長簡介，專項測試 9 綠。⚠️ 譯校藏只收明確譯本、校本與其固定單元；學術方法、研究群體或叢書品牌不能當成一部譯作。

**~~今‧史傳藏外藏 5→100~~✅（2026-07-21）**：刪除二手哲學書《世俗時代》、學術論題概稱，以及沒有固定作者與文本邊界的三種「某宗教史」；把實際一九四四年出版的守基‧阿芬《神臨證記》由近世移回現代，並依甘地《我對真理的實驗》正式章目收入前 99 章。來源為巴哈伊權威文庫及甘地研究機構完整目錄，每卷具實際英文章題、完整 metadata、母合集、來源 URL 與長簡介，專項測試 9 綠。⚠️ 史傳藏只收有明確作者、文本與篇界的史書或自傳；作品追述的年代不能取代成書年代，學術論題與宗教運動概稱不能冒充史傳作品。

**~~今‧類書藏外藏 6→100~~✅（2026-07-21）**：刪除《金枝》《圖騰與禁忌》《摩西與一神教》《心理學與宗教》等單篇專著，以及實際屬十九世紀近世的《祕密教義》《揭開伊西斯的面紗》；依一九〇八年《宗教與倫理百科全書》第一卷原書影像與全文，收入由〈A 與 Ω〉至〈利他主義〉的前 100 個固定百科條目。每條具中英詞頭、主編與協編、出版地、年代、母合集、來源 URL 與長簡介，專項測試 9 綠。**至此古、中、近、今四代除經藏外，九藏共 36 格外藏全部達到至少 100 卷。** ⚠️ 一部專著採百科式寫法仍不是類書；類書藏應收有固定詞頭、卷次或條目邊界的知識工程，並用原書目錄或掃描本文核對實際篇界。

**下一步建議**：外藏補全 campaign 已完成；後續只做全庫語義複核、來源連結維護與個別 metadata 精修，不再以增量湊數。詳細交接見 repo `SESSION_HANDOFF_dazangjing_wai_2026-07-19.md`。
...
### 重 OCR 管線（2026-09-19 新約篇四冊，MinerU）

上面第 1–6 支是 2026-05 那一輪（吃 PDF 內建文字層＋Gemini Vision）。那批文字層
本身是壞掉的 OCR，而且**整冊書被倒進一個 slug**，所以 2026-09 用 MinerU 重做。
新管線各司其職，全部是可單跑的純函式／CLI：

| 腳本 | 做什麼 |
|---|---|
| `ocr_cct_apocrypha.py` | MinerU CPU OCR，**40 頁一批**、批次夾即斷點 |
| `apocrypha_toc.py` | 讀書自己的**目錄** → 有哪幾部作品、各從印刷第幾頁起（定界的權威來源） |
| `apocrypha_map_volumes.py` | 書眉／卷首兩個錨 ＋ `extract_blocks`（表格還原、巢狀區塊） |
| `apocrypha_sectionize.py` | 純函式切節，五種體例 |
| `apocrypha_footnotes.py` | 註腳 → `{標記: 定義}` ＋ 正文標記轉上標 |
| `apocrypha_missing_numbers.py` | 被 OCR 吃掉的節號，**人工核過**的對照表 |
| `apocrypha_extract_works.py` | 組裝：定界 → 對帳 → 切節 → 逐段點名 |
| `ingest_cct_apocrypha.py` | 對應 doc_slug、蓋掉舊的 `cct_zh` 列 |

**五種編號體例**（同一套書各卷不一致，所以不猜、五種都跑，挑「補最少號」的）：
`flat`（§1..N）／`chapverse`（23:1，章節常印在一起）／`grouped`（「一、革利免」或
「1. 章標題」分組，組內號從頭數）／`bypage`（書上真的沒編號，按印刷頁切）／
範圍式（「1-6概論…」摘要體，label 寫成 `1-6`）。

**2026-09-19 成果**：四冊 1,294 頁、99 部作品、992 節、2,085 條註腳；
14 份壞檔重收（品質閘：複合 5→2、壞文字層 15→4，剩下四項各有記錄的理由）。
《多馬福音》回到 **114 則語錄**、《阿拉伯語嬰孩福音》55 節與《拉丁語嬰孩福音》
7 節（§68–74）與上一輪人工驗收的成品逐節吻合。

#### 🚨 這一輪踩到的坑（每一條都是「看起來成功的失敗」）

- **表格文字在 `span["html"]` 不在 `span["content"]`**。只讀 content 讓 **50 頁**
  整頁回空——頁數照樣對、逐段點名照樣 0 段落外（分母就是 MinerU 給的那些段落）。
  其中三頁是《多馬福音》語錄 1–7，整部書因此切不出章。巢狀區塊也不要用白名單
  列舉型別（`table`/`image` 之外還有 `code`），改成「沒有 lines 但有 blocks 就往下鑽」。
- **`page_idx` 是每批各自從 0 開始**。分批 OCR 併檔不加偏移，每批都蓋在 0–39，
  而頁數看起來完全正常。
- **目錄的卷號不可貪心比對**：`卷四十二使徒福音` ＝ 卷四＋《十二使徒福音》、
  `卷九七十長老福音` ＝ 卷九＋《七十長老福音》。要按「預期的下一卷」挑最短前綴。
  另外要認得「廿」「卅」，否則第二冊卷廿一–廿五整條消失。
- **`index` 型別在書裡別處也有**（第四冊《西卜神諭篇》是帶行號的長詩），
  只吃冊首第一段連續的 index 頁。
- **同一件事書上有四種印法**：`121` / `13 1` / `15¹` / `2`。少認一種就整章不見，
  而且節數只少一、字數全對。所以把所有讀法列出來，交給連號規則去選。
- **雙欄並排是兩種抄本的異文**（伯默蒲草紙5／一些後期的抄卷），同一組節號出現兩次。
  定案：**單一版本＋行內標籤**，右欄以書上欄標為前綴附在該節後，不開第二個
  version_code（異文只有四頁，開了就得把其餘 99% 正文複製一份）。
- **註腳「收到了」不等於「看得到」**：reader 是拿正文裡的上標去查 `footnote_defs`。
  舊版存成整頁一個 list、又複製給該頁每一節，正文裡又是普通數字——26 條一條都
  沒顯示。現在存 `{標記: 定義}` 並把正文數字轉上標；但實測 **58% 的標記在 OCR
  正文裡根本不存在**（原書是很小的上標），所以 reader 已改成「連不上的也照樣列在
  頁底」，否則那 58% 等於沒收。
