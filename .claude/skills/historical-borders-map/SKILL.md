...
| E6. **CHGIS 中國朝代真實邊界** | `public/maps/chgis-polygons.geojson` | **51 polygons / 12 朝代 (900 KB)** | 從 Harvard/Fudan **CHGIS V6 Time Series Prefecture Polygons**（DOI:10.7910/DVN/I0Q7SM，免費學術用）dissolve 出朝代邊界。涵蓋 -224 BCE → 1911 CE，含繁中名／拼音／簡中名。每朝代取代表性 key years（Han 武帝極盛 -110、Tang 開元盛世 750、Yuan 忽必烈 1280、Ming 永樂初 1400、Manchu 乾隆極盛 1760…等）unary_union 所有 active prefectures。3,830 個 prefecture/府／州／路 → dissolve 後 51 個朝代-年 polygons。pyshp + shapely，[scripts/build_chgis_polygons.py](../../../scripts/build_chgis_polygons.py)。|
