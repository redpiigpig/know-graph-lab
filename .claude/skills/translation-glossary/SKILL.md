...
**核心設計（兩層）**：
1. **register 對應（制對應）**：把外國政權按「**社會發展階段＋政治氣質**」（共時性，非日曆年代）對到一個朝代 register。純核心 `ADMIN_REGISTERS`（**11 桶**）：商周制／春秋制／戰國秦制／漢制／魏晉制／唐制／**宋制**／**遼金元制**／明清制／**漢字圈自有**／周封建五等爵。**遼金元制**（南北面雙軌、萬戶千戶百戶、達魯花赤）專供**游牧/征服帝國**（安息/塞爾柱/蒙古諸汗國/帖木兒/匈奴/突厥/印加）；**漢字圈自有**收日/韓/越（官名本即漢字，**直用原稱不另譯**）；拜占庭跨唐[軍區]/宋[晚期文官]兩制（如羅馬跨漢/魏晉）。已建 ~30 政權涵蓋近東/波斯/希臘化/羅馬/拜占庭/伊斯蘭/印度/草原/西歐/漢字圈/非洲/美洲，全表見藍圖 §7。
