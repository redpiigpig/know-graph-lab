...
第一支案例＝2026-07-18 豬豬相遇（Drive `知識圖工作室\影片\2026-07-18_豬豬相遇\文案.md`）（石垣島大豬 × 新加坡機場失散兄弟）。
...
- **影片一律不進 repo**（2026-08-27 起）：整個 `影片/` 已搬到 Drive，repo 內連 `文案.md` 都不留，只留本 skill。

## 歸檔慣例

工作區在 Drive，不在 repo：`G:\我的雲端硬碟\資料\知識圖工作室\影片\`
ffmpeg 直接對這個路徑讀寫即可（Drive 串流掛載支援），不用先在本機做完再搬。
