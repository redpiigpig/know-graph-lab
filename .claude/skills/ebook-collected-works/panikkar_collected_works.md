...
（2026-06-12 逐一查證，**全數查實**；ISBN 經 douban subject 頁核對。原 sandbox web 搜尋穿透差，改用 douban 站內搜尋 + subject 頁直抓拿到完整書目。）

| 原書 | 中譯本 | 譯者 | 出版社 | 年 | ISBN | 頁 | douban |
|---|---|---|---|---|---|---|---|
| The Unknown Christ of Hinduism | **《印度教中未知的基督》** | 王志成、思竹 | 四川人民出版社 | 2003 | 9787220061684 | 228 | 1270684 **← 起手卷** |
| The Invisible Harmony | 《看不見的和諧》 | 王志成 | 江蘇人民出版社 | 2001-07 | 9787214029744 | 272 | 1278507（另有宗教文化 2005 重排本 1838831）|
| A Dwelling Place for Wisdom | 《智慧的居所》 | 王志成 | 江蘇人民出版社 | 2000-09 | 9787214028341 | 223 | 1556263 |
| Cultural Disarmament: The Way to Peace | 《文化裁軍》 | 思竹 | 四川人民出版社 | 1999-11 | 9787220047190 | 174 | 1538902 |
| The Intra-religious Dialogue | 《宗教內對話》 | 王志成、思竹 | 宗教文化出版社 | 2001-03 | 9787801233134 | 224 | 1287056 |
| The Cosmotheandric Experience | 《宇宙—神—人共融的經驗：正在湧現的宗教意識》 | 思竹 | 宗教文化出版社 | 2005-12 | 9787801237347 | 215 | 1683741 |
| The Fullness of Man: A Christophany | 《人的圓滿》 | 王志成 | 宗教文化出版社 | 2006-12 | 9787801238283 | 290 | 2029353（= Opera Omnia III.2 基督顯現 同源）|
| （諸宗教相遇）| 《對話經：諸宗教的相遇》 | 王志成 | 四川人民出版社 | 2008 | 9787220076619 | — | 3354914 |
...
## 🚀 新 session 接手清單（2026-06-25 最新；交棒用，先讀本節）
...
| `55555561-5555-4555-8555-555555555555` | 神的經驗：奧祕的聖像 | 自譯（en→繁中，39 chunks；2026-06-25 已補 cache 對齊並重建上架）|
...
- 自譯 cache 小批量：`python -X utf8 scripts/panikkar_auto.py --work <slug> --translate-only --maxparas 50 --save-every 1 --backend haiku`。
- cache 完成後上架：`python -X utf8 -c "import sys; sys.path.insert(0,'scripts'); import panikkar_auto as pa; pa.build_and_upload('<slug>', do_upload=True)"`。
...
- `rhythm-of-being` EPUB 抽出沒有 `##` heading marker，整本成單一 section；2026-06-25 已在 `panikkar_auto.build_chunks` 加每 10 段拆一個 reader chunk，避免 43 萬字塞成一頁。

### ⏳ 待辦
1. **queue 收尾**：下一本接 `myth-faith-hermeneutics`（義文，cache 已有 599/684 左右但需按新 split 補齊）；各卷完成後補 hub。
