...
- **🚧 第二部第七章「雙重母親」(The Dual Mother Role)**：建設中（`ch12.json`，英文 HTML 13147–16443，**294 個英文 entries / 59 詩節 — 全書最大章**）。德文＝德 VII「Das Opfer」前半（`jung_ch12_de.txt`，1234 段）。**⏭️ 進度：已建 ch12.json，4 rows（標題＋E1–E3）**：奇萬托佩爾法文獨白尋找「理解我的她」=母親=生命伴侶、性別對立於力比多關係甚微、渴望被理解=對自然命運的被壓抑奮進。抽取器 `c:/tmp/_jung_extract_ch12.py`（jung_ch12_en.txt 294 entries＋jung_ch12_de.txt 1234 段）。**下一批 E4**＝米勒求自立=年輕佛陀棄宮（德文 `jung_ch12_de.txt` D6 起）＋馬太10:34-36「我來不是叫地上太平，乃是叫地上動刀兵…與父母為敵」（E5–E7 分節，zh=和合本；德文 D7 含整段太10:34-36 需分節；E8 路加12:51 平行）。
