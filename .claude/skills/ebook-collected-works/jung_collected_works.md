...
> ⚙️ **引擎政策（2026-06-04 更新）**：所有 LLM 工作一律**優先用 NVIDIA（輝達，`https://integrate.api.nvidia.com/v1`，預設文字模型 `deepseek-ai/deepseek-v4-flash-0731`，4 把 key 輪流＋間隔節流避免 429）**，第二層 fallback 用 Gemini，**第三層救急才用 Haiku（NVIDIA→Gemini→Haiku；前兩個免費池都用罄時才動 Haiku）**。視覺類用 NVIDIA 視覺模型（如 `nvidia/llama-3.1-nemotron-nano-vl-8b-v1`）。
...
## 後期成熟著作優先清單（宗教學向，2026-07-04 研究）

> **版權底線**：榮格卒 1961-06-06 → 德文 GW **2032-01-01** 進 PD；Hull 英譯 CW（1953–79 出版）美國約 **2048–2074** 才 PD；遺著（紅書 2009／黑書 2020／研討會）從出版日算、鎖最久。**全部無公有領域來源 → 私人站英文先入、我親譯（轉化作品），來源檔須 user 提供**（本環境連不到 shadow 鏡像）。

**TOP 8（宗教學者優先入手序）**：
1. **CW 11《心理學與宗教：西方與東方》★★★★★** — 最該先要的一卷。西方：心理學與宗教(1937 Terry 講座)/三位一體教義/彌撒中的轉化象徵/**答約伯**；東方：西藏度亡經/中陰/瑜伽/鈴木禪序/東方冥想/印度聖者/易經序。基督教教義＋佛教瑜伽禪道比較宗教一冊到位。
2. **CW 9ii《伊雍 Aion》★★★★★** — 榮格論**基督＝自性原型**、諾斯底、雙魚座 2000 年基督教符號史；含〈基督作為自性的象徵〉〈諾斯底的自性象徵〉。他基督論的唯一專書。
3. **《答約伯 Antwort auf Hiob》(1952) ★★★★★** — 宗教學被引用最多的榮格文本；神義論、上帝與惡、聖母升天教義。（亦在 CW 11 內，但獨立看待。）
4. **CW 12《心理學與煉金術》★★★★★** — 煉金術全корpus 入口；基督＝哲人石(lapis)類比、煉金術中的宗教觀念。讀 13/14 前先讀。
5. **紅書 Liber Novus (2009) ★★★★★** — 榮格親身異象「與無意識對峙」的圖文手稿，後期宗教心理學的源頭（含七佈道原型）；20 世紀的異象「福音書」。鎖最重，取 facsimile 或 Reader's Edition。
6. **CW 14《神祕合體 Mysterium Coniunctionis》★★★★★** — 最後大作；煉金術/卡巴拉/諾斯底/基督教神祕主義論對立面之合(coniunctio)。比較神祕主義頂點。
7. **CW 9i《原型與集體無意識》★★★★☆** — 讀懂上述的解釋鑰匙：重生/神聖之子/大母神/曼陀羅象徵。
8. **昆達里尼瑜伽研討會 (1932) ★★★★★** 或 **《回憶‧夢‧省思》MDR (1962) ★★★★☆** — 前者＝印度密教/脈輪比較宗教；後者＝榮格個人宗教經驗傳記框架（童年大教堂異象/波林根塔/瀕死異象/七佈道脈絡）。

**次級（值得但排後）**：CW 13 煉金術研究(★★★★☆，金花的祕密/佐西默斯異象/帕拉塞爾蘇斯)、CW 5 轉化的象徵(1952 改寫本，★★★★☆，≠已有的 1916 Hinkle PD 版)、CW 10 轉變中的文明(含〈Wotan〉神話爆發/《未發現的自我》/《飛碟》)、《尋找靈魂的現代人》(1933,最易入門)、《人及其象徵》(1964 圖文導論)、黑書(2020,最原始異象紀錄)、查拉圖斯特拉研討會(1934–39,論上帝之死/先知原型)、異象研討會(1930–34)。**暫略**：CW 18 象徵的生命(宗教密度低)。

**去重提醒**：答約伯／Terry 講座／未發現的自我／飛碟 都同時有獨立本與 CW 卷內版；收全 CW 11/10 即涵蓋。**下一步＝待 user 挑選並提供來源檔**（English-first，走 jung_bilingual_translate.py 或 collected-works 多語 pipeline）。
