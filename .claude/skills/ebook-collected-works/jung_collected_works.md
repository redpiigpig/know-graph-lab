...
- **🚧 第二部第六章「為脫離母親而戰」(The Battle for Deliverance from the Mother)**：建設中（`ch11.json`，英文 HTML 11982–13147，**76 個英文 entries / 11 詩節**）。**⏭️ 進度：已建 39 rows（標題＋E1–E38，~51%）**：森林=聖樹=母親、奇萬托佩爾戲劇法文開場、E6 馬=動物性無意識/被壓抑力比多巨段（諸神坐騎、魔鬼馬蹄足=陽具、閃電=馬）、戴歐尼修斯牛蹄禱辭、佩加索斯踏泉、馬=風/火/光、四馬戰車 Quadriga=時間、廣林奧義書獻祭之馬宇宙頌、埃永獅頭時間之神、馬克羅比烏斯+斐洛論時間、菲爾多西時間=命運、馬=死亡之樹/引魂者/特洛伊木馬、三腳馬與沃魯卡沙驢、莎翁卡西烏斯與布魯圖斯（=母親認同/嬰兒式稟性）、死亡願望/阿普列尤斯戰鬥=交媾拉丁、英雄死於箭傷=聖塞巴斯蒂安、艾默里希修女心臟被箭穿、佛陀偈箭在肉中、神祕合一=性力比多、聖痕異象三重紅光束=箭、詩篇127:4兒女=勇士手中箭。**進度已達 60 rows（標題＋E1–E59，~78%）**：續譯尼采寧錄詩/自獵自縊=自體受孕內傾、力比多沉入深處=記憶童年樂園/霍普特曼《沉鐘》之歌、梅菲斯特危險甚大=母親與死亡/維濕奴入定生梵天降魔奪回吠陀、特洛伊木馬=從母重生/菲羅克忒忒斯被克律塞詛咒毒蛇咬足。**下一批 E60**＝埃及讚歌（德文 `jung_ch11_de.txt` D190 起：Rê 被伊西斯以唾液所造毒蟲咬傷=母親害死太陽神/伊西斯索其真名=力比多回轉母親/Rê 退回天牛；E60–E68 為 Rê–Isis 讚歌大段，含 V61/V64/V66 三首詩節；E69–E75 收尾本章=回顧性渴望=麻痺毒蛇/參孫大利拉/浮士德母親內傾/獻祭=棄絕母親）。抽取腳本 `c:/tmp/_jung_extract_ch11.py`。⚠️ 受版權 CW 卷一律等 user 提供合法檔或用 PD 德文原典（1929 前／2032 全 PD），**不抓盜版**。
  - **🔑 章界映射關鍵（Hinkle 重組）**：**德文版第二部只有兩章** — 德 VI「Der Kampf um die Befreiung von der Mutter」(de 14189–15781) ＝ **英文 Ch VI＋Ch VII 兩章合併**；德 VII「Das Opfer」(de 15781–) ＝ **英文 Ch VIII「The Sacrifice」**。故 `jung_ch11_de.txt`（德文整章 VI，289 段）同時供英文 Ch VI（ch11）與 Ch VII（ch12）取用；英文 Ch VIII（ch13）的德文＝德文 VII「Das Opfer」。英文章界：VI=HTML 11982–13147、VII=13147–16443、VIII=16443–18479。
- **⏭️ 後續章節**：VII 雙重母親（en HTML 13147–16443，建 `ch12.json`，德文續用 `jung_ch11_de.txt` 後半）、VIII 獻祭（en 16443–18479，建 `ch13.json`，德文＝德 VII「Das Opfer」de 15781+，需新 `_jung_extract_ch13.py`）。逐章流程同下方「新 session 續傳細則」（ch10 寫法通用，僅改檔名/行號）。
