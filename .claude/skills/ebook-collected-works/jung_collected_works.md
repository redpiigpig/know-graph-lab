...
- **🚧 第二部第五章「母親與重生的象徵」(Symbols of the Mother and of Rebirth)**：待建（`ch10.json`）。德文 ZWEITER TEIL V「Symbole der Mutter und der Wiedergeburt」第 10731 行起 / 英文 HTML `CHAPTER V` 第 9497 行起（至 11982，Ch VI 在 11983）。**⏭️ 續傳指標：尚未開抽**——下一步先寫 `c:/tmp/_jung_extract_ch10.py`（仿 ch9，de 10731→Ch VI 德文起點、en HTML 9496:11982），再逐批建 ch10。
