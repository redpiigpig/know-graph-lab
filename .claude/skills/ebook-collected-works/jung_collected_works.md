...
- **🚧 第二部第五章「母親與重生的象徵」(Symbols of the Mother and of Rebirth)**：建設中（`ch10.json`，**全書最大章**）。抽取已跑（`c:/tmp/_jung_extract_ch10.py`，輸出 `jung_ch10_de.txt` 538 段 / `jung_ch10_en.txt` 208 entries 含 12 詩節）。德文 ZWEITER TEIL V 第 10731 行起 / 英文 HTML `CHAPTER V` 第 9497 行起（至 11982，Ch VI 在 11983）。**⏭️ 續傳指標：已建 10 rows（標題＋E1–E9）**——E1 人群=祕密象徵/力比多 rapport、E2 馬+戰鬥=功能範疇/夢之城=母性象徵=天上耶路撒冷/瑞亞庫柏勒城牆冠、E3 以賽亞47巴比倫處女、E4–E9 城即母親（耶利米論巴別/城是處女與妓女/以賽亞論推羅/忠信的城變妓女）。**下一批 E10**＝`jung_ch10_en.txt` 的 `[E10]`（俄古革斯 Ogyges 神話：城與妻同名=城即女人；因陀羅娶沃土 Urvarā；王娶耕地；濕婆陰陽合體/林伽=母胎象徵/厄琉息斯祕箱漂水=胎兒羊水倒置），對德文 `[D17]`。逐批 append→`python scripts/jung_build_all.py`→commit `[loop]`。
