...
| **神學** | 無教會主義九位：內村鑑三 `uchimura`、矢內原忠雄 `yanaihara`＋譜系七位（畔上賢造 `azegami`／塚本虎二 `tsukamoto`／黒崎幸吉 `kurosaki`／藤井武 `fujii`／南原繁 `nanbara`／金教臣 `kim-kyoshin`／咸錫憲 `ham-sokhon`） | 多語對照（ja/ko/en＋繁中） | [§C 神學](#c3-神學無教會主義九位) |
