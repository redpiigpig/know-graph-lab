...
| 卷 | 章 | 英文 | 中文 | 狀態 |
|---|---|---|---|---|
| M1 愛的萬物論 | 7 | 37 | ⛔ 待補 | report `lit_review_genesis_M1.md` |
| M2 虛構的烏托邦 | 13 | 39 | ⛔ 待補 | `lit_review_genesis_M2.md` |
| M3 人子 | 9 | 39 | ⛔ 待補 | `lit_review_genesis_M3.md` |
| E1 本質的幽靈 | 8 | 31 | ✅ 8 | `lit_review_genesis_E1.md` + `_zh` |
...
| V1 願然 | 6 | ⛔ | ⛔ | 未做 |
| V2 意義、愛與神聖 | 6 | ⛔ | ⛔ | 未做 |
| V3 世界理論 | 5 | ⛔ | ⛔ | 未做（新卷，內容多為代擬） |
| B1 空無與創生前態 | 7 | ⛔ | ⛔ | 未做 |
| B2 默然與不可言說 | 6 | ⛔ | ⛔ | 未做（在場世界論已移 V3） |
| B3 神聖、虛無與終極存在 | 7 | ⛔ | ⛔ | 未做 |

**累計 233 筆 / 6 卷英文完成（E 系列含中文）。**

## 剩餘工作
1. **M1/M2/M3 補中文**（開 3 個中文代理 → `lit_review_genesis_<M?>_zh.md` → ingest `--display-offset 100`）。
2. **O1-3／V1-3／B1-3 共 9 卷**：每卷英文一輪（4 領域代理）＋中文一輪（1 代理覆蓋四領域），compose → ingest。
