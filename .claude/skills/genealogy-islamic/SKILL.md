...
`scripts/genealogy_data_audit.py --table islamic_people` 四類結構檢查歸零外，另跑領域級驗證（世代單調性／12 伊瑪目鏈完整性／主幹連續性／缺 gen）：
- **12 伊瑪目鏈完整正確** ✅：阿里(g65)→哈桑/侯賽因(66)→宰因·阿比丁(67)→巴基爾(68)→嘉法爾·薩迪克(69)→穆薩·卡齊姆(70)→里達(71)→穆罕默德·賈瓦德(72)→哈迪(73)→阿斯卡里(74)→馬赫迪(75)，世代連續無缺。
- **主幹阿丹→穆罕默德連續**（46 代）、**0 人缺 generation**。
- **修 2 處真 off-by-one gen**：①哈蘭（易卜拉欣之兄）g19→20（原與父阿札爾同代，應與弟易卜拉欣齊 g20；子樹魯特/女/摩押/便亞米 連帶 +1）；②哈菲茲·法蒂瑪 g83→85（原低於父穆罕默德·伊本·穆斯坦希爾 g84 之逆序，法蒂瑪王朝晚期鏈；子樹優素福/扎菲爾/阿迪德/法伊茲 +2）。修後**零逆序**。
- **餘 10 條「同代父子」皆 intentional 不動**：穆聖三妻（阿伊莎/哈芙莎/烏姆·哈比巴＝配偶對齊丈夫代）／法蒂瑪三子女（阿里堂親聯姻 g65＋12 伊瑪目鏈起點，動則整鏈位移）／猶大列王阿蒙→約西亞（修則沿被擄後大衛世系 cascade 撞其他分支，minGen 已保視覺正確）／晚期開羅傀儡哈里發橫向鏈。
- 視覺驗收：伊斯蘭樹 195 卡渲染健康、主幹單列清楚（阿丹＋哈娃→設特→…）。
