...
```
python scripts/build_roster_docx.py <匯出的.xls> [...] --outdir "G:\我的雲端硬碟\玄奘\博一\教學M-1 {課程}"
```

🚨 **點名表放使用者自己的教學夾 `玄奘/博一/教學/115-1 {課程}/`，不是 `資料/知識圖工作室/教學/`。**
...
教學材料存兩處：課堂用的 `玄奘\博一\教學M-1 {課程}`（資料夾名用**空格**）與網站鏡射用的
`資料\知識圖工作室\教學M-1_{課程}`（用**底線**，國文那本後面還多「講義」二字）。
...
| 點名表 | 3 份 docx（國文 16 人／基督宗教概論 13 人／世界宗教文化導論 49 人） | Drive `玄奘/博一/教學/115-1 {課程}/` |
