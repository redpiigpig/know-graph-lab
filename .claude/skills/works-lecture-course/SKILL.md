...
的週次表重編組，43 份一次出齊：BBE275 14 份、BBE150 14 份、PPA066 8 份、PPA001 7 份。
...
改完一定要跑一次全量稽核（把四十三份掃過找 `第X章`），別只看單一份。
...
- **演講與參訪那六週**（BBE275 10/7、11/4；BBE150 10/7、11/4；PPA066 11/7；PPA001 11/1）
  封面後插一頁行程說明，用 `section` 不用 `big`——`fold_bigs` 會把 `big` 併進下一頁。
  講授內容保留著當備用，講者提早結束就接得上。
...
目前 BBE275 第 3、7 週與 PPA001 第 1、3、5 次會走到最底一階（內文縮到約 16pt），
其餘都在第一階（不縮字）。要那幾份也維持大字，得先把講稿條目刪短，不是調參數。
