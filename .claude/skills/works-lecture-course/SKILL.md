...
```
python scripts/build_roster_docx.py <匯出的.xls> [...] --outdir "G:\...\教學\{課程}"
```

範本是 `教學/115-1_世界宗教文化導論/二年制世界宗教文化導論-點名表.docx`（使用者手工整理過
的那一份）。腳本直接改範本的 document.xml，字體、灰底、框線一律沿用，只換內容：
...
| 點名表 | 3 份 docx（國文 16 人／基督宗教概論 13 人／世界宗教文化導論 49 人） | Drive `教學/{課程}/` |
