...
3. **西面（路加 2）＋三王 → 收**：
   ...
   - **東方三博士**＝加斯帕/梅爾基奧爾/巴爾塔薩三新 row（tradition=catholic，名出 6c《Excerpta Latina Barbari》）。**譜系錨定查證後站不住**（三博士世系無權威文獻），依 fallback 以獨立 row + notes 收錄——⚠️ **只在表格檢視出現，族譜圖不渲染**（無父節點連結，spine 樹不可達）。這是刻意且誠實的處理，非 bug。
