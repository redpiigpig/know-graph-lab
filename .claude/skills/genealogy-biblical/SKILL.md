...
**存疑留使用者**：①艾梅倫提亞屬 15 世紀晚期傳統（比黃金傳說更晚），要不要留請定奪；②「米利暗＝以法他嫁迦勒」（梳妲 11b-12a）與「喇合嫁約書亞」（米吉拉 14b）兩個 rabbinic 認同說**未做**——雙方都是 biblical 明文人物，直連會污染明文圖層、rabbinic JSONB 又不被 API merge；要做得仿 API 內 rabbinicPC hardcode（拿順→以利米勒 pattern）。
