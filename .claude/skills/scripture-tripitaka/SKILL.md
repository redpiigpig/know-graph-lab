...
scripts/tests/test_tripitaka_*.py   純函式測試（75 個，鎖住下列所有陷阱）
...
- **梵文完成 11 部**（GRETIL 有 194 部）：中論 27 品（頌號 MMK 1.1 逐頌可引）、
  法華 27 品、方廣大莊嚴經 27 品、維摩詰 12 品、十住經、心經、金剛經、
  華嚴入法界品、菩薩本生鬘論，＋2026-08-30 新增 **辯中邊論 5 章**與
  **究竟一乘寶性論 5 章**（兩張手寫 `chapter_map`，見下）。
  **5 部仍被閘擋下**：大乘莊嚴經論 20 vs 24、菩提行經 10 vs 8、
  道行般若 32 vs 30、佛所行讚（梵本側只解出 1 章）、
  金光明經（梵本品號還跳號，且梵 21／曇無讖 19／義淨 31 三者互異）。
