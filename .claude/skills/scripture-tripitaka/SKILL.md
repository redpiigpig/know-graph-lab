...
84000 **沒有漢譯對照，一個 Taishō 編號都沒有**；rKTs 也沒有（它的強項是各版
甘珠爾的版本異同）；本站既有的 SuttaCentral 平行經目是巴利↔漢，**完全沒有 Toh**；
本站的漢文目錄也沒有梵名欄，無法靠梵名自動 join——這三條捷徑都試過，都不通。

中文站要的 `title_zh` 是**該經既有的漢譯正式書名**，不是藏文題名的翻譯：
Toh 113 藏文題名直譯是「正法白蓮華」，漢譯正式書名是**《妙法蓮華經》**。
把前者填進去，讀者會以為那是真的漢譯書名。**寧可空著。**
要補只能走**東北目錄**（宇井伯壽等，1934——「Toh」這個編號就是從那裡來的）
的漢譯對照欄，而且只填對照表說有的。
