...
| 梵文原文 | 107 | 15,906 | — | 9 部 | GRETIL |
| 藏文原文 | 29 | 4,871 | — | 3 部 | 84000 翻譯記憶（TMX） |
| 繁中白話 | — | 2,281 段（77%） | — | 12/14 部 | 本站自譯（Haiku）|
...
scripts/tests/test_tripitaka_*.py   純函式測試（71 個，鎖住下列所有陷阱）
...
2026-08-30 進度 2,281/2,964 段（77%）。已完成 12 部，剩 **T0159 大乘本生心地觀經**
（218 段）與 **T0262 妙法蓮華經**（514 段）。log 在 `C:/tmp/cbeta/vernacular.log`。
掉了就直接重跑同一行指令 —— 有 resume，已譯的段會跳過。
...
- **梵文只完成 9 部**（GRETIL 有 194 部）：中論 27 品（頌號 MMK 1.1 逐頌可引）、
  法華 27 品、方廣大莊嚴經 27 品、維摩詰 12 品、十住經、心經、金剛經、
  華嚴入法界品、菩薩本生鬘論。**7 部被閘擋下**，都是真的梵漢分品不同，
  要逐部手寫 `chapter_map`：辯中邊論 5 vs 7、大乘莊嚴經論 20 vs 24、
  菩提行經 10 vs 8、寶性論 3 vs 14、道行般若 32 vs 30、佛所行讚、
