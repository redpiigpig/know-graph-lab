...
| 原文對照 | 巴利原文 8,309 部／118 萬行（20 部漢文經）・平行經目 23,321 筆（172 部）・CBETA 漢梵巴詞條 29,930 組（142 部）・大正藏原註巴利對應 1,597 條（21 部） |
...
scripts/tripitaka_original_text.py  平行經目的「指標」→ 原典全文
...
scripts/tests/test_tripitaka_*.py   純函式測試（29 個，鎖住下列所有陷阱）
...
- **梵文原文**。SuttaCentral 的 `root/san` 只有 2 檔，形同沒有。梵本須另從
  **GRETIL**（gretil.sub.uni-goettingen.de）取，涵蓋法華、般若、入楞伽、
  維摩詰、中論頌等主要大乘經論。目前站上的「梵文」只有平行經目編號與
  CBETA 詞條的專名原語形，**沒有梵文全文**。
